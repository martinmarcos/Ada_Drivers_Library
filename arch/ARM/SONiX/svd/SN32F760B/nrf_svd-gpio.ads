...
package NRF_SVD.GPIO is
   ...
   type CFG_CFG0_Field is
     (
      ...
      CFG_CFG0_Field_00,
      --  Inactive. (no pull-up resistor enabled, Schmitt trigger enabled)
      CFG_CFG0_Field_10,
      --  Inactive. (no pull-up resistor enabled, Schmitt trigger disabled,
   ...
   --  CFG array
   type CFG_Field_Array_1 is array (0 .. 11) of CFG_CFG0_Field
