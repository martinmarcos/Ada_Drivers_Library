...
package NRF_SVD.SPI is
   ...
   type CTRL0_Register is record
      --  SPI enable
      SPIEN          : CTRL0_SPIEN_Field := NRF_SVD.SPI.Disable;
      --  Loopback mode enable
      LOOPBACK       : CTRL0_LOOPBACK_Field := NRF_SVD.SPI.Disable;
      --  Slave data out disable
      SDODIS         : CTRL0_SDODIS_Field := NRF_SVD.SPI.Enable;
      --  Master/Slave selection
      MS             : CTRL0_MS_Field := NRF_SVD.SPI.Master;
      --  Interface format
      FORMAT         : CTRL0_FORMAT_Field := NRF_SVD.SPI.Spi;
      --  unspecified
      Reserved_5_5   : HAL.Bit := 16#0#;
      --  Write-only. SPI FSM and FIFO Reset
      FRESET         : CTRL0_FRESET_Field :=
                        NRF_SVD.SPI.CTRL0_FRESET_Field_00;
      --  Data length = DL[3:0]+1
      DL             : CTRL0_DL_Field := NRF_SVD.SPI.CTRL0_DL_Field_1111;
      --  TX FIFO Threshold level
      TXFIFOTH       : CTRL0_TXFIFOTH_Field :=
                        NRF_SVD.SPI.CTRL0_TXFIFOTH_Field_0;
      --  RX FIFO Threshold level
      RXFIFOTH       : CTRL0_RXFIFOTH_Field :=
                        NRF_SVD.SPI.CTRL0_RXFIFOTH_Field_0;
      --  Auto-SEL disable bit
      SELDIS         : CTRL0_SELDIS_Field := NRF_SVD.SPI.Disable;
      --  unspecified
   ...
   type CTRL1_Register is record
      --  MSB/LSB seletion
      MLSB          : CTRL1_MLSB_Field := NRF_SVD.SPI.Msb;
      --  Clock priority selection
      CPOL          : CTRL1_CPOL_Field := NRF_SVD.SPI.Low;
      --  Clock phase of edge sampling
      CPHA          : CTRL1_CPHA_Field := NRF_SVD.SPI.Cpha0;
      --  unspecified
   ...
   type IE_Register is record
      --  RX FIFO overflow interrupt enable
      RXOVFIE       : IE_RXOVFIE_Field := NRF_SVD.SPI.Disable;
      --  RX time-out interrupt enable
      RXTOIE        : IE_RXTOIE_Field := NRF_SVD.SPI.Disable;
      --  RX FIFO threshold interrupt enable
      RXFIFOTHIE    : IE_RXFIFOTHIE_Field := NRF_SVD.SPI.Disable;
      --  TX FIFO threshold interrupt enable
      TXFIFOTHIE    : IE_TXFIFOTHIE_Field := NRF_SVD.SPI.Disable;
      --  unspecified
   ...
   type IC_Register is record
      ...
      RXOVFIC       : IC_RXOVFIC_Field := NRF_SVD.SPI.No EFFECT;
      --  Write-only. RX time-out interrupt flag clear
      RXTOIC        : IC_RXTOIC_Field := NRF_SVD.SPI.No EFFECT;
      --  Write-only. RX Interrupt flag Clear
      RXFIFOTHIC    : IC_RXFIFOTHIC_Field := NRF_SVD.SPI.No EFFECT;
      --  Write-only. TX Interrupt flag Clear
      TXFIFOTHIC    : IC_TXFIFOTHIC_Field := NRF_SVD.SPI.No EFFECT;
      --  unspecified
      Reserved_4_31 : HAL.UInt28 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type DFDLY_DFETCH_EN_Field is
     (
      ...
      Enable)
     with Size => 1;
   for DFDLY_DFETCH_EN_Field use
     (Disable => 0,
      Enable => 1);

   --  Offset:0x20 SPI0 Data Fetch Register
   type DFDLY_Register is record
      --  SPI0 data fetch control bit
      DFETCH_EN     : DFDLY_DFETCH_EN_Field := NRF_SVD.SPI.Disable;
      --  unspecified
   ...
   for DFDLY_Register use record
      DFETCH_EN     at 0 range 0 .. 0;
   ...
   --  SPI0
   type SN_SPI0_Peripheral is record
      --  Offset:0x00 SPI0 Control Register 0
      ...
      --  Offset:0x20 SPI0 Data Fetch Register
      DFDLY  : aliased DFDLY_Register;
   end record
     with Volatile;

   for SN_SPI0_Peripheral use record
      ...
      DFDLY  at 16#20# range 0 .. 31;
   end record;

   --  SPI0
   SN_SPI0_Periph : aliased SN_SPI0_Peripheral
