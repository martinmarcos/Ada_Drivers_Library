...
package NRF_SVD.GPIO is
   ...
   --  CFG array
   type CFG_Field_Array is array (0 .. 11) of CFG_CFG0_Field
   ...
   type ODCTRL_Pn4OC_Field is
     (
      ...
      Enable)
     with Size => 1;
   for ODCTRL_Pn4OC_Field use
     (Disable => 0,
      Enable => 1);

   --  Pn.5 open-drain control
   type ODCTRL_Pn5OC_Field is
     (
      --  Disable
      Disable,
      --  Enable
      Enable)
     with Size => 1;
   for ODCTRL_Pn5OC_Field use
     (Disable => 0,
      Enable => 1);

   --  Pn.6 open-drain control
   type ODCTRL_Pn6OC_Field is
     (
      --  Disable
      Disable,
      --  Enable
      Enable)
     with Size => 1;
   for ODCTRL_Pn6OC_Field use
     (Disable => 0,
      Enable => 1);

   --  Pn.7 open-drain control
   type ODCTRL_Pn7OC_Field is
     (
      --  Disable
      Disable,
      --  Enable
   ...
   type ODCTRL_Register is record
      ...
      --  Pn.4 open-drain control
      Pn4OC         : ODCTRL_Pn4OC_Field := NRF_SVD.GPIO.Disable;
      --  Pn.5 open-drain control
      Pn5OC         : ODCTRL_Pn5OC_Field := NRF_SVD.GPIO.Disable;
      --  Pn.6 open-drain control
      Pn6OC         : ODCTRL_Pn6OC_Field := NRF_SVD.GPIO.Disable;
      --  Pn.7 open-drain control
      Pn7OC         : ODCTRL_Pn7OC_Field := NRF_SVD.GPIO.Disable;
      --  unspecified
   ...
   for ODCTRL_Register use record
      ...
      Pn4OC         at 0 range 4 .. 4;
      Pn5OC         at 0 range 5 .. 5;
      Pn6OC         at 0 range 6 .. 6;
      Pn7OC         at 0 range 7 .. 7;
