...
package NRF_SVD.SYSTEM is
   ...
   type APBCP0_CT32B2PRE_Field is
     (
      --  HCLK/1
      APBCP0_CT32B2PRE_Field_000B,
      --  HCLK/2
      APBCP0_CT32B2PRE_Field_001B,
      --  HCLK/4
      APBCP0_CT32B2PRE_Field_010B,
      --  HCLK/8
      APBCP0_CT32B2PRE_Field_011B,
      --  HCLK/16
      APBCP0_CT32B2PRE_Field_100B)
     with Size => 3;
   for APBCP0_CT32B2PRE_Field use
     (APBCP0_CT32B2PRE_Field_000B => 0,
      APBCP0_CT32B2PRE_Field_001B => 1,
      APBCP0_CT32B2PRE_Field_010B => 2,
      APBCP0_CT32B2PRE_Field_011B => 3,
      APBCP0_CT32B2PRE_Field_100B => 4);
   ...
   type APBCP0_Register is record
      ...
      CT32B2PRE      : APBCP0_CT32B2PRE_Field :=
                        NRF_SVD.SYSTEM.APBCP0_CT32B2PRE_Field_000B;
      --  unspecified
      Reserved_31_31 : HAL.Bit := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type APBCP1_CT16B2PRE_Field is
     (
      --  HCLK/1
      APBCP1_CT16B2PRE_Field_000B,
      --  HCLK/2
      APBCP1_CT16B2PRE_Field_001B,
      --  HCLK/4
      APBCP1_CT16B2PRE_Field_010B,
      --  HCLK/8
      APBCP1_CT16B2PRE_Field_011B,
      --  HCLK/16
      APBCP1_CT16B2PRE_Field_100B)
     with Size => 3;
   for APBCP1_CT16B2PRE_Field use
     (APBCP1_CT16B2PRE_Field_000B => 0,
      APBCP1_CT16B2PRE_Field_001B => 1,
      APBCP1_CT16B2PRE_Field_010B => 2,
      APBCP1_CT16B2PRE_Field_011B => 3,
      APBCP1_CT16B2PRE_Field_100B => 4);
   ...
   type APBCP1_Register is record
      ...
      CT16B2PRE      : APBCP1_CT16B2PRE_Field :=
                        NRF_SVD.SYSTEM.APBCP1_CT16B2PRE_Field_000B;
      --  unspecified
      Reserved_31_31 : HAL.Bit := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type APBCP2_CLKOUTPRE_Field is
     (
      --  FCLKOUT/1
      APBCP2_CLKOUTPRE_Field_0000B,
      --  FCLKOUT/2
      APBCP2_CLKOUTPRE_Field_0001B,
      --  FCLKOUT/4
      APBCP2_CLKOUTPRE_Field_0010B,
      --  FCLKOUT/8
      APBCP2_CLKOUTPRE_Field_0011B,
      --  FCLKOUT/16
      APBCP2_CLKOUTPRE_Field_0100B,
      --  FCLKOUT/32
      APBCP2_CLKOUTPRE_Field_0101B,
      --  FCLKOUT/64
      APBCP2_CLKOUTPRE_Field_0110B,
      --  FCLKOUT/128
      APBCP2_CLKOUTPRE_Field_0111B,
      --  FCLKOUT/256
      APBCP2_CLKOUTPRE_Field_1000B,
      --  FCLKOUT/512
      APBCP2_CLKOUTPRE_Field_1001B)
     with Size => 4;
   for APBCP2_CLKOUTPRE_Field use
     (APBCP2_CLKOUTPRE_Field_0000B => 0,
      APBCP2_CLKOUTPRE_Field_0001B => 1,
      APBCP2_CLKOUTPRE_Field_0010B => 2,
      APBCP2_CLKOUTPRE_Field_0011B => 3,
      APBCP2_CLKOUTPRE_Field_0100B => 4,
      APBCP2_CLKOUTPRE_Field_0101B => 5,
      APBCP2_CLKOUTPRE_Field_0110B => 6,
      APBCP2_CLKOUTPRE_Field_0111B => 7,
      APBCP2_CLKOUTPRE_Field_1000B => 8,
      APBCP2_CLKOUTPRE_Field_1001B => 9);

   --  Offset:0x0C APB Clock Prescale Register 2
   type APBCP2_Register is record
      --  CLKOUT APB clock source prescaler
      CLKOUTPRE     : APBCP2_CLKOUTPRE_Field :=
                       NRF_SVD.SYSTEM.APBCP2_CLKOUTPRE_Field_0000B;
      --  unspecified
      Reserved_4_31 : HAL.UInt28 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
