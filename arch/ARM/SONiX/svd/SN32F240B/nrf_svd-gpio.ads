...
package NRF_SVD.GPIO is
   ...
   type CFG_CFG0_Field is
     (
      ...
      CFG_CFG0_Field_00,
      --  No pull-up resistor enabled, Schmitt trigger enabled
      CFG_CFG0_Field_10,
      --  No pull-up resistor enabled, Schmitt trigger disabled
      CFG_CFG0_Field_11)
     with Size => 2;
   ...
   type CFG_CFG3_Field is
     (
      ...
      CFG_CFG3_Field_11)
     with Size => 2;
   for CFG_CFG3_Field use
     (CFG_CFG3_Field_00 => 0,
      CFG_CFG3_Field_10 => 2,
      CFG_CFG3_Field_11 => 3);

   --  CFG array
   type CFG_Field_Array_1 is array (3 .. 11) of CFG_CFG3_Field
   ...
   --  General Purpose I/O
   SN_GPIO1_Periph : aliased SN_GPIO0_Peripheral
     with Import, Address => System'To_Address (16#40046000#);

   --  General Purpose I/O
   SN_GPIO2_Periph : aliased SN_GPIO0_Peripheral
     with Import, Address => System'To_Address (16#40048000#);

   --  General Purpose I/O
   type SN_GPIO3_Peripheral is record
      --  Offset:0x00 GPIO Port n Data Register
   ...
   for SN_GPIO3_Peripheral use record
      DATA at 16#0# range 0 .. 31;
      MODE at 16#4# range 0 .. 31;
      CFG  at 16#8# range 0 .. 31;
      IS_k at 16#C# range 0 .. 31;
   ...
   --  General Purpose I/O
   SN_GPIO3_Periph : aliased SN_GPIO3_Peripheral
