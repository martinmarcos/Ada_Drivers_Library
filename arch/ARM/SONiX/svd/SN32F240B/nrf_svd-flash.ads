...
package NRF_SVD.FLASH is
   ...
   subtype LPCTRL_FMCKEY_Field is HAL.UInt16;
   ...
   type LPCTRL_Register is record
      ...
      --  Write-only. FMC register key
      FMCKEY        : LPCTRL_FMCKEY_Field := 16#0#;
   end record
   ...
   type CTRL_Register is record
      ...
      --  Mass erase mode chosen bit
      MER           : CTRL_MER_Field := NRF_SVD.FLASH.CTRL_MER_Field_0;
      --  unspecified
