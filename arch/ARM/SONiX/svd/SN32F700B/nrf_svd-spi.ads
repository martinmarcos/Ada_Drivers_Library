...
package NRF_SVD.SPI is
   ...
   --  Offset:0x00 SPIn Control Register 0
   type CTRL0_Register is record
      ...
      --  Write-only. FSM and FIFO Reset
      FRESET         : CTRL0_FRESET_Field :=
                        NRF_SVD.SPI.CTRL0_FRESET_Field_00B;
      --  Data length = DL[3:0]+1
      DL             : CTRL0_DL_Field := NRF_SVD.SPI.CTRL0_DL_Field_1111B;
      --  TX FIFO Threshold level
   ...
   --  Offset:0x04 SPIn Control Register 1
   ...
   --  Offset:0x08 SPIn Clock Divider Register
   type CLKDIV_Register is record
      --  SPIn SCK=SPIn_PCLK/(2*DIV+2)
   ...
   --  Offset:0x0C SPIn Status Register
   ...
   --  Offset:0x10 SPIn Interrupt Enable Register
   ...
   --  Offset:0x14 SPIn Raw Interrupt Status Register
   ...
   --  Offset:0x18 SPIn Interrupt Clear Register
   ...
   --  Offset:0x1C SPIn Data Register
   ...
   type DF_Register is record
      --  SPI data fetch control bit
      DF            : DF_DF_Field := NRF_SVD.SPI.Disable;
      --  unspecified
