...
package NRF_SVD.TIMER is
   ...
   for MCTRL_Register use record
      ...
      MR9IE          at 0 range 29 .. 29;
      MR9RST         at 0 range 30 .. 30;
      MR9STOP        at 0 range 31 .. 31;
   end record;
   ...
   --  EM array
   type EM_Field_Array is array (0 .. 3) of Boolean
   ...
   --  CT16Bn_PWM0N/GPIO selection
   type PWMCTRL_PWM0NIOEN_Field is
     (
      --  CT16Bn_PWM0N pin is act as GPIO
      PWMCTRL_PWM0NIOEN_Field_0,
      --  CT16Bn_PWM0N pin outputs the inverse signal with dead-band of
      --  CT16Bn_PWM0, but same High signal during dead-band period
      PWMCTRL_PWM0NIOEN_Field_1,
      --  CT16Bn_PWM0N pin outputs the inverse signal with dead-band of
      --  CT16Bn_PWM0, but same Low signal during dead-band period
      PWMCTRL_PWM0NIOEN_Field_2,
      --  CT16Bn_PWM0N pin outputs the same signal with dead-band of
      --  CT16Bn_PWM0
      PWMCTRL_PWM0NIOEN_Field_3)
     with Size => 2;
   for PWMCTRL_PWM0NIOEN_Field use
     (PWMCTRL_PWM0NIOEN_Field_0 => 0,
      PWMCTRL_PWM0NIOEN_Field_1 => 1,
      PWMCTRL_PWM0NIOEN_Field_2 => 2,
      PWMCTRL_PWM0NIOEN_Field_3 => 3);

   --  CT16Bn_PWM1N/GPIO selection
   type PWMCTRL_PWM1NIOEN_Field is
     (
      --  CT16Bn_PWM1N pin is act as GPIO
      PWMCTRL_PWM1NIOEN_Field_0,
      --  CT16Bn_PWM1N pin outputs the inverse signal with dead-band of
      --  CT16Bn_PWM1, but same High signal during dead-band period
      PWMCTRL_PWM1NIOEN_Field_1,
      --  CT16Bn_PWM1N pin outputs the inverse signal with dead-band of
      --  CT16Bn_PWM1, but same Low signal during dead-band period
      PWMCTRL_PWM1NIOEN_Field_2,
      --  CT16Bn_PWM1N pin outputs the same signal with dead-band of
      --  CT16Bn_PWM1
      PWMCTRL_PWM1NIOEN_Field_3)
     with Size => 2;
   for PWMCTRL_PWM1NIOEN_Field use
     (PWMCTRL_PWM1NIOEN_Field_0 => 0,
      PWMCTRL_PWM1NIOEN_Field_1 => 1,
      PWMCTRL_PWM1NIOEN_Field_2 => 2,
      PWMCTRL_PWM1NIOEN_Field_3 => 3);

   --  CT16Bn_PWM2N/GPIO selection
   type PWMCTRL_PWM2NIOEN_Field is
     (
      --  CT16Bn_PWM2N pin is act as GPIO
      PWMCTRL_PWM2NIOEN_Field_0,
      --  CT16Bn_PWM2N pin outputs the inverse signal with dead-band of
      --  CT16Bn_PWM2, but same High signal during dead-band period
      PWMCTRL_PWM2NIOEN_Field_1,
      --  CT16Bn_PWM2N pin outputs the inverse signal with dead-band of
      --  CT16Bn_PWM2, but same Low signal during dead-band period
      PWMCTRL_PWM2NIOEN_Field_2,
      --  CT16Bn_PWM2N pin outputs the same signal with dead-band of
      --  CT16Bn_PWM2
      PWMCTRL_PWM2NIOEN_Field_3)
     with Size => 2;
   for PWMCTRL_PWM2NIOEN_Field use
     (PWMCTRL_PWM2NIOEN_Field_0 => 0,
      PWMCTRL_PWM2NIOEN_Field_1 => 1,
      PWMCTRL_PWM2NIOEN_Field_2 => 2,
      PWMCTRL_PWM2NIOEN_Field_3 => 3);

   --  CT16Bn_PWM3N/GPIO selection
   type PWMCTRL_PWM3NIOEN_Field is
     (
      --  CT16Bn_PWM3N pin is act as GPIO
      PWMCTRL_PWM3NIOEN_Field_0,
      --  CT16Bn_PWM3N pin outputs the inverse signal with dead-band of
      --  CT16Bn_PWM3, but same High signal during dead-band period
      PWMCTRL_PWM3NIOEN_Field_1,
      --  CT16Bn_PWM3N pin outputs the inverse signal with dead-band of
      --  CT16Bn_PWM3, but same Low signal during dead-band period
      PWMCTRL_PWM3NIOEN_Field_2,
      --  CT16Bn_PWM3N pin outputs the same signal with dead-band of
      --  CT16Bn_PWM3
      PWMCTRL_PWM3NIOEN_Field_3)
     with Size => 2;
   for PWMCTRL_PWM3NIOEN_Field use
     (PWMCTRL_PWM3NIOEN_Field_0 => 0,
      PWMCTRL_PWM3NIOEN_Field_1 => 1,
      PWMCTRL_PWM3NIOEN_Field_2 => 2,
      PWMCTRL_PWM3NIOEN_Field_3 => 3);
   ...
   type PWMCTRL_Register is record
      ...
      --  CT16Bn_PWM0N/GPIO selection
      PWM0NIOEN      : PWMCTRL_PWM0NIOEN_Field :=
                        NRF_SVD.TIMER.PWMCTRL_PWM0NIOEN_Field_0;
      --  CT16Bn_PWM1N/GPIO selection
      PWM1NIOEN      : PWMCTRL_PWM1NIOEN_Field :=
                        NRF_SVD.TIMER.PWMCTRL_PWM1NIOEN_Field_0;
      --  CT16Bn_PWM2N/GPIO selection
      PWM2NIOEN      : PWMCTRL_PWM2NIOEN_Field :=
                        NRF_SVD.TIMER.PWMCTRL_PWM2NIOEN_Field_0;
      --  CT16Bn_PWM3N/GPIO selection
      PWM3NIOEN      : PWMCTRL_PWM3NIOEN_Field :=
                        NRF_SVD.TIMER.PWMCTRL_PWM3NIOEN_Field_0;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   for PWMCTRL_Register use record
      ...
      PWM0NIOEN      at 0 range 24 .. 25;
      PWM1NIOEN      at 0 range 26 .. 27;
      PWM2NIOEN      at 0 range 28 .. 29;
      PWM3NIOEN      at 0 range 30 .. 31;
   end record;
   ...
   --  Offset:0x44 CT16Bn PWM0N Dead-band Period Register
   ...
   --  Offset:0x48 CT16Bn PWM1N Dead-band Period Register
   ...
   --  Offset:0x4C CT16Bn PWM2N Dead-band Period Register
   ...
   subtype PWM3NDB_DB_Field is HAL.UInt10;

   --  Offset:0x50 CT16Bn PWM3N Dead-band Period Register
   type PWM3NDB_Register is record
      --  PWM3N output dead-band period time=DB*CT16Bn_PCLK cycle
      DB             : PWM3NDB_DB_Field := 16#0#;
      --  unspecified
      Reserved_10_31 : HAL.UInt22 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for PWM3NDB_Register use record
      DB             at 0 range 0 .. 9;
      Reserved_10_31 at 0 range 10 .. 31;
   end record;
   ...
   type TIMER_Peripheral is record
      ...
      --  Offset:0x50 CT16Bn PWM3N Dead-band Period Register
      PWM3NDB : aliased PWM3NDB_Register;
   end record
     with Volatile;
   ...
   for TIMER_Peripheral use record
      ...
      PWM0NDB at 16#44# range 0 .. 31;
      PWM1NDB at 16#48# range 0 .. 31;
      PWM2NDB at 16#4C# range 0 .. 31;
      PWM3NDB at 16#50# range 0 .. 31;
   end record;

   --  16-bit Timer 0 with Capture function
   SN_CT16B0_Periph : aliased TIMER_Peripheral
     with Import, Address => System'To_Address (16#40000000#);

   --  16-bit Timer 0 with Capture function
   SN_CT16B1_Periph : aliased TIMER_Peripheral
     with Import, Address => System'To_Address (16#40002000#);

   --  16-bit Timer 0 with Capture function
   SN_CT16B2_Periph : aliased TIMER_Peripheral
