...
package NRF_SVD.SSP is
   ...
   type CTRL0_FRESET_Field is
     (
      --  No effect
      CTRL0_FRESET_Field_00,
      --  Reset FSM and FIFO
      CTRL0_FRESET_Field_11)
     with Size => 2;
   for CTRL0_FRESET_Field use
     (CTRL0_FRESET_Field_00 => 0,
      CTRL0_FRESET_Field_11 => 3);
   ...
   for CTRL0_DL_Field use
     (CTRL0_DL_Field_0010 => 2,
      CTRL0_DL_Field_0011 => 3,
      CTRL0_DL_Field_0100 => 4,
      CTRL0_DL_Field_0101 => 5,
      CTRL0_DL_Field_0110 => 6,
      CTRL0_DL_Field_0111 => 7,
      CTRL0_DL_Field_1000 => 8,
      CTRL0_DL_Field_1001 => 9,
      CTRL0_DL_Field_1010 => 10,
      CTRL0_DL_Field_1011 => 11,
      CTRL0_DL_Field_1100 => 12,
      CTRL0_DL_Field_1101 => 13,
      CTRL0_DL_Field_1110 => 14,
      CTRL0_DL_Field_1111 => 15);

   --  TX FIFO Threshold level
   type CTRL0_TXFIFOTH_Field is
     (
      --  TX FIFO threshold level is 0
      CTRL0_TXFIFOTH_Field_000,
      --  TX FIFO threshold level is 1
      CTRL0_TXFIFOTH_Field_001,
      --  TX FIFO threshold level is 2
      CTRL0_TXFIFOTH_Field_010,
      --  TX FIFO threshold level is 3
      CTRL0_TXFIFOTH_Field_011,
      --  TX FIFO threshold level is 4
      CTRL0_TXFIFOTH_Field_100,
      --  TX FIFO threshold level is 5
      CTRL0_TXFIFOTH_Field_101,
      --  TX FIFO threshold level is 6
      CTRL0_TXFIFOTH_Field_110,
      --  TX FIFO threshold level is 7
      CTRL0_TXFIFOTH_Field_111)
     with Size => 3;
   for CTRL0_TXFIFOTH_Field use
     (CTRL0_TXFIFOTH_Field_000 => 0,
      CTRL0_TXFIFOTH_Field_001 => 1,
      CTRL0_TXFIFOTH_Field_010 => 2,
      CTRL0_TXFIFOTH_Field_011 => 3,
      CTRL0_TXFIFOTH_Field_100 => 4,
      CTRL0_TXFIFOTH_Field_101 => 5,
      CTRL0_TXFIFOTH_Field_110 => 6,
      CTRL0_TXFIFOTH_Field_111 => 7);

   --  Rx FIFO Threshold level
   type CTRL0_RXFIFOTH_Field is
     (
      --  Rx FIFO threshold level is 0
      CTRL0_RXFIFOTH_Field_000,
      --  Rx FIFO threshold level is 1
      CTRL0_RXFIFOTH_Field_001,
      --  Rx FIFO threshold level is 2
      CTRL0_RXFIFOTH_Field_010,
      --  Rx FIFO threshold level is 3
      CTRL0_RXFIFOTH_Field_011,
      --  Rx FIFO threshold level is 4
      CTRL0_RXFIFOTH_Field_100,
      --  Rx FIFO threshold level is 5
      CTRL0_RXFIFOTH_Field_101,
      --  Rx FIFO threshold level is 6
      CTRL0_RXFIFOTH_Field_110,
      --  Rx FIFO threshold level is 7
      CTRL0_RXFIFOTH_Field_111)
     with Size => 3;
   for CTRL0_RXFIFOTH_Field use
     (CTRL0_RXFIFOTH_Field_000 => 0,
      CTRL0_RXFIFOTH_Field_001 => 1,
      CTRL0_RXFIFOTH_Field_010 => 2,
      CTRL0_RXFIFOTH_Field_011 => 3,
      CTRL0_RXFIFOTH_Field_100 => 4,
      CTRL0_RXFIFOTH_Field_101 => 5,
      CTRL0_RXFIFOTH_Field_110 => 6,
      CTRL0_RXFIFOTH_Field_111 => 7);
   ...
   --  Source for SEL pin
   type CTRL0_SELCTRL_Field is
     (
      --  SEL pin is low level.
      Sel-Low,
      --  SEL pin is high level.
      Sel-High)
     with Size => 1;
   for CTRL0_SELCTRL_Field use
     (Sel-Low => 0,
      Sel-High => 1);
   ...
   type CTRL0_Register is record
      ...
      FRESET         : CTRL0_FRESET_Field :=
                        NRF_SVD.SSP.CTRL0_FRESET_Field_00;
      --  Data length = DL[3:0]+1
      DL             : CTRL0_DL_Field := NRF_SVD.SSP.CTRL0_DL_Field_1111;
      --  TX FIFO Threshold level
      TXFIFOTH       : CTRL0_TXFIFOTH_Field :=
                        NRF_SVD.SSP.CTRL0_TXFIFOTH_Field_000;
      --  Rx FIFO Threshold level
      RXFIFOTH       : CTRL0_RXFIFOTH_Field :=
                        NRF_SVD.SSP.CTRL0_RXFIFOTH_Field_000;
      --  Auto-SEL disable bit
      SELDIS         : CTRL0_SELDIS_Field := NRF_SVD.SSP.Enable Auto-Sel;
      --  Source for SEL pin
      SELCTRL        : CTRL0_SELCTRL_Field := NRF_SVD.SSP.Sel-Low;
      --  unspecified
   ...
   type STAT_TXFIFOTHF_Field is
     (
      --  Data in TX FIFO is larger than TXFIFOTH
      Tx Fifo IS LARGER THAN Txfifoth,
      --  Data in TX FIFO is less equal than TXFIFOTH
      Tx Fifo IS LESS EQUAL THAN Txfifoth)
     with Size => 1;
   for STAT_TXFIFOTHF_Field use
     (Tx Fifo IS LARGER THAN Txfifoth => 0,
      Tx Fifo IS LESS EQUAL THAN Txfifoth => 1);

   --  RX FIFO threshold flag
   type STAT_RXFIFOTHF_Field is
     (
      --  Data in RX FIFO is less equal than RXFIFOTH
      Rx Fifo IS LESS EQUAL THAN Rxfifoth,
      --  Data in RX FIFO is larger than RXFIFOTH
      Rx Fifo IS LARGER THAN Rxfifoth)
     with Size => 1;
   for STAT_RXFIFOTHF_Field use
     (Rx Fifo IS LESS EQUAL THAN Rxfifoth => 0,
      Rx Fifo IS LARGER THAN Rxfifoth => 1);
