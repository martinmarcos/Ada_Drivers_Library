...
package NRF_SVD.SCU is
   ...
   subtype VDCCON_TC_S_Field is HAL.UInt2;
   ...
   type VDCCON_Register is record
      ...
      --  Write-only. VDC trim value
      VDCTRIM        : VDCCON_VDCTRIM_Field := 16#0#;
      --  unspecified
      Reserved_20_22 : HAL.UInt3 := 16#0#;
      --  Write-only. VDC BGR/BMR trim value write enable
      VDCTE          : Boolean := False;
      --  Write-only. VDC BIMODE value write enable bit
      BIMODE         : Boolean := False;
      --  Write-only. VDC STOP MODE Select bit
      STOPSEL        : Boolean := False;
      --  Write-only. OSC TC Compensation
      TC_S           : VDCCON_TC_S_Field := 16#0#;
      --  Write-only. VDC STOP MODE Enable bit
      STOPEN         : Boolean := False;
      --  Write-only. VDD18 Up Option Enable bit
      VDCOPT         : Boolean := False;
      --  unspecified
   ...
   for VDCCON_Register use record
      ...
      BIMODE         at 0 range 24 .. 24;
      STOPSEL        at 0 range 25 .. 25;
      TC_S           at 0 range 26 .. 27;
      STOPEN         at 0 range 28 .. 28;
      VDCOPT         at 0 range 29 .. 29;
   ...
   subtype HSIOSCTRIM_UDCL_Field is HAL.UInt3;
   subtype HSIOSCTRIM_UDCH_Field is HAL.UInt2;
   subtype HSIOSCTRIM_LT_LTM_Field is HAL.UInt7;
   subtype HSIOSCTRIM_TSL_Field is HAL.UInt3;

   --  High Speed Internal OSC Trim Register
   type HSIOSCTRIM_Register is record
      --  Internal oscillator UDC trim value
      UDCL           : HSIOSCTRIM_UDCL_Field := 16#7#;
      --  Internal oscillator UDC trim value
      UDCH           : HSIOSCTRIM_UDCH_Field := 16#3#;
      --  unspecified
      Reserved_5_6   : HAL.UInt2 := 16#3#;
      --  Write-only. UDCH/UDCL value write enable
      UDCEN          : Boolean := True;
      --  Internal oscillator LT trim value
      LT_LTM         : HSIOSCTRIM_LT_LTM_Field := 16#0#;
      --  Write-only. LTM_LT value write enable
      LTEN           : Boolean := True;
      --  TSL trim value
      TSL            : HSIOSCTRIM_TSL_Field := 16#7#;
      --  unspecified
      Reserved_19_22 : HAL.UInt4 := 16#E#;
      --  Write-only. TSL trim value write enable
      TSLEN          : Boolean := False;
      --  unspecified
      Reserved_24_26 : HAL.UInt3 := 16#0#;
      --  Adpaptive calibration clock function enable
      ADCALON        : Boolean := False;
      --  unspecified
   ...
   subtype LSIOSC_CTR_Field is HAL.UInt4;

   --  Low Speed Internal OSC Trim Register
   type LSIOSC_Register is record
      --  CTR
      CTR           : LSIOSC_CTR_Field := 16#0#;
      --  unspecified
      Reserved_4_6  : HAL.UInt3 := 16#0#;
      --  CTRTRIMEN
      CTRTRIMEN     : Boolean := False;
      --  unspecified
      Reserved_8_31 : HAL.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for LSIOSC_Register use record
      CTR           at 0 range 0 .. 3;
      Reserved_4_6  at 0 range 4 .. 6;
      CTRTRIMEN     at 0 range 7 .. 7;
      Reserved_8_31 at 0 range 8 .. 31;
   end record;
   ...
   subtype MCCR4_PBDCSEL_Field is HAL.UInt3;
   ...
   type MCCR4_Register is record
      ...
      PBDCSEL        : MCCR4_PBDCSEL_Field := 16#0#;
      --  unspecified
      Reserved_27_31 : HAL.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype MCCR5_PCDCSEL_Field is HAL.UInt3;
   ...
   type MCCR5_Register is record
      ...
      PCDCSEL        : MCCR5_PCDCSEL_Field := 16#0#;
      --  unspecified
      Reserved_11_15 : HAL.UInt5 := 16#0#;
   ...
   subtype MCCR7_UARTCDIV_Field is HAL.UInt8;
   subtype MCCR7_UARTCSEL_Field is HAL.UInt3;
   subtype MCCR7_ADCCDIV_Field is HAL.UInt8;
   subtype MCCR7_ADCCSEL_Field is HAL.UInt3;

   --  Miscellaneous Clock Control Register 7
   type MCCR7_Register is record
      --  UART Clock N divider
      UARTCDIV       : MCCR7_UARTCDIV_Field := 16#0#;
      --  UART clock source select bit
      UARTCSEL       : MCCR7_UARTCSEL_Field := 16#0#;
      --  unspecified
      Reserved_11_15 : HAL.UInt5 := 16#0#;
      --  ADC Clock N divider
      ADCCDIV        : MCCR7_ADCCDIV_Field := 16#1#;
   ...
   type SCU_Peripheral is record
      ...
      --  Low Speed Internal OSC Trim Register
      LSIOSC     : aliased LSIOSC_Register;
      --  External Main Oscillator Control Register
