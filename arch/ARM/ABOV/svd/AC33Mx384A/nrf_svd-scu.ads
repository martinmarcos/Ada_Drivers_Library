...
package NRF_SVD.SCU is
   ...
   type WUSR_Register is record
      ...
      --  GPIOEWU
      GPIOEWU        : Boolean := False;
      --  GPIOFWU
      GPIOFWU        : Boolean := False;
      --  unspecified
      Reserved_14_31 : HAL.UInt18 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for CMR_Register use record
      ...
      SXOSCSTS       at 0 range 8 .. 8;
      SXOSCFAIL      at 0 range 9 .. 9;
      SXOSCIE        at 0 range 10 .. 10;
      SXOSCMNT       at 0 range 11 .. 11;
      Reserved_12_14 at 0 range 12 .. 14;
      MCLKREC        at 0 range 15 .. 15;
      Reserved_16_31 at 0 range 16 .. 31;
   end record;

   subtype NMIR_ACODE_Field is HAL.UInt12;
   ...
   type NMIR_Register is record
      ...
      --  NMIPINDBE
      NMIPINDBE      : Boolean := False;
      --  NMICLR
      NMICLR         : Boolean := False;
      --  NMIPINF
      NMIPINF        : Boolean := False;
      --  0xA32 to write
   ...
   for NMIR_Register use record
      ...
      NMIINTSTS      at 0 range 13 .. 13;
      Reserved_14_16 at 0 range 14 .. 16;
      NMIPINDBE      at 0 range 17 .. 17;
      NMICLR         at 0 range 18 .. 18;
      NMIPINF        at 0 range 19 .. 19;
      ACODE          at 0 range 20 .. 31;
   end record;
   ...
   type EOSCR_Register is record
      --  Select noise cancel delay
      NCSEL          : EOSCR_NCSEL_Field := 16#0#;
      --  unspecified
      Reserved_2_6   : HAL.UInt5 := 16#0#;
      --  Write-only. Write enable of bit field NCSEL
      NCEN           : Boolean := False;
      --  select current
   ...
   subtype MCCR6_PEDDIV_Field is HAL.UInt8;
   subtype MCCR6_PEDCSEL_Field is HAL.UInt3;
   subtype MCCR6_PFDDIV_Field is HAL.UInt8;
   subtype MCCR6_PFDCSEL_Field is HAL.UInt3;

   --  Miscellaneous Clock Control Register 6
   type MCCR6_Register is record
      --  PORT E debounce divider
      PEDDIV         : MCCR6_PEDDIV_Field := 16#1#;
      --  debouce clock for port E source clock sel
      PEDCSEL        : MCCR6_PEDCSEL_Field := 16#0#;
      --  unspecified
      Reserved_11_15 : HAL.UInt5 := 16#0#;
      --  PORT F debounce divider
      PFDDIV         : MCCR6_PFDDIV_Field := 16#1#;
      --  debouce clock for port F source clock sel
      PFDCSEL        : MCCR6_PFDCSEL_Field := 16#0#;
      --  unspecified
      Reserved_27_31 : HAL.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype MCCR7_NMIDDIV_Field is HAL.UInt8;
   subtype MCCR7_NMIDCSEL_Field is HAL.UInt3;
   ...
   type MCCR7_Register is record
      ...
      NMIDDIV        : MCCR7_NMIDDIV_Field := 16#1#;
      --  Debounce Clock for NMI source select bit
      NMIDCSEL       : MCCR7_NMIDCSEL_Field := 16#0#;
      --  unspecified
      Reserved_11_15 : HAL.UInt5 := 16#0#;
      --  ADC Clock N divider
