...
package NRF_SVD.IIC is
   ...
   type CR_Register is record
      ...
      --  Interrupt flag bit
      IIF            : Boolean := False;
      --  Interval delay value between address and data transfer
   ...
   --  IIC SCL HIGH duration Register
   ...
   --  IIC Interface
   IC0_Periph : aliased IIC_Peripheral
     with Import, Address => System'To_Address (16#4000A000#);

   --  IIC Interface
   IC1_Periph : aliased IIC_Peripheral
     with Import, Address => System'To_Address (16#4000A100#);
