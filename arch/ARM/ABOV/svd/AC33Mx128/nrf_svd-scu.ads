...
package NRF_SVD.SCU is
   ...
   --  PER2_IIC array
   type PER2_IIC_Field_Array is array (0 .. 1) of Boolean
     with Component_Size => 1, Size => 2;

   --  Type definition for PER2_IIC
   type PER2_IIC_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         ...
         when True =>
            --  IIC as an array
            Arr : PER2_IIC_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 2;

   for PER2_IIC_Field use record
      Val at 0 range 0 .. 1;
      Arr at 0 range 0 .. 1;
   end record;
   ...
   type PER2_Register is record
      ...
      Reserved_2_3   : HAL.UInt2 := 16#0#;
      --  IIC0 Enable
      IIC            : PER2_IIC_Field := (As_Array => False, Val => 16#0#);
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  UART0 Enable
   ...
   --  PCER2_IIC array
   type PCER2_IIC_Field_Array is array (0 .. 1) of Boolean
     with Component_Size => 1, Size => 2;

   --  Type definition for PCER2_IIC
   type PCER2_IIC_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
         ...
         when True =>
            --  IIC as an array
            Arr : PCER2_IIC_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 2;

   for PCER2_IIC_Field use record
      Val at 0 range 0 .. 1;
      Arr at 0 range 0 .. 1;
   end record;
   ...
   type PCER2_Register is record
      ...
      Reserved_2_3   : HAL.UInt2 := 16#0#;
      --  IIC0 Enable
      IIC            : PCER2_IIC_Field := (As_Array => False, Val => 16#0#);
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  UART0 Enable
   ...
   subtype NMIR_SCUAA_Field is HAL.UInt8;
   ...
   subtype OPA0TRIM_GTRIML_Field is HAL.UInt2;
   subtype OPA0TRIM_GTRIMH_Field is HAL.UInt2;
   ...
   type OPA0TRIM_Register is record
      ...
      --  GTRIML
      GTRIML         : OPA0TRIM_GTRIML_Field := 16#2#;
      --  GTRIMH
      GTRIMH         : OPA0TRIM_GTRIMH_Field := 16#0#;
      --  unspecified
   ...
   for OPA0TRIM_Register use record
      ...
      GTRIML         at 0 range 8 .. 9;
      GTRIMH         at 0 range 10 .. 11;
   ...
   subtype OPA1TRIM_GTRIML_Field is HAL.UInt2;
   subtype OPA1TRIM_GTRIMH_Field is HAL.UInt2;
   ...
   type OPA1TRIM_Register is record
      ...
      ATRIMEN        : Boolean := False;
      --  GTRIML
      GTRIML         : OPA1TRIM_GTRIML_Field := 16#2#;
      --  GTRIMH
      GTRIMH         : OPA1TRIM_GTRIMH_Field := 16#0#;
      --  unspecified
      Reserved_12_14 : HAL.UInt3 := 16#0#;
      --  Write-only. GTRIMEN
      GTRIMEN        : Boolean := False;
   ...
   subtype OPA2TRIM_GTRIML_Field is HAL.UInt2;
   subtype OPA2TRIM_GTRIMH_Field is HAL.UInt2;
   ...
   type OPA2TRIM_Register is record
      ...
      ATRIMEN        : Boolean := False;
      --  GTRIML
      GTRIML         : OPA2TRIM_GTRIML_Field := 16#2#;
      --  GTRIMH
      GTRIMH         : OPA2TRIM_GTRIMH_Field := 16#0#;
      --  unspecified
      Reserved_12_14 : HAL.UInt3 := 16#0#;
      --  Write-only. GTRIMEN
      GTRIMEN        : Boolean := False;
   ...
   subtype OPA3TRIM_GTRIML_Field is HAL.UInt2;
   subtype OPA3TRIM_GTRIMH_Field is HAL.UInt2;
   ...
   type OPA3TRIM_Register is record
      ...
      ATRIMEN        : Boolean := False;
      --  GTRIML
      GTRIML         : OPA3TRIM_GTRIML_Field := 16#2#;
      --  GTRIMH
      GTRIMH         : OPA3TRIM_GTRIMH_Field := 16#0#;
      --  unspecified
      Reserved_12_14 : HAL.UInt3 := 16#0#;
      --  Write-only. GTRIMEN
      GTRIMEN        : Boolean := False;
   ...
   subtype MCCR6_ETCDDIV_Field is HAL.UInt8;
   subtype MCCR6_ETCDCSEL_Field is HAL.UInt3;
   subtype MCCR6_ADCCDIV_Field is HAL.UInt8;
   subtype MCCR6_ADCCSEL_Field is HAL.UInt3;

   --  Miscellaneous Clock Control Register 6
   type MCCR6_Register is record
      --  ETC Debounce clock divider
      ETCDDIV        : MCCR6_ETCDDIV_Field := 16#1#;
      --  Debouce clock for ETC source clock sel
      ETCDCSEL       : MCCR6_ETCDCSEL_Field := 16#0#;
      --  unspecified
      Reserved_11_15 : HAL.UInt5 := 16#0#;
      --  ADC Clock N divider
      ADCCDIV        : MCCR6_ADCCDIV_Field := 16#0#;
      --  ADC clock source select bitl
      ADCCSEL        : MCCR6_ADCCSEL_Field := 16#0#;
      --  unspecified
      Reserved_27_31 : HAL.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type SCU_Peripheral is record
      ...
      --  Trim Area Access Enable
      TRIMENT  : aliased HAL.UInt32;
      --  PLL Control Register
