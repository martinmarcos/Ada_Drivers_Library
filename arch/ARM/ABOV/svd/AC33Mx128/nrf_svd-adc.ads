...
package NRF_SVD.ADC is
   ...
   --  TRG_MP0TRG array element
   subtype TRG_MP0TRG_Element is HAL.UInt4;

   --  TRG_MP0TRG array
   type TRG_MP0TRG_Field_Array is array (1 .. 6) of TRG_MP0TRG_Element
     with Component_Size => 4, Size => 24;

   --  Type definition for TRG_MP0TRG
   type TRG_MP0TRG_Field
   ...
   is record
      case As_Array is
         ...
         when True =>
            --  MP0TRG as an array
            Arr : TRG_MP0TRG_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 24;

   for TRG_MP0TRG_Field use record
      Val at 0 range 0 .. 23;
      Arr at 0 range 0 .. 23;
   end record;

   subtype TRG_TRGnEN_Field is HAL.UInt6;

   --  ADC Trigger 0 Channel Register
   type TRG_Register is record
      --  ADC channel n select for MPWM0 ADC trigger1 operation
      MP0TRG         : TRG_MP0TRG_Field := (As_Array => False, Val => 16#0#);
      --  MP0TRGn enable
      TRGnEN         : TRG_TRGnEN_Field := 16#0#;
      --  unspecified
   ...
   type ADC_Peripheral is record
      ...
      --  ADC Trigger 0 Channel Register
      TRG0 : aliased TRG_Register;
      --  ADC Trigger 1 Channel Register
      TRG1 : aliased TRG_Register;
      --  ADC Trigger 2 Channel Register
