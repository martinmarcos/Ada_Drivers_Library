...
package NRF_SVD.SPI is
   ...
   subtype RDR_RDR_Field is HAL.UInt16;
   ...
   subtype TDR_TDR_Field is HAL.UInt16;
   ...
   type CR_Register is record
      ...
      DTXIE          : Boolean := False;
      --  Recieve buffer flushing enable
      RXBF           : Boolean := False;
      --  TX Buffer flushing enable bitr
      TXBF           : Boolean := False;
      --  unspecified
   ...
   for CR_Register use record
      ...
      DRXIE          at 0 range 17 .. 17;
      DTXIE          at 0 range 18 .. 18;
      RXBF           at 0 range 19 .. 19;
      TXBF           at 0 range 20 .. 20;
   ...
   type SR_Register is record
      ...
      RXDMAF         : Boolean := False;
      --  DMA transmit Operation complete flag
      TXDMAF         : Boolean := False;
      --  unspecified
   ...
   for SR_Register use record
      RRDY           at 0 range 0 .. 0;
      TRDY           at 0 range 1 .. 1;
      S_BUSY         at 0 range 2 .. 2;
      UDRF           at 0 range 3 .. 3;
      OVRF           at 0 range 4 .. 4;
      SSON           at 0 range 5 .. 5;
      SSDET          at 0 range 6 .. 6;
      SBUSY          at 0 range 7 .. 7;
      RXDMAF         at 0 range 8 .. 8;
      TXDMAF         at 0 range 9 .. 9;
   ...
   --  SERIAL PERIPHERAL INTERFACE
   SP0_Periph : aliased SPI_Peripheral
     with Import, Address => System'To_Address (16#40009000#);

   --  SERIAL PERIPHERAL INTERFACE
   SP1_Periph : aliased SPI_Peripheral
     with Import, Address => System'To_Address (16#40009100#);
