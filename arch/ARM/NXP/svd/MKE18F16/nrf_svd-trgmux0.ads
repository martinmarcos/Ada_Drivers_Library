...
package NRF_SVD.TRGMUX0 is
   ...
   subtype TRGMUX_ADC_SEL2_Field is HAL.UInt6;
   subtype TRGMUX_ADC_SEL3_Field is HAL.UInt6;
   ...
   type TRGMUX_ADC_Register is record
      ...
      Reserved_14_15 : HAL.UInt2 := 16#0#;
      --  Trigger MUX Input 2 Source Select
      SEL2           : TRGMUX_ADC_SEL2_Field := 16#0#;
      --  unspecified
      Reserved_22_23 : HAL.UInt2 := 16#0#;
      --  Trigger MUX Input 3 Source Select
      SEL3           : TRGMUX_ADC_SEL3_Field := 16#0#;
      --  unspecified
      Reserved_30_30 : HAL.Bit := 16#0#;
      --  Read-only. Enable
   ...
   subtype TRGMUX_DAC0_SEL0_Field is HAL.UInt6;
   ...
   type TRGMUX_DAC0_Register is record
      ...
      --  Read-only. Enable
      LK            : TRGMUX_DAC0_LK_Field := NRF_SVD.TRGMUX0.Lk_0;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype TRGMUX_FTM_SEL3_Field is HAL.UInt6;
   ...
   type TRGMUX_FTM_Register is record
      ...
      Reserved_22_23 : HAL.UInt2 := 16#0#;
      --  Trigger MUX Input 3 Source Select
      SEL3           : TRGMUX_FTM_SEL3_Field := 16#0#;
      --  unspecified
      Reserved_30_30 : HAL.Bit := 16#0#;
      --  Read-only. Enable
   ...
   subtype TRGMUX_PDB_SEL0_Field is HAL.UInt6;
   ...
   --  TRGMUX Register
   type TRGMUX_PDB_Register is record
      --  Trigger MUX Input 0 Source Select
      SEL0          : TRGMUX_PDB_SEL0_Field := 16#0#;
      --  unspecified
      Reserved_6_30 : HAL.UInt25 := 16#0#;
      --  Read-only. Enable
   ...
   for TRGMUX_PDB_Register use record
      SEL0          at 0 range 0 .. 5;
      Reserved_6_30 at 0 range 6 .. 30;
      LK            at 0 range 31 .. 31;
   end record;
   ...
   type TRGMUX0_Peripheral is record
      ...
      --  TRGMUX Register
      TRGMUX_ADC2    : aliased TRGMUX_ADC_Register;
      --  TRGMUX Register
      ...
      --  TRGMUX Register
      TRGMUX_CMP2    : aliased TRGMUX_CMP_Register;
      --  TRGMUX Register
      TRGMUX_FTM0    : aliased TRGMUX_FTM_Register;
      --  TRGMUX Register
      TRGMUX_FTM1    : aliased TRGMUX_FTM_Register;
      --  TRGMUX Register
      TRGMUX_FTM2    : aliased TRGMUX_FTM_Register;
      --  TRGMUX Register
      TRGMUX_FTM3    : aliased TRGMUX_FTM_Register;
      --  TRGMUX Register
      TRGMUX_PDB0    : aliased TRGMUX_PDB_Register;
      --  TRGMUX Register
      TRGMUX_PDB1    : aliased TRGMUX_PDB_Register;
      --  TRGMUX Register
      TRGMUX_PDB2    : aliased TRGMUX_PDB_Register;
      --  TRGMUX Register
   ...
   for TRGMUX0_Peripheral use record
      ...
      TRGMUX_ADC2    at 16#14# range 0 .. 31;
      TRGMUX_DAC0    at 16#18# range 0 .. 31;
      TRGMUX_CMP0    at 16#1C# range 0 .. 31;
      TRGMUX_CMP1    at 16#20# range 0 .. 31;
      TRGMUX_CMP2    at 16#24# range 0 .. 31;
      TRGMUX_FTM0    at 16#28# range 0 .. 31;
      TRGMUX_FTM1    at 16#2C# range 0 .. 31;
      TRGMUX_FTM2    at 16#30# range 0 .. 31;
      TRGMUX_FTM3    at 16#34# range 0 .. 31;
      TRGMUX_PDB0    at 16#38# range 0 .. 31;
      TRGMUX_PDB1    at 16#3C# range 0 .. 31;
      TRGMUX_PDB2    at 16#40# range 0 .. 31;
