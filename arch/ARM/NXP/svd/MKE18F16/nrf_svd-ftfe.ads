...
package NRF_SVD.FTFE is
   ...
   type FERSTAT_DFDIF_Field is
     (
      --  Double bit fault not detected during a valid flash read access from
      --  the platform flash controller
      Dfdif_0,
      --  Double bit fault detected (or FERCNFG[FDFD] is set) during a valid
   ...
   type FTFE_FERSTAT_Register is record
      --  unspecified
      Reserved_0_0 : HAL.Bit := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. Double Bit Fault Detect Interrupt Flag
      DFDIF        : FERSTAT_DFDIF_Field := NRF_SVD.FTFE.Dfdif_0;
      --  unspecified
      Reserved_2_7 : HAL.UInt6 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 8, Bit_Order => System.Low_Order_First;

   for FTFE_FERSTAT_Register use record
   ...
   type FERCNFG_DFDIE_Field is
     (
      ...
      Dfdie_0,
      --  Double bit fault detect interrupt enabled. An interrupt request is
   ...
   type FERCNFG_FDFD_Field is
     (
      --  FERSTAT[DFDIF] sets only if a double bit fault is detected during
      --  read access from the platform flash controller
      Fdfd_0,
      --  FERSTAT[DFDIF] sets during any valid flash read access from the
      --  platform flash controller. An interrupt request is generated if the
      --  DFDIE bit is set.
      Fdfd_1)
     with Size => 1;
   for FERCNFG_FDFD_Field use
     (Fdfd_0 => 0,
      Fdfd_1 => 1);

   --  Flash Error Configuration Register
   type FTFE_FERCNFG_Register is record
      --  unspecified
      Reserved_0_0 : HAL.Bit := 16#0#;
      --  Double Bit Fault Detect Interrupt Enable
      DFDIE        : FERCNFG_DFDIE_Field := NRF_SVD.FTFE.Dfdie_0;
      --  unspecified
      Reserved_2_4 : HAL.UInt3 := 16#0#;
      --  Force Double Bit Fault Detect
      FDFD         : FERCNFG_FDFD_Field := NRF_SVD.FTFE.Fdfd_0;
      --  unspecified
      Reserved_6_7 : HAL.UInt2 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 8, Bit_Order => System.Low_Order_First;

   for FTFE_FERCNFG_Register use record
      Reserved_0_0 at 0 range 0 .. 0;
   ...
   type FTFE_Peripheral is record
      ...
      --  Flash Error Status Register
      FERSTAT : aliased FTFE_FERSTAT_Register;
      --  Flash Error Configuration Register
      FERCNFG : aliased FTFE_FERCNFG_Register;
   end record
     with Volatile;
   ...
   for FTFE_Peripheral use record
      ...
      FERSTAT at 16#2E# range 0 .. 7;
      FERCNFG at 16#2F# range 0 .. 7;
   end record;
