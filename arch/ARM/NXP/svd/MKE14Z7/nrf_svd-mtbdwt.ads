...
package NRF_SVD.MTBDWT is
   ...
   type MTBDWT_FCT0_Register is record
      --  Function
      FUNCTION_k     : FCT0_FUNCTION_Field := NRF_SVD.MTBDWT.Function_0;
      --  unspecified
      Reserved_4_7   : HAL.UInt4 := 16#0#;
      --  Data Value Match
      DATAVMATCH     : FCT0_DATAVMATCH_Field := NRF_SVD.MTBDWT.Datavmatch_0;
      --  unspecified
      Reserved_9_9   : HAL.Bit := 16#0#;
      --  Data Value Size
      DATAVSIZE      : FCT0_DATAVSIZE_Field := NRF_SVD.MTBDWT.Datavsize_0;
      --  Data Value Address 0
      DATAVADDR0     : MTBDWT_FCT0_DATAVADDR0_Field := 16#0#;
      --  unspecified
      Reserved_16_23 : HAL.UInt8 := 16#0#;
      --  Read-only. Comparator match
      MATCHED        : FCT0_MATCHED_Field := NRF_SVD.MTBDWT.Matched_0;
      --  unspecified
   ...
   type MTBDWT_FCT1_Register is record
      --  Function
      FUNCTION_k     : FCT1_FUNCTION_Field := NRF_SVD.MTBDWT.Function_0;
      --  unspecified
      Reserved_4_23  : HAL.UInt20 := 16#0#;
      --  Read-only. Comparator match
      MATCHED        : FCT1_MATCHED_Field := NRF_SVD.MTBDWT.Matched_0;
      --  unspecified
      Reserved_25_31 : HAL.UInt7 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type MTBDWT_TBCTRL_Register is record
      --  Action based on Comparator 0 match
      ACOMP0        : TBCTRL_ACOMP0_Field := NRF_SVD.MTBDWT.Acomp0_0;
      --  Action based on Comparator 1 match
      ACOMP1        : TBCTRL_ACOMP1_Field := NRF_SVD.MTBDWT.Acomp1_0;
      --  unspecified
   ...
   MTBDWT_Periph : aliased MTBDWT_Peripheral
     with Import, Address => System'To_Address (16#F0001000#);
