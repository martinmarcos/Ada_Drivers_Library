...
package NRF_SVD.PCC is
   ...
   type PCC_PDB0_INUSE_Field is
     (
      ...
      Inuse_1)
     with Size => 1;
   for PCC_PDB0_INUSE_Field use
     (Inuse_0 => 0,
      Inuse_1 => 1);

   --  Clock Control
   type PCC_PDB0_CGC_Field is
     (
      --  Clock disabled
      Cgc_0,
      --  Clock enabled
      Cgc_1)
     with Size => 1;
   for PCC_PDB0_CGC_Field use
     (Cgc_0 => 0,
      Cgc_1 => 1);

   --  Enable
   type PCC_PDB0_PR_Field is
     (
      --  Peripheral is not present.
      Pr_0,
      --  Peripheral is present.
      Pr_1)
     with Size => 1;
   for PCC_PDB0_PR_Field use
     (Pr_0 => 0,
      Pr_1 => 1);

   --  PCC Register
   type PCC_PDB0_Register is record
      --  unspecified
      Reserved_0_28 : HAL.UInt29 := 16#0#;
      --  Read-only. Clock Gate Control
      INUSE         : PCC_PDB0_INUSE_Field := NRF_SVD.PCC.Inuse_0;
      --  Clock Control
      CGC           : PCC_PDB0_CGC_Field := NRF_SVD.PCC.Cgc_0;
      --  Read-only. Enable
      PR            : PCC_PDB0_PR_Field := NRF_SVD.PCC.Pr_1;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for PCC_PDB0_Register use record
      Reserved_0_28 at 0 range 0 .. 28;
      INUSE         at 0 range 29 .. 29;
      CGC           at 0 range 30 .. 30;
      PR            at 0 range 31 .. 31;
   ...
   --  Clock Gate Control
   type PCC_FLEXTMR0_INUSE_Field is
     (
      --  Peripheral is not being used.
      Inuse_0,
      --  Peripheral is being used. Software cannot modify the existing
      ...
      Inuse_1)
     with Size => 1;
   for PCC_FLEXTMR0_INUSE_Field use
     (Inuse_0 => 0,
      Inuse_1 => 1);

   --  Clock Control
   type PCC_FLEXTMR0_CGC_Field is
     (
      --  Clock disabled
      Cgc_0,
      --  Clock enabled
      Cgc_1)
     with Size => 1;
   for PCC_FLEXTMR0_CGC_Field use
     (Cgc_0 => 0,
      Cgc_1 => 1);

   --  Enable
   type PCC_FLEXTMR0_PR_Field is
     (
      --  Peripheral is not present.
      Pr_0,
      --  Peripheral is present.
   ...
   type PCC_FLEXTMR_Register is record
      ...
      Reserved_0_28 : HAL.UInt29 := 16#0#;
      --  Read-only. Clock Gate Control
      INUSE         : PCC_FLEXTMR0_INUSE_Field := NRF_SVD.PCC.Inuse_0;
      --  Clock Control
      CGC           : PCC_FLEXTMR0_CGC_Field := NRF_SVD.PCC.Cgc_0;
      --  Read-only. Enable
      PR            : PCC_FLEXTMR0_PR_Field := NRF_SVD.PCC.Pr_1;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type PCC_TSI_INUSE_Field is
     (
      ...
      Inuse_1)
     with Size => 1;
   for PCC_TSI_INUSE_Field use
     (Inuse_0 => 0,
      Inuse_1 => 1);

   --  Clock Control
   type PCC_TSI_CGC_Field is
     (
      --  Clock disabled
      Cgc_0,
      --  Clock enabled
      Cgc_1)
     with Size => 1;
   for PCC_TSI_CGC_Field use
     (Cgc_0 => 0,
      Cgc_1 => 1);

   --  Enable
   type PCC_TSI_PR_Field is
     (
      --  Peripheral is not present.
      Pr_0,
      --  Peripheral is present.
      Pr_1)
     with Size => 1;
   for PCC_TSI_PR_Field use
     (Pr_0 => 0,
      Pr_1 => 1);

   --  PCC Register
   type PCC_TSI_Register is record
      --  unspecified
      Reserved_0_28 : HAL.UInt29 := 16#0#;
      --  Read-only. Clock Gate Control
      INUSE         : PCC_TSI_INUSE_Field := NRF_SVD.PCC.Inuse_0;
      --  Clock Control
      CGC           : PCC_TSI_CGC_Field := NRF_SVD.PCC.Cgc_0;
      --  Read-only. Enable
      PR            : PCC_TSI_PR_Field := NRF_SVD.PCC.Pr_1;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for PCC_TSI_Register use record
      Reserved_0_28 at 0 range 0 .. 28;
      INUSE         at 0 range 29 .. 29;
      CGC           at 0 range 30 .. 30;
      PR            at 0 range 31 .. 31;
   ...
   type PCC_Peripheral is record
      ...
      --  PCC Register
      PCC_PDB0     : aliased PCC_PDB0_Register;
      --  PCC Register
      ...
      --  PCC Register
      PCC_TSI      : aliased PCC_TSI_Register;
      --  PCC Register
