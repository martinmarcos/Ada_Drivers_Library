...
package NRF_SVD.FTM is
   ...
   type FTM0_SC_Register is record
      ...
      --  Filter Prescaler
      FLTPS          : SC_FLTPS_Field := NRF_SVD.FTM.Fltps_0;
      --  unspecified
   ...
   subtype FTM0_DEADTIME_DTVALEX_Field is HAL.UInt4;
   ...
   type FTM0_DEADTIME_Register is record
      ...
      DTVALEX        : FTM0_DEADTIME_DTVALEX_Field := 16#0#;
      --  unspecified
   ...
   --  FlexTimer Module
   FTM3_Periph : aliased FTM_Peripheral
