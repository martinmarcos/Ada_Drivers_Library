...
package NRF_SVD.LPUART is
   ...
   subtype BAUD_OSR_Field is HAL.UInt5;
   ...
   type BAUD_Register is record
      ...
      --  Receiver Idle DMA Enable
      RIDMAE         : BAUD_RIDMAE_Field := NRF_SVD.LPUART.Ridmae_0;
      --  Receiver Full DMA Enable
   ...
   subtype MODIR_RTSWATER_Field is HAL.UInt8;
   ...
   subtype WATER_TXWATER_Field is HAL.UInt8;
   subtype WATER_TXCOUNT_Field is HAL.UInt8;
   subtype WATER_RXWATER_Field is HAL.UInt8;
   subtype WATER_RXCOUNT_Field is HAL.UInt8;
