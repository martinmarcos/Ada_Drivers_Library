...
package NRF_SVD.SHS is
   ...
   type SHSCFG_Register is record
      ...
      --  Analog Converter Power Down Force
      ANOFF          : SHSCFG_ANOFF_Field := NRF_SVD.SHS.VALUE2;
      --  unspecified
   ...
   type TIMCFG0_FCRT_Field is
     (
      --  Result after tADCI o 2
      VALUE1,
      --  Result after tADCI o 32
      VALUE2)
     with Size => 4;
   ...
   type TIMCFG0_SST_Field is
     (
      ...
      VALUE1,
      --  Sample time is tADC o 1
      VALUE2,
      --  Sample time is tADC o 63
      VALUE3)
     with Size => 6;
   ...
   type CALCTR_Register is record
      ...
      CALMAX         : CALCTR_CALMAX_Field := 16#0#;
      --  unspecified
