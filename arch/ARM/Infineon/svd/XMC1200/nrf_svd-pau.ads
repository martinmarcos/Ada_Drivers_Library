...
package NRF_SVD.PAU is
   ...
   type AVAIL2_AVAIL13_Field is
     (
      ...
      VALUE2)
     with Size => 1;
   for AVAIL2_AVAIL13_Field use
     (VALUE1 => 0,
      VALUE2 => 1);

   --  LEDTS1 Sync Slave Availability Flag
   type AVAIL2_AVAIL14_Field is
     (
   ...
   type AVAIL2_Register is record
      ...
      --  Read-only. LEDTS0 Sync Master Availability Flag
      AVAIL13        : AVAIL2_AVAIL13_Field;
      --  Read-only. LEDTS1 Sync Slave Availability Flag
      AVAIL14        : AVAIL2_AVAIL14_Field;
   ...
   for AVAIL2_Register use record
      ...
      AVAIL13        at 0 range 13 .. 13;
      AVAIL14        at 0 range 14 .. 14;
