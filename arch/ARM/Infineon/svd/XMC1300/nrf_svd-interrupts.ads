...
package NRF_SVD.Interrupts is
   ...
   VADC0_C0_0            : constant := 15;

   --  Analog to Digital Converter Common Block 0
   VADC0_C0_1            : constant := 16;

   --  Analog to Digital Converter Group 0
   VADC0_G0_0            : constant := 17;

   --  Analog to Digital Converter Group 0
   VADC0_G0_1            : constant := 18;

   --  Analog to Digital Converter Group 1
   VADC0_G1_0            : constant := 19;

   --  Analog to Digital Converter Group 1
   VADC0_G1_1            : constant := 20;
   ...
   POSIF0_0              : constant := 27;

   --  Position Interface (Module 0)
   POSIF0_1              : constant := 28;
