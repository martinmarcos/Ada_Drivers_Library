...
package NRF_SVD.CCU4 is
   ...
   type INS2_Register is record
      --  Event 0 Edge Selection
      EV0EM          : INS2_EV0EM_Field := NRF_SVD.CCU4.VALUE1;
      --  Event 0 Level Selection
      EV0LM          : INS2_EV0LM_Field := NRF_SVD.CCU4.VALUE1;
      --  unspecified
      Reserved_3_3   : HAL.Bit := 16#0#;
      --  Event 1 Edge Selection
      EV1EM          : INS2_EV1EM_Field := NRF_SVD.CCU4.VALUE1;
      --  Event 1 Level Selection
      EV1LM          : INS2_EV1LM_Field := NRF_SVD.CCU4.VALUE1;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  Event 2 Edge Selection
      EV2EM          : INS2_EV2EM_Field := NRF_SVD.CCU4.VALUE1;
      --  Event 2 Level Selection
      EV2LM          : INS2_EV2LM_Field := NRF_SVD.CCU4.VALUE1;
      --  unspecified
      Reserved_11_15 : HAL.UInt5 := 16#0#;
      --  Event 0 Low Pass Filter Configuration
      LPF0M          : INS2_LPF0M_Field := NRF_SVD.CCU4.VALUE1;
      --  unspecified
      Reserved_18_19 : HAL.UInt2 := 16#0#;
      --  Event 1 Low Pass Filter Configuration
      LPF1M          : INS2_LPF1M_Field := NRF_SVD.CCU4.VALUE1;
      --  unspecified
      Reserved_22_23 : HAL.UInt2 := 16#0#;
      --  Event 2 Low Pass Filter Configuration
      LPF2M          : INS2_LPF2M_Field := NRF_SVD.CCU4.VALUE1;
      --  unspecified
   ...
   --  Immediate Write into Compare Configuration
   type STC_IRCC_Field is
     (
   ...
   --  Automatic Shadow transfer request when writing into Compare Shadow
   --  Register
   type STC_ASCC_Field is
     (
   ...
   type STC_Register is record
      --  Cascaded shadow transfer enable
      CSE            : STC_CSE_Field := NRF_SVD.CCU4.VALUE1;
      --  Shadow transfer mode
      STM            : STC_STM_Field := NRF_SVD.CCU4.VALUE1;
      --  unspecified
      Reserved_3_3   : HAL.Bit := 16#0#;
      --  Immediate Write into Period Configuration
      IRPC           : STC_IRPC_Field := NRF_SVD.CCU4.VALUE1;
      --  Immediate Write into Compare Configuration
      IRCC           : STC_IRCC_Field := NRF_SVD.CCU4.VALUE1;
      --  unspecified
      Reserved_6_6   : HAL.Bit := 16#0#;
      --  Immediate Write into Passive Level Configuration
      IRLC           : STC_IRLC_Field := NRF_SVD.CCU4.VALUE1;
      --  Immediate Write into Dither Value Configuration
      IRDC           : STC_IRDC_Field := NRF_SVD.CCU4.VALUE1;
      --  Immediate Write into Floating Prescaler Value Configuration
      IRFC           : STC_IRFC_Field := NRF_SVD.CCU4.VALUE1;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Automatic Shadow Transfer request when writing into Period Shadow
      --  Register
      ASPC           : STC_ASPC_Field := NRF_SVD.CCU4.VALUE1;
      --  Automatic Shadow transfer request when writing into Compare Shadow
      --  Register
      ASCC           : STC_ASCC_Field := NRF_SVD.CCU4.VALUE1;
      --  unspecified
      Reserved_18_18 : HAL.Bit := 16#0#;
      --  Automatic Shadow transfer request when writing into Passive Level
      --  register
      ASLC           : STC_ASLC_Field := NRF_SVD.CCU4.VALUE1;
      --  Automatic Shadow transfer request when writing into Dither Shadow
      --  register
      ASDC           : STC_ASDC_Field := NRF_SVD.CCU4.VALUE1;
      --  Automatic Shadow transfer request when writing into Floating
      --  Prescaler Shadow register
      ASFC           : STC_ASFC_Field := NRF_SVD.CCU4.VALUE1;
      --  unspecified
   ...
   type INS1_Register is record
      --  Event 0 signal selection
      EV0IS          : INS1_EV0IS_Field := NRF_SVD.CCU4.VALUE1;
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  Event 1 signal selection
      EV1IS          : INS1_EV1IS_Field := NRF_SVD.CCU4.VALUE1;
      --  unspecified
      Reserved_14_15 : HAL.UInt2 := 16#0#;
      --  Event 2 signal selection
      EV2IS          : INS1_EV2IS_Field := NRF_SVD.CCU4.VALUE1;
      --  unspecified
      Reserved_22_31 : HAL.UInt10 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   CCU41_Periph : aliased CCU4_Peripheral
     with Import, Address => System'To_Address (16#48044000#);

   --  Capture Compare Unit 4 - Unit 0
   type CCU4_CC4_Peripheral is record
      --  Input Selector Configuration 2
   ...
   for CCU4_CC4_Peripheral use record
   ...
   --  Capture Compare Unit 4 - Unit 0
   CCU40_CC40_Periph : aliased CCU4_CC4_Peripheral
     with Import, Address => System'To_Address (16#48040100#);

   --  Capture Compare Unit 4 - Unit 0
   CCU40_CC41_Periph : aliased CCU4_CC4_Peripheral
     with Import, Address => System'To_Address (16#48040200#);

   --  Capture Compare Unit 4 - Unit 0
   CCU40_CC42_Periph : aliased CCU4_CC4_Peripheral
     with Import, Address => System'To_Address (16#48040300#);

   --  Capture Compare Unit 4 - Unit 0
   CCU40_CC43_Periph : aliased CCU4_CC4_Peripheral
     with Import, Address => System'To_Address (16#48040400#);

   --  Capture Compare Unit 4 - Unit 1
   CCU41_CC40_Periph : aliased CCU4_CC4_Peripheral
     with Import, Address => System'To_Address (16#48044100#);

   --  Capture Compare Unit 4 - Unit 1
   CCU41_CC41_Periph : aliased CCU4_CC4_Peripheral
     with Import, Address => System'To_Address (16#48044200#);

   --  Capture Compare Unit 4 - Unit 1
   CCU41_CC42_Periph : aliased CCU4_CC4_Peripheral
     with Import, Address => System'To_Address (16#48044300#);

   --  Capture Compare Unit 4 - Unit 1
   CCU41_CC43_Periph : aliased CCU4_CC4_Peripheral
     with Import, Address => System'To_Address (16#48044400#);
