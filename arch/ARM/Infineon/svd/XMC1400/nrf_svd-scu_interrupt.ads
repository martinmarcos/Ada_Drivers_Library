...
package NRF_SVD.SCU_INTERRUPT is
   ...
   type SRRAW_Register is record
      ...
      --  Read-only. Out of Range Comparator X Event Status Before Masking
      ORC7I          : Boolean;
      --  Read-only. Loss of DCO1 Clock Event Status Before Masking
      LOCI           : Boolean;
      ...
      --  Read-only. DTS Measurement Done Event Status Before Masking
      TSE_DONE       : Boolean;
      --  Read-only. DTS Compare High Temperature Event Status Before Masking
      TSE_HIGH       : Boolean;
      --  Read-only. DTS Compare Low Temperature Event Status Before Masking
      TSE_LOW        : Boolean;
   end record
   ...
   type SRMSK_Register is record
      ...
      --  Out of Range Comparator X Interrupt Mask
      ORC7I          : Boolean := False;
      --  Loss of DCO1 Clock Interrupt Mask
      LOCI           : Boolean := False;
      ...
      RTC_TIM        : SRMSK_RTC_TIM_Field :=
                        (As_Array => False, Val => 16#0#);
      --  DTS Measurement Done Interrupt Mask
      TSE_DONE       : Boolean := False;
      --  DTS Compare High Temperature Interrupt Mask
      TSE_HIGH       : Boolean := False;
      --  DTS Compare Low Temperature Interrupt Mask
   ...
   type SRCLR_Register is record
      ...
      --  Write-only. Out of Range Comparator X Interrupt Clear
      ORC7I          : Boolean := False;
      --  Write-only. Loss of DCO1 Clock Interrupt Clear
      LOCI           : Boolean := False;
      ...
      RTC_TIM        : SRCLR_RTC_TIM_Field :=
                        (As_Array => False, Val => 16#0#);
      --  Write-only. DTS Measurement Done Interrupt Clear
      TSE_DONE       : Boolean := False;
      --  Write-only. DTS Compare High Temperature Interrupt Clear
      TSE_HIGH       : Boolean := False;
      --  Write-only. DTS Compare Low Temperature Interrupt Clear
      TSE_LOW        : Boolean := False;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type SRSET_Register is record
      ...
      --  Write-only. Out of Range Comparator X Interrupt Set
      ORC7I          : Boolean := False;
      --  Write-only. Loss of DCO1 Clock Interrupt Set
      LOCI           : Boolean := False;
      ...
      RTC_TIM        : SRSET_RTC_TIM_Field :=
                        (As_Array => False, Val => 16#0#);
      --  Write-only. DTS Measurement Done Interrupt Set
      TSE_DONE       : Boolean := False;
      --  Write-only. DTS Compare High Temperature Interrupt Set
      TSE_HIGH       : Boolean := False;
      --  Write-only. DTS Compare Low Temperature Interrupt Set
      TSE_LOW        : Boolean := False;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type SRRAW1_Register is record
      --  Read-only. Analog Comparator 3 Event Status Before Masking
      ACMP3I        : Boolean;
      --  Read-only. Loss of External OSC_HP Clock Event Status Before Masking
      LOECI         : Boolean;
      --  Read-only. USIC1 SRAM Parity Error Event Status Before Masking
      PEU1I         : Boolean;
      --  Read-only. MultiCAN SRAM Parity Error Event Status Before Masking
      PEMCI         : Boolean;
      --  Read-only. DCO1 Out of SYNC Event Status Before Masking
      DCO1OFSI      : Boolean;
      --  unspecified
   ...
   for SRRAW1_Register use record
      ACMP3I        at 0 range 0 .. 0;
      LOECI         at 0 range 1 .. 1;
      PEU1I         at 0 range 2 .. 2;
      PEMCI         at 0 range 3 .. 3;
      DCO1OFSI      at 0 range 4 .. 4;
      Reserved_5_31 at 0 range 5 .. 31;
   end record;

   --  SCU Service Request Mask 1
   type SRMSK1_Register is record
      --  Analog Comparator 3 Interrupt Mask
      ACMP3I        : Boolean := False;
      --  Loss of External OSC_HP Clock Interrupt Mask
      LOECI         : Boolean := False;
      --  USIC1 SRAM Parity Error Interrupt Mask
      PEU1I         : Boolean := False;
      --  MultiCAN SRAM Parity Error Interrupt Mask
      PEMCI         : Boolean := False;
      --  DCO1 Out of SYNC Interrupt Mask
      DCO1OFSI      : Boolean := False;
      --  unspecified
   ...
   for SRMSK1_Register use record
      ACMP3I        at 0 range 0 .. 0;
      LOECI         at 0 range 1 .. 1;
      PEU1I         at 0 range 2 .. 2;
      PEMCI         at 0 range 3 .. 3;
   ...
   type SRCLR1_Register is record
      --  Write-only. Analog Comparator 3 Interrupt Clear
      ACMP3I        : Boolean := False;
      --  Write-only. Loss of External OSC_HP Clock Interrupt Clear
      LOECI         : Boolean := False;
      --  Write-only. USIC1 SRAM Parity Error Interrupt Clear
      PEU1I         : Boolean := False;
      --  Write-only. MultiCAN SRAM Parity Error Interrupt Clear
      PEMCI         : Boolean := False;
      --  Write-only. DCO1 Out of SYNC Interrupt Clear
      DCO1OFSI      : Boolean := False;
      --  unspecified
      Reserved_5_31 : HAL.UInt27 := 16#0#;
   end record
   ...
   for SRCLR1_Register use record
      ACMP3I        at 0 range 0 .. 0;
      LOECI         at 0 range 1 .. 1;
      PEU1I         at 0 range 2 .. 2;
      PEMCI         at 0 range 3 .. 3;
   ...
   type SRSET1_Register is record
      --  Write-only. Analog Comparator 3 Interrupt Set
      ACMP3I        : Boolean := False;
      --  Write-only. Loss of External OSC_HP Clock Interrupt Set
      LOECI         : Boolean := False;
      --  Write-only. USIC1 SRAM Parity Error Interrupt Set
      PEU1I         : Boolean := False;
      --  Write-only. MultiCAN SRAM Parity Error Interrupt Set
      PEMCI         : Boolean := False;
      --  Write-only. DCO1 Out of SYNC Interrupt Set
      DCO1OFSI      : Boolean := False;
      --  unspecified
      Reserved_5_31 : HAL.UInt27 := 16#0#;
   end record
   ...
   for SRSET1_Register use record
      ACMP3I        at 0 range 0 .. 0;
      LOECI         at 0 range 1 .. 1;
      PEU1I         at 0 range 2 .. 2;
      PEMCI         at 0 range 3 .. 3;
   ...
   type SCU_INTERRUPT_Peripheral is record
      ...
      --  SCU Raw Service Request Status 1
      SRRAW1 : aliased SRRAW1_Register;
      --  SCU Service Request Mask 1
      SRMSK1 : aliased SRMSK1_Register;
      --  SCU Service Request Clear 1
      SRCLR1 : aliased SRCLR1_Register;
      --  SCU Service Request Set 1
      SRSET1 : aliased SRSET1_Register;
   end record
     with Volatile;
   ...
   for SCU_INTERRUPT_Peripheral use record
      ...
      SRRAW1 at 16#20# range 0 .. 31;
      SRMSK1 at 16#24# range 0 .. 31;
      SRCLR1 at 16#28# range 0 .. 31;
      SRSET1 at 16#2C# range 0 .. 31;
   end record;
