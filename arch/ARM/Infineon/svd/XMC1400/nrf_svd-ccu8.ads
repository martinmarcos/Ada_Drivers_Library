...
package NRF_SVD.CCU8 is
   ...
   type INS2_EV0LM_Field is
     (
      ...
      VALUE2)
     with Size => 1;
   for INS2_EV0LM_Field use
     (VALUE1 => 0,
      VALUE2 => 1);

   --  Event 1 Edge Selection
   type INS2_EV1EM_Field is
     (
      --  No action
      VALUE1,
      --  Signal active on rising edge
   ...
   type INS2_EV1LM_Field is
     (
      ...
      VALUE2)
     with Size => 1;
   for INS2_EV1LM_Field use
     (VALUE1 => 0,
      VALUE2 => 1);

   --  Event 2 Edge Selection
   type INS2_EV2EM_Field is
     (
      --  No action
      VALUE1,
      --  Signal active on rising edge
   ...
   type INS2_EV2LM_Field is
     (
      ...
      VALUE2)
     with Size => 1;
   for INS2_EV2LM_Field use
     (VALUE1 => 0,
      VALUE2 => 1);

   --  Event 0 Low Pass Filter Configuration
   type INS2_LPF0M_Field is
     (
      --  LPF is disabled
      VALUE1,
      --  3 clock cycles offCCU8
      VALUE2,
      --  5 clock cycles offCCU8
      VALUE3,
      --  7 clock cycles offCCU8
      VALUE4)
     with Size => 2;
   for INS2_LPF0M_Field use
     (VALUE1 => 0,
      VALUE2 => 1,
      VALUE3 => 2,
      VALUE4 => 3);
   ...
   type INS2_Register is record
      --  Event 0 Edge Selection
      EV0EM          : INS2_EV0EM_Field := NRF_SVD.CCU8.VALUE1;
      --  Event 0 Level Selection
      EV0LM          : INS2_EV0LM_Field := NRF_SVD.CCU8.VALUE1;
      --  unspecified
      Reserved_3_3   : HAL.Bit := 16#0#;
      --  Event 1 Edge Selection
      EV1EM          : INS2_EV1EM_Field := NRF_SVD.CCU8.VALUE1;
      --  Event 1 Level Selection
      EV1LM          : INS2_EV1LM_Field := NRF_SVD.CCU8.VALUE1;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  Event 2 Edge Selection
      EV2EM          : INS2_EV2EM_Field := NRF_SVD.CCU8.VALUE1;
      --  Event 2 Level Selection
      EV2LM          : INS2_EV2LM_Field := NRF_SVD.CCU8.VALUE1;
      --  unspecified
      Reserved_11_15 : HAL.UInt5 := 16#0#;
      --  Event 0 Low Pass Filter Configuration
      LPF0M          : INS2_LPF0M_Field := NRF_SVD.CCU8.VALUE1;
      --  unspecified
      Reserved_18_19 : HAL.UInt2 := 16#0#;
      --  Event 1 Low Pass Filter Configuration
      LPF1M          : INS2_LPF1M_Field := NRF_SVD.CCU8.VALUE1;
      --  unspecified
      Reserved_22_23 : HAL.UInt2 := 16#0#;
      --  Event 2 Low Pass Filter Configuration
      LPF2M          : INS2_LPF2M_Field := NRF_SVD.CCU8.VALUE1;
      --  unspecified
   ...
   for INS2_Register use record
      EV0EM          at 0 range 0 .. 1;
      EV0LM          at 0 range 2 .. 2;
      Reserved_3_3   at 0 range 3 .. 3;
      EV1EM          at 0 range 4 .. 5;
      EV1LM          at 0 range 6 .. 6;
      Reserved_7_7   at 0 range 7 .. 7;
      EV2EM          at 0 range 8 .. 9;
      EV2LM          at 0 range 10 .. 10;
      Reserved_11_15 at 0 range 11 .. 15;
      LPF0M          at 0 range 16 .. 17;
      Reserved_18_19 at 0 range 18 .. 19;
      LPF1M          at 0 range 20 .. 21;
      Reserved_22_23 at 0 range 22 .. 23;
      LPF2M          at 0 range 24 .. 25;
   ...
   type TC_EMT_Field is
     (
      --  External Modulation functionality is clearing the CC8ySTn bits.
      VALUE1,
   ...
   type CHC_OCS1_Field is
     (
      ...
      VALUE2,
      --  CC8yST2 signal path is connected to the CCU8x.OUTy0
      VALUE3,
      --  Inverted CC8yST2 signal path is connected to the CCU8x.OUTy0
      VALUE4)
     with Size => 2;
   ...
   type CHC_OCS2_Field is
     (
      ...
      VALUE2,
      --  Inverted CC8yST2 signal path is connected to the CCU8x.OUTy1
      VALUE3,
      --  CC8yST2 signal path is connected to the CCU8x.OUTy1
      VALUE4)
     with Size => 2;
   ...
   type CHC_OCS3_Field is
     (
      ...
      VALUE2,
      --  CC8yST1 signal path is connected to the CCU8x.OUTy2
      VALUE3,
      --  Inverted CCST1 signal path is connected to the CCU8x.OUTy2
      VALUE4)
     with Size => 2;
   ...
   type CHC_OCS4_Field is
     (
      ...
      VALUE2,
      --  Inverted CC8yST1 signal path is connected to the CCU8x.OUTy3
      VALUE3,
      --  CC8yST1 signal path is connected to the CCU8x.OUTy3
      VALUE4)
     with Size => 2;
   ...
   for CHC_Register use record
      ...
      OCS3           at 0 range 12 .. 13;
      Reserved_14_15 at 0 range 14 .. 15;
      OCS4           at 0 range 16 .. 17;
   ...
   --  Immediate Write into Period Configuration
   type STC_IRPC_Field is
     (
      --  Update of the period value is done coherently with PWM cycle
      VALUE1,
      --  Update of the period value happens immediately after a shadow
      --  transfer is request
      VALUE2)
     with Size => 1;
   for STC_IRPC_Field use
     (VALUE1 => 0,
      VALUE2 => 1);

   --  Immediate Write into Compare 1 Configuration
   type STC_IRCC1_Field is
     (
      --  Update of the compare value is done coherently with PWM cycle
      VALUE1,
      --  Update of the compare value happens immediately after a shadow
      --  transfer is request
      VALUE2)
     with Size => 1;
   for STC_IRCC1_Field use
     (VALUE1 => 0,
      VALUE2 => 1);

   --  STC_IRCC array
   type STC_IRCC_Field_Array is array (1 .. 2) of STC_IRCC1_Field
     with Component_Size => 1, Size => 2;

   --  Type definition for STC_IRCC
   type STC_IRCC_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         ...
         when True =>
            --  IRCC as an array
            Arr : STC_IRCC_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 2;

   for STC_IRCC_Field use record
      Val at 0 range 0 .. 1;
      Arr at 0 range 0 .. 1;
   end record;

   --  Immediate Write into Passive Level Configuration
   type STC_IRLC_Field is
     (
      --  Update of the pwm passive level is done coherently with PWM cycle
      VALUE1,
      --  Update of the pwm passive level value happens immediately after a
      --  shadow transfer is request
      VALUE2)
     with Size => 1;
   for STC_IRLC_Field use
     (VALUE1 => 0,
      VALUE2 => 1);

   --  Immediate Write into Dither Value Configuration
   type STC_IRDC_Field is
     (
      --  Update of the dither compare value is done coherently with PWM cycle
      VALUE1,
      --  Update of the dither compare value happens immediately after a shadow
      --  transfer is request
      VALUE2)
     with Size => 1;
   for STC_IRDC_Field use
     (VALUE1 => 0,
      VALUE2 => 1);

   --  Immediate Write into Floating Prescaler Value Configuration
   type STC_IRFC_Field is
     (
      --  Update of the floating prescaler value is done coherently with PWM
      --  cycle
      VALUE1,
      --  Update of the floating prescaler value happens immediately after a
      --  shadow transfer is request
      VALUE2)
     with Size => 1;
   for STC_IRFC_Field use
     (VALUE1 => 0,
      VALUE2 => 1);

   --  Automatic Shadow Transfer request when writing into Period Shadow
   --  Register
   type STC_ASPC_Field is
     (
      --  Writing into Period Shadow register does not automatically requests a
      --  shadow transfer
      VALUE1,
      --  Writing into Period Shadow register will automatically requests a
      --  shadow transfer
      VALUE2)
     with Size => 1;
   for STC_ASPC_Field use
     (VALUE1 => 0,
      VALUE2 => 1);

   --  Automatic Shadow transfer request when writing into Compare 1 Shadow
   --  Register
   type STC_ASCC1_Field is
     (
      --  Writing into Compare Shadow register does not automatically requests
      --  a shadow transfer
      VALUE1,
      --  Writing into Compare Shadow register automatically requests a shadow
      --  transfer
      VALUE2)
     with Size => 1;
   for STC_ASCC1_Field use
     (VALUE1 => 0,
      VALUE2 => 1);

   --  STC_ASCC array
   type STC_ASCC_Field_Array is array (1 .. 2) of STC_ASCC1_Field
     with Component_Size => 1, Size => 2;

   --  Type definition for STC_ASCC
   type STC_ASCC_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         ...
         when True =>
            --  ASCC as an array
            Arr : STC_ASCC_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 2;

   for STC_ASCC_Field use record
      Val at 0 range 0 .. 1;
      Arr at 0 range 0 .. 1;
   end record;

   --  Automatic Shadow transfer request when writing into Passive Level
   --  register
   type STC_ASLC_Field is
     (
      --  Writing into Passivel Level register does not automatically requests
      --  a shadow transfer
      VALUE1,
      --  Writing into Passive Level register automatically requests a shadow
      --  transfer
      VALUE2)
     with Size => 1;
   for STC_ASLC_Field use
     (VALUE1 => 0,
      VALUE2 => 1);

   --  Automatic Shadow transfer request when writing into Dither Shadow
   --  register
   type STC_ASDC_Field is
     (
      --  Writing into Dither Shadow register does not automatically requests a
      --  shadow transfer
      VALUE1,
      --  Writing into Dither Shadow register automatically requests a shadow
      --  transfer
      VALUE2)
     with Size => 1;
   for STC_ASDC_Field use
     (VALUE1 => 0,
      VALUE2 => 1);

   --  Automatic Shadow transfer request when writing into Floating Prescaler
   --  Shadow register
   type STC_ASFC_Field is
     (
      --  Writing into Floating Prescaler Shadow register does not
      --  automatically requests a shadow transfer
      VALUE1,
      --  Writing into Floating Prescaler Shadow register automatically
      --  requests a shadow transfer
      VALUE2)
     with Size => 1;
   for STC_ASFC_Field use
     (VALUE1 => 0,
      VALUE2 => 1);
   ...
   type STC_Register is record
      ...
      Reserved_3_3   : HAL.Bit := 16#0#;
      --  Immediate Write into Period Configuration
      IRPC           : STC_IRPC_Field := NRF_SVD.CCU8.VALUE1;
      --  Immediate Write into Compare 1 Configuration
      IRCC           : STC_IRCC_Field := (As_Array => False, Val => 16#0#);
      --  Immediate Write into Passive Level Configuration
      IRLC           : STC_IRLC_Field := NRF_SVD.CCU8.VALUE1;
      --  Immediate Write into Dither Value Configuration
      IRDC           : STC_IRDC_Field := NRF_SVD.CCU8.VALUE1;
      --  Immediate Write into Floating Prescaler Value Configuration
      IRFC           : STC_IRFC_Field := NRF_SVD.CCU8.VALUE1;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Automatic Shadow Transfer request when writing into Period Shadow
      --  Register
      ASPC           : STC_ASPC_Field := NRF_SVD.CCU8.VALUE1;
      --  Automatic Shadow transfer request when writing into Compare 1 Shadow
      --  Register
      ASCC           : STC_ASCC_Field := (As_Array => False, Val => 16#0#);
      --  Automatic Shadow transfer request when writing into Passive Level
      --  register
      ASLC           : STC_ASLC_Field := NRF_SVD.CCU8.VALUE1;
      --  Automatic Shadow transfer request when writing into Dither Shadow
      --  register
      ASDC           : STC_ASDC_Field := NRF_SVD.CCU8.VALUE1;
      --  Automatic Shadow transfer request when writing into Floating
      --  Prescaler Shadow register
      ASFC           : STC_ASFC_Field := NRF_SVD.CCU8.VALUE1;
      --  unspecified
   ...
   for STC_Register use record
      ...
      ASPC           at 0 range 16 .. 16;
      ASCC           at 0 range 17 .. 18;
      ASLC           at 0 range 19 .. 19;
      ASDC           at 0 range 20 .. 20;
      ASFC           at 0 range 21 .. 21;
   ...
   type INS1_Register is record
      --  Event 0 signal selection
      EV0IS          : INS1_EV0IS_Field := NRF_SVD.CCU8.VALUE1;
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  Event 1 signal selection
      EV1IS          : INS1_EV1IS_Field := NRF_SVD.CCU8.VALUE1;
      --  unspecified
      Reserved_14_15 : HAL.UInt2 := 16#0#;
      --  Event 2 signal selection
      EV2IS          : INS1_EV2IS_Field := NRF_SVD.CCU8.VALUE1;
      --  unspecified
      Reserved_22_31 : HAL.UInt10 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for INS1_Register use record
      EV0IS          at 0 range 0 .. 5;
      Reserved_6_7   at 0 range 6 .. 7;
      EV1IS          at 0 range 8 .. 13;
      Reserved_14_15 at 0 range 14 .. 15;
      EV2IS          at 0 range 16 .. 21;
      Reserved_22_31 at 0 range 22 .. 31;
   end record;
   ...
   CCU81_Periph : aliased CCU8_Peripheral
     with Import, Address => System'To_Address (16#50004000#);

   --  Capture Compare Unit 8 - Unit 0
   type CCU8_CC8_Peripheral is record
      --  Input Selector Configuration 2
      INS2  : aliased INS2_Register;
      --  Connection Matrix Control
      ...
      --  Input Selector Configuration 1
      INS1  : aliased INS1_Register;
   end record
     with Volatile;

   for CCU8_CC8_Peripheral use record
      INS2  at 16#0# range 0 .. 31;
      ...
      INS1  at 16#D8# range 0 .. 31;
   end record;

   --  Capture Compare Unit 8 - Unit 0
   CCU80_CC80_Periph : aliased CCU8_CC8_Peripheral
     with Import, Address => System'To_Address (16#50000100#);

   --  Capture Compare Unit 8 - Unit 0
   CCU80_CC81_Periph : aliased CCU8_CC8_Peripheral
     with Import, Address => System'To_Address (16#50000200#);

   --  Capture Compare Unit 8 - Unit 0
   CCU80_CC82_Periph : aliased CCU8_CC8_Peripheral
     with Import, Address => System'To_Address (16#50000300#);

   --  Capture Compare Unit 8 - Unit 0
   CCU80_CC83_Periph : aliased CCU8_CC8_Peripheral
     with Import, Address => System'To_Address (16#50000400#);

   --  Capture Compare Unit 8 - Unit 1
   CCU81_CC80_Periph : aliased CCU8_CC8_Peripheral
     with Import, Address => System'To_Address (16#50004100#);

   --  Capture Compare Unit 8 - Unit 1
   CCU81_CC81_Periph : aliased CCU8_CC8_Peripheral
     with Import, Address => System'To_Address (16#50004200#);

   --  Capture Compare Unit 8 - Unit 1
   CCU81_CC82_Periph : aliased CCU8_CC8_Peripheral
     with Import, Address => System'To_Address (16#50004300#);

   --  Capture Compare Unit 8 - Unit 1
   CCU81_CC83_Periph : aliased CCU8_CC8_Peripheral
