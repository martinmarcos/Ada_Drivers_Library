...
package NRF_SVD.LEDTS is
   ...
   subtype GLOBCTL_CLK_PS_Field is HAL.UInt16;
   ...
   type GLOBCTL_Register is record
      ...
      CLK_PS       : GLOBCTL_CLK_PS_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type FNCTL_NR_LEDCOL_Field is
     (
      ...
      --  7 LED columns
      VALUE7,
      --  8 LED columns (if bit TS_EN = 1, a maximum number of 7 LED columns is
      --  allowed. Combination of TS_EN = 1 and NR_LEDCOL = 111#is disallowed)
      VALUE8)
     with Size => 3;
   ...
   --  LED and Touch Sense Unit 2
   LEDTS2_Periph : aliased LEDTS_Peripheral
