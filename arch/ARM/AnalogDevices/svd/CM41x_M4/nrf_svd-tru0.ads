...
package NRF_SVD.TRU0 is
   ...
   subtype SSR_SSR_Field is HAL.UInt6;
   ...
   --  Slave Select Register
   type SSR_Registers is array (0 .. 46) of SSR_Register
     with Volatile;

   subtype MTR_MTR0_Field is HAL.UInt6;
   subtype MTR_MTR1_Field is HAL.UInt6;
   subtype MTR_MTR2_Field is HAL.UInt6;
   subtype MTR_MTR3_Field is HAL.UInt6;
   ...
   for MTR_Register use record
      ...
      MTR1           at 0 range 8 .. 13;
      Reserved_14_15 at 0 range 14 .. 15;
      MTR2           at 0 range 16 .. 21;
      Reserved_22_23 at 0 range 22 .. 23;
      MTR3           at 0 range 24 .. 29;
   ...
   type TRU0_Peripheral is record
      --  Slave Select Register
   ...
   for TRU0_Peripheral use record
      SSR     at 16#0# range 0 .. 1503;
   ...
   --  Trigger Routing Unit
   TRU0_Periph : aliased TRU0_Peripheral
