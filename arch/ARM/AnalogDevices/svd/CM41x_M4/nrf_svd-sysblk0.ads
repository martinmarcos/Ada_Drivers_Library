...
package NRF_SVD.SYSBLK0 is
   ...
   type M0_VTOR_Register is record
      ...
      --  Vector table base offset field. It contains the MS bits of the offset
   ...
   type SISTAT0_Register is record
      --  Shared INTR_0 status bit (From CGU[0]_ERR)
      CGU0_ERR        : Boolean := False;
