...
package NRF_SVD.TIMER0 is
   ...
   type CFG_TMODE_Field is
     (
      ...
      Widcap0_Mode,
      --  Measurement Report at Deasserting Edge of Waveform
      Widcap1_Mode,
   ...
   type CFG_PULSEHI_Field is
     (
      --  Negative Response or Pulse.
      Neg_Edge,
      --  Positive Response or Pulse.
      Pos_Edge)
     with Size => 1;
   ...
   type CFG_CLKSEL_Field is
     (
      --  Use SCLK
      Clksel_Sclk,
      --  Use TMR_ALT_CLK0 as TMR Clock
      Clksel_Alt0,
      --  Use TMR_ALT_CLK1 as TMR Clock
      Clksel_Alt1)
     with Size => 2;
