...
package NRF_SVD.SEC1 is
   ...
   type GCTL_Register is record
      --  Enable
      EN            : GCTL_EN_Field := NRF_SVD.SEC1.Dis;
      --  Reset
      RESET         : GCTL_RESET_Field := NRF_SVD.SEC1.No_Reset;
      --  unspecified
      Reserved_2_30 : HAL.UInt29 := 16#0#;
      --  Lock
      LOCK          : GCTL_LOCK_Field := NRF_SVD.SEC1.Unlock;
   end record
   ...
   type GSTAT_Register is record
      ...
      --  Error
      ERR           : GSTAT_ERR_Field := NRF_SVD.SEC1.No_Err;
      --  unspecified
      Reserved_2_3  : HAL.UInt2 := 16#0#;
      --  Read-only. Error Cause
      ERRC          : GSTAT_ERRC_Field := NRF_SVD.SEC1.Sfierr;
      --  unspecified
      Reserved_6_29 : HAL.UInt24 := 16#0#;
      --  Address Error
      ADRERR        : GSTAT_ADRERR_Field := NRF_SVD.SEC1.No_Adrerr;
      --  Lock Write Error
      LWERR         : GSTAT_LWERR_Field := NRF_SVD.SEC1.No_Lwerr;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type FCTL_Register is record
      --  Enable
      EN             : FCTL_EN_Field := NRF_SVD.SEC1.Dis;
      --  Reset
      RESET          : FCTL_RESET_Field := NRF_SVD.SEC1.No_Reset;
      --  unspecified
      Reserved_2_3   : HAL.UInt2 := 16#0#;
      --  Fault Output Enable
      FOEN           : FCTL_FOEN_Field := NRF_SVD.SEC1.Fltout_Dis;
      --  Trigger Output Enable
      TOEN           : FCTL_TOEN_Field := NRF_SVD.SEC1.Trgout_Dis;
      --  System Reset Enable
      SREN           : FCTL_SREN_Field := NRF_SVD.SEC1.Sysrst_Dis;
      --  Fault Input Enable
      FIEN           : FCTL_FIEN_Field := NRF_SVD.SEC1.Fltin_Dis;
      --  unspecified
      Reserved_8_11  : HAL.UInt4 := 16#0#;
      --  COP Mode Select
      CMS            : FCTL_CMS_Field := NRF_SVD.SEC1.Flt_Mode;
      --  Trigger Event Select
      TES            : FCTL_TES_Field := NRF_SVD.SEC1.Fltact_Mode;
      --  unspecified
      Reserved_14_30 : HAL.UInt17 := 16#0#;
      --  Lock
      LOCK           : FCTL_LOCK_Field := NRF_SVD.SEC1.Unlock;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type FSTAT_Register is record
      ...
      Reserved_0_0   : HAL.Bit := 16#0#;
      --  Error
      ERR            : FSTAT_ERR_Field := NRF_SVD.SEC1.No_Err;
      --  unspecified
      Reserved_2_3   : HAL.UInt2 := 16#0#;
      --  Read-only. Error Cause
      ERRC           : FSTAT_ERRC_Field := NRF_SVD.SEC1.Sovferr;
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  Read-only. Pending Fault
      PND            : FSTAT_PND_Field := NRF_SVD.SEC1.No_Fltpnd;
      --  Read-only. Fault Active
      ACT            : FSTAT_ACT_Field := NRF_SVD.SEC1.No_Fltact;
      --  Read-only. Next Pending Fault
      NPND           : FSTAT_NPND_Field := NRF_SVD.SEC1.No_Nxtflt;
      --  unspecified
   ...
   type FEND_Register is record
      ...
      --  Fault External
      FEXT           : FEND_FEXT_Field := NRF_SVD.SEC1.End_Intflt;
      --  unspecified
   ...
   type SCTL_SEC1_SB_Register is record
      --  unspecified
      Reserved_0_0  : HAL.Bit := 16#0#;
      --  Fault Enable
      FEN           : SCTL_FEN_Field := NRF_SVD.SEC1.Fault_Dis;
      --  Source (signal) Enable
      SEN           : SCTL_SEN_Field := NRF_SVD.SEC1.Src_Dis;
      --  Edge Select
      ES            : SCTL_ES_Field := NRF_SVD.SEC1.Level;
      --  Error Enable
      ERREN         : SCTL_ERREN_Field := NRF_SVD.SEC1.Err_Dis;
      --  unspecified
      Reserved_5_30 : HAL.UInt26 := 16#0#;
      --  Lock
      LOCK          : SCTL_LOCK_Field := NRF_SVD.SEC1.Unlock;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for SCTL_SEC1_SB_Register use record
      Reserved_0_0  at 0 range 0 .. 0;
      FEN           at 0 range 1 .. 1;
      SEN           at 0 range 2 .. 2;
      ES            at 0 range 3 .. 3;
   ...
   type SSTAT_SEC1_SB_Register is record
      --  unspecified
      Reserved_0_0  : HAL.Bit := 16#0#;
      --  Error
      ERR           : SSTAT_ERR_Field := NRF_SVD.SEC1.No_Err;
      --  unspecified
      Reserved_2_3  : HAL.UInt2 := 16#0#;
      --  Read-only. Error Cause
      ERRC          : SSTAT_ERRC_Field := NRF_SVD.SEC1.Sovferr;
      --  unspecified
      Reserved_6_7  : HAL.UInt2 := 16#0#;
      --  Pending Source
      PND           : SSTAT_PND_Field := NRF_SVD.SEC1.Notpending;
      --  unspecified
   ...
   for SSTAT_SEC1_SB_Register use record
      Reserved_0_0  at 0 range 0 .. 0;
      ERR           at 0 range 1 .. 1;
      Reserved_2_3  at 0 range 2 .. 3;
      ERRC          at 0 range 4 .. 5;
   ...
   --  SSI Registers
   type SEC1_SB_Cluster is record
      --  Source Control Register n
      SCTL  : aliased SCTL_SEC1_SB_Register;
      --  Source Status Register n
      SSTAT : aliased SSTAT_SEC1_SB_Register;
   end record
     with Volatile, Size => 64;

   for SEC1_SB_Cluster use record
      SCTL  at 16#0# range 0 .. 31;
      SSTAT at 16#4# range 0 .. 31;
   end record;

   --  SSI Registers
   type SEC1_SB_Clusters is array (0 .. 163) of SEC1_SB_Cluster;
   ...
   type SEC1_Peripheral is record
      --  Global Control Register
      ...
      --  SSI Registers
      SEC1_SB    : aliased SEC1_SB_Clusters;
   end record
     with Volatile;

   for SEC1_Peripheral use record
      ...
      SEC1_SB    at 16#800# range 0 .. 10495;
   end record;

   --  System Event Controller
   SEC1_Periph : aliased SEC1_Peripheral
