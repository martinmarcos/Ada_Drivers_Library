...
package NRF_SVD.SMPU1 is
   ...
   type CTL_Register is record
      --  Read Speculation Disable
      RSDIS         : CTL_RSDIS_Field := NRF_SVD.SMPU1.Rsen;
      --  Protection Violation Bus Error Disable
      PBEDIS        : CTL_PBEDIS_Field := NRF_SVD.SMPU1.Pbeen;
      --  Protection Violation Bus Error Type
      PBETYPE       : CTL_PBETYPE_Field := NRF_SVD.SMPU1.Decerr;
      --  Protection Violation Interrupt Enable
      PINTEN        : CTL_PINTEN_Field := NRF_SVD.SMPU1.Pintdis;
   ...
   type STAT_IOVR_Field is
     (
      ...
      Noiovr,
      --  Interrupt overrun has occurred
      Iovr)
     with Size => 1;
   ...
   type STAT_BEOVR_Field is
     (
      ...
      Nobeovr,
      --  Bus Error overrun has occurred
      Beovr)
     with Size => 1;
   ...
   type STAT_Register is record
      --  Interrupt Request
      IRQ            : STAT_IRQ_Field := NRF_SVD.SMPU1.Noirq;
      --  Interrupt Overrun
      IOVR           : STAT_IOVR_Field := NRF_SVD.SMPU1.Noiovr;
      --  Bus Error
      BERR           : STAT_BERR_Field := NRF_SVD.SMPU1.Noberr;
      --  Bus Error Overrun
      BEOVR          : STAT_BEOVR_Field := NRF_SVD.SMPU1.Nobeovr;
      --  unspecified
      Reserved_4_15  : HAL.UInt12 := 16#0#;
      --  Address Error
      ADRERR         : STAT_ADRERR_Field := NRF_SVD.SMPU1.Noadrerr;
      --  Lock Write Error
      LWERR          : STAT_LWERR_Field := NRF_SVD.SMPU1.Nolwerr;
      --  unspecified
   ...
   subtype IDTLS_ID_Field is HAL.UInt9;
   ...
   subtype BDTLS_ID_Field is HAL.UInt9;
   ...
   ----------------------------------
   -- SMPU1_Rn cluster's Registers --
   ----------------------------------

   subtype RCTL_SMPU1_Rn_SIZE_Field is HAL.UInt5;
   ...
   type RCTL_SMPU1_Rn_Register is record
      --  Region Enable
      EN             : Boolean := False;
      --  Memory Region Size
      SIZE           : RCTL_SMPU1_Rn_SIZE_Field := 16#0#;
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  Read Transaction Protection Enable
      RPROTEN        : RCTL_RPROTEN_Field := NRF_SVD.SMPU1.Rprotdis;
      --  Read Transaction ID Compare Invert
      RIDCINV        : Boolean := False;
      --  Write Transaction Protection Enable
      WPROTEN        : RCTL_WPROTEN_Field := NRF_SVD.SMPU1.Wprotdis;
   ...
   for RCTL_SMPU1_Rn_Register use record
      EN             at 0 range 0 .. 0;
      SIZE           at 0 range 1 .. 5;
   ...
   subtype RADDR_SMPU1_Rn_BADDR_Field is HAL.UInt20;

   --  Region n Address Register
   type RADDR_SMPU1_Rn_Register is record
      --  unspecified
      Reserved_0_11 : HAL.UInt12 := 16#0#;
      --  Region n Base Address 20 Most Significant Bits
      BADDR         : RADDR_SMPU1_Rn_BADDR_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for RADDR_SMPU1_Rn_Register use record
      Reserved_0_11 at 0 range 0 .. 11;
      BADDR         at 0 range 12 .. 31;
   end record;

   subtype RIDA_SMPU1_Rn_ID_Field is HAL.UInt9;

   --  Region n ID A Register
   type RIDA_SMPU1_Rn_Register is record
      --  Region n ID Register A
      ID            : RIDA_SMPU1_Rn_ID_Field := 16#0#;
      --  unspecified
   ...
   for RIDA_SMPU1_Rn_Register use record
      ID            at 0 range 0 .. 8;
      Reserved_9_31 at 0 range 9 .. 31;
   end record;

   subtype RIDMSKA_SMPU1_Rn_MSK_Field is HAL.UInt9;

   --  Region n ID Mask A Register
   type RIDMSKA_SMPU1_Rn_Register is record
      --  Region n ID Mask Register A
      MSK           : RIDMSKA_SMPU1_Rn_MSK_Field := 16#0#;
      --  unspecified
      Reserved_9_31 : HAL.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for RIDMSKA_SMPU1_Rn_Register use record
      MSK           at 0 range 0 .. 8;
      Reserved_9_31 at 0 range 9 .. 31;
   end record;

   subtype RIDB_SMPU1_Rn_ID_Field is HAL.UInt9;

   --  Region n ID B Register
   type RIDB_SMPU1_Rn_Register is record
      --  Region n ID Register B
      ID            : RIDB_SMPU1_Rn_ID_Field := 16#0#;
      --  unspecified
      Reserved_9_31 : HAL.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for RIDB_SMPU1_Rn_Register use record
      ID            at 0 range 0 .. 8;
      Reserved_9_31 at 0 range 9 .. 31;
   end record;

   subtype RIDMSKB_SMPU1_Rn_MSK_Field is HAL.UInt9;

   --  Region n ID Mask B Register
   type RIDMSKB_SMPU1_Rn_Register is record
      --  Region n ID Mask Register B
      MSK           : RIDMSKB_SMPU1_Rn_MSK_Field := 16#0#;
      --  unspecified
      Reserved_9_31 : HAL.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for RIDMSKB_SMPU1_Rn_Register use record
      MSK           at 0 range 0 .. 8;
      Reserved_9_31 at 0 range 9 .. 31;
   end record;

   --  Region n
   type SMPU1_Rn_Cluster is record
      --  Region n Control Register
      RCTL    : aliased RCTL_SMPU1_Rn_Register;
      --  Region n Address Register
      RADDR   : aliased RADDR_SMPU1_Rn_Register;
      --  Region n ID A Register
      RIDA    : aliased RIDA_SMPU1_Rn_Register;
      --  Region n ID Mask A Register
      RIDMSKA : aliased RIDMSKA_SMPU1_Rn_Register;
      --  Region n ID B Register
      RIDB    : aliased RIDB_SMPU1_Rn_Register;
      --  Region n ID Mask B Register
      RIDMSKB : aliased RIDMSKB_SMPU1_Rn_Register;
   end record
     with Volatile, Size => 192;

   for SMPU1_Rn_Cluster use record
   ...
   --  Region n
   type SMPU1_Rn_Clusters is array (0 .. 7) of SMPU1_Rn_Cluster;
   ...
   type SMPU1_Peripheral is record
      --  SMPU Control Register
      ...
      --  Region n
      SMPU1_Rn : aliased SMPU1_Rn_Clusters;
      --  SMPU Revision ID Register
      REVID    : aliased REVID_Register;
   end record
     with Volatile;

   for SMPU1_Peripheral use record
      ...
      SMPU1_Rn at 16#20# range 0 .. 1535;
      REVID    at 16#220# range 0 .. 31;
   end record;

   --  The System Memory Protection Unit
   SMPU1_Periph : aliased SMPU1_Peripheral
