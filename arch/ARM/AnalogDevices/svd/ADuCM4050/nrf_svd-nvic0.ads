...
package NRF_SVD.NVIC0 is
   ...
   type INTCON0_SLEEPONEXIT_Field is
     (
      ...
      Sleeponexit)
     with Size => 1;
   for INTCON0_SLEEPONEXIT_Field use
     (No_Sleeponexit => 0,
      Sleeponexit => 1);

   --  Deep Sleep Flag for Hibernate Mode
   type INTCON0_SLEEPDEEP_Field is
     (
      ...
      Sleepdeep)
     with Size => 1;
   for INTCON0_SLEEPDEEP_Field use
     (No_Sleepdeep => 0,
      Sleepdeep => 1);
   ...
   type INTCON0_Register is record
      ...
      --  Sleeps the Core on Exit from an ISR
      SLEEPONEXIT   : INTCON0_SLEEPONEXIT_Field :=
                       NRF_SVD.NVIC0.No_Sleeponexit;
      --  Deep Sleep Flag for Hibernate Mode
      SLEEPDEEP     : INTCON0_SLEEPDEEP_Field := NRF_SVD.NVIC0.No_Sleepdeep;
      --  unspecified
   ...
   type NVIC0_Peripheral is record
      ...
      --  IRQ44..47 Priority
      INTPRI11   : aliased HAL.UInt32;
      --  IRQ48..51 Priority
      INTPRI12   : aliased HAL.UInt32;
      --  IRQ52..55 Priority
      INTPRI13   : aliased HAL.UInt32;
      --  IRQ56..59 Priority
      INTPRI14   : aliased HAL.UInt32;
      --  IRQ60..63 Priority
      INTPRI15   : aliased HAL.UInt32;
      --  IRQ64..67 Priority
      INTPRI16   : aliased HAL.UInt32;
      --  IRQ68..71 Priority
      INTPRI17   : aliased HAL.UInt32;
      --  CPUID Base
   ...
   for NVIC0_Peripheral use record
      ...
      INTPRI11   at 16#42C# range 0 .. 31;
      INTPRI12   at 16#430# range 0 .. 31;
      INTPRI13   at 16#434# range 0 .. 31;
      INTPRI14   at 16#438# range 0 .. 31;
      INTPRI15   at 16#43C# range 0 .. 31;
      INTPRI16   at 16#440# range 0 .. 31;
      INTPRI17   at 16#444# range 0 .. 31;
