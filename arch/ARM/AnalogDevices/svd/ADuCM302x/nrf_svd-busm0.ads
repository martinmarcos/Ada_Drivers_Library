...
package NRF_SVD.BUSM0 is
   ...
   subtype ARBIT1_SIP_DCODE_Field is HAL.UInt2;
   subtype ARBIT1_SIP_SBUS_Field is HAL.UInt2;
   subtype ARBIT1_SIP_DMA0_Field is HAL.UInt2;
   ...
   type ARBIT1_Register is record
      ...
      SIP_DCODE      : ARBIT1_SIP_DCODE_Field := 16#0#;
      --  SIP priority for SBUS
      SIP_SBUS       : ARBIT1_SIP_SBUS_Field := 16#1#;
      --  SIP priority for DMA0
      SIP_DMA0       : ARBIT1_SIP_DMA0_Field := 16#2#;
      --  unspecified
      Reserved_22_31 : HAL.UInt10 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for ARBIT1_Register use record
      ...
      Reserved_6_15  at 0 range 6 .. 15;
      SIP_DCODE      at 0 range 16 .. 17;
      SIP_SBUS       at 0 range 18 .. 19;
      SIP_DMA0       at 0 range 20 .. 21;
      Reserved_22_31 at 0 range 22 .. 31;
   end record;
