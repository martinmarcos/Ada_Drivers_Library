...
package NRF_SVD.DMA0 is
   ...
   subtype SWREQ_CHAN_Field is HAL.UInt25;
   ...
   for SWREQ_Register use record
      CHAN           at 0 range 0 .. 24;
      Reserved_25_31 at 0 range 25 .. 31;
   end record;

   subtype RMSK_SET_CHAN_Field is HAL.UInt25;
   ...
   subtype RMSK_CLR_CHAN_Field is HAL.UInt25;
   ...
   subtype EN_SET_CHAN_Field is HAL.UInt25;
   ...
   subtype EN_CLR_CHAN_Field is HAL.UInt25;
   ...
   subtype ALT_SET_CHAN_Field is HAL.UInt25;
   ...
   subtype ALT_CLR_CHAN_Field is HAL.UInt25;
   ...
   subtype PRI_SET_CHAN_Field is HAL.UInt25;
   ...
   subtype PRI_CLR_CHPRICLR_Field is HAL.UInt25;
   ...
   for PRI_CLR_Register use record
      CHPRICLR       at 0 range 0 .. 24;
      Reserved_25_31 at 0 range 25 .. 31;
   end record;

   subtype ERRCHNL_CLR_CHAN_Field is HAL.UInt25;
   ...
   subtype ERR_CLR_CHAN_Field is HAL.UInt25;
   ...
   subtype INVALIDDESC_CLR_CHAN_Field is HAL.UInt25;
   ...
   subtype BS_SET_CHAN_Field is HAL.UInt25;
   ...
   subtype BS_CLR_CHAN_Field is HAL.UInt25;
   ...
   subtype SRCADDR_SET_CHAN_Field is HAL.UInt25;
   ...
   subtype SRCADDR_CLR_CHAN_Field is HAL.UInt25;
   ...
   subtype DSTADDR_SET_CHAN_Field is HAL.UInt25;
   ...
   subtype DSTADDR_CLR_CHAN_Field is HAL.UInt25;
