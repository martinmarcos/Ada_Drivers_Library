...
package NRF_SVD.ADC is
   ...
   subtype MR_STSEL_Field is HAL.UInt4;
   ...
   type MR_Register is record
      ...
      --  Stop/Restart at end of sequence
      ARST           : Boolean := False;
      --  ADC Enable
      ADEN           : Boolean := False;
   ...
   --  ADCn Sequence/Channel Select Register
   ...
   type SR_Register is record
      --  Sequence Conversion Complete interrupt flag
   ...
   type IER_Register is record
      --  ADC Sequence Conversion Complete interrupt enable
      EOCIRQE       : Boolean := False;
      --  unspecified
      Reserved_1_1  : HAL.Bit := 16#0#;
      --  ADC End of Sequence conversion interrupt enable
   ...
   type ADC_Peripheral is record
      ...
      --  ADC Sequence 1 Data Register
      DR1  : aliased DR_Register;
      --  ADC Sequence 2 Data Register
      DR2  : aliased DR_Register;
      --  ADC Sequence 3 Data Register
      DR3  : aliased DR_Register;
      --  ADC Sequence 4 Data Register
      DR4  : aliased DR_Register;
      --  ADC Sequence 5 Data Register
      DR5  : aliased DR_Register;
      --  ADC Sequence 6 Data Register
      DR6  : aliased DR_Register;
      --  ADC Sequence 7 Data Register
