...
package NRF_SVD.UART is
   ...
   type THR_Register is record
      --  Write-only. received/transmit data
   ...
   type IIR_Register is record
      ...
      --  Read-only. Data Receive Interrupt Flag
      DR             : Boolean;
      --  Read-only. Transmit Holding register empty flag
      THRE           : Boolean;
      --  Read-only. Receiver line status flag
      RLS            : Boolean;
      --  unspecified
   ...
   for IIR_Register use record
      ...
      DR             at 0 range 16 .. 16;
      THRE           at 0 range 17 .. 17;
      RLS            at 0 range 18 .. 18;
   ...
   type IDTR_Register is record
      ...
      --  Data Bit Multi sampling enable
      DMS           : Boolean := False;
      --  Start Bit Multi sampling enable
      SMS           : Boolean := False;
      --  unspecified
      Reserved_8_31 : HAL.UInt24 := 16#0#;
   end record
