...
package NRF_SVD.UART is
   ...
   type LSR_Register is record
      ...
      BI            : Boolean;
      --  Read-only. Transmit holding register empty
      THRE          : Boolean;
   ...
   --  UNIVERSAL ASYNCHRONOUS RECEIVER/TRANSMITTER
   U2_Periph : aliased UART_Peripheral
     with Import, Address => System'To_Address (16#40008200#);

   --  UNIVERSAL ASYNCHRONOUS RECEIVER/TRANSMITTER
   U3_Periph : aliased UART_Peripheral
     with Import, Address => System'To_Address (16#40008300#);
