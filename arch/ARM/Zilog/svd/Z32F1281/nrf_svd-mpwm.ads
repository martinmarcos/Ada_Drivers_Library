...
package NRF_SVD.MPWM is
   ...
   for OCR_Register use record
      WLEN          at 0 range 0 .. 0;
      WHVAL         at 0 range 1 .. 1;
      VLVAL         at 0 range 2 .. 2;
      VHVAL         at 0 range 3 .. 3;
      ULVAL         at 0 range 4 .. 4;
      UHVAL         at 0 range 5 .. 5;
   ...
   for PCR_Register use record
      ...
      PRTIN          at 0 range 23 .. 23;
      Reserved_24_31 at 0 range 24 .. 31;
   end record;

   subtype PSR_PROTPAT_Field is HAL.UInt16;
   ...
   type PSR_Register is record
      ...
      PROTPAT       : PSR_PROTPAT_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
