...
package LPC43_SVD.CGU is
   ...
   subtype FREQ_MON_RCNT_Field is LPC43_SVD.UInt9;
   subtype FREQ_MON_FCNT_Field is LPC43_SVD.UInt14;
   ...
   subtype FREQ_MON_RESERVED_Field is LPC43_SVD.UInt3;
   ...
   type FREQ_MON_Register is record
      ...
      --  Measure frequency
      MEAS     : FREQ_MON_ENUM := LPC43_SVD.CGU.Rcnt_And_Fcnt_Disabl;
      --  Clock-source selection for the clock to be measured. All other values
      --  are reserved.
      CLK_SEL  : FREQ_MON_ENUM_1 :=
                  LPC43_SVD.CGU.FREQ_MON_ENUM_32_Khz_Oscillator_D;
      --  Reserved
   ...
   subtype XTAL_OSC_CTRL_RESERVED_Field is LPC43_SVD.UInt29;
   ...
   type XTAL_OSC_CTRL_Register is record
      ...
      ENABLE   : XTAL_OSC_CTRL_ENUM := LPC43_SVD.CGU.Power_Down;
      --  Configure crystal operation or external-clock input pin XTAL1. Do not
      --  change the BYPASS and ENABLE bits in one write-action: this will
      --  result in unstable device operation!
      BYPASS   : XTAL_OSC_CTRL_ENUM_1 := LPC43_SVD.CGU.Crystal;
      --  Select frequency range
      HF       : XTAL_OSC_CTRL_ENUM_2 := LPC43_SVD.CGU.High;
      --  Reserved
   ...
   subtype PLL0USB_STAT_LOCK_Field is LPC43_SVD.Bit;
   subtype PLL0USB_STAT_FR_Field is LPC43_SVD.Bit;
   subtype PLL0USB_STAT_RESERVED_Field is LPC43_SVD.UInt30;
   ...
   subtype PLL0USB_CTRL_DIRECTI_Field is LPC43_SVD.Bit;
   subtype PLL0USB_CTRL_DIRECTO_Field is LPC43_SVD.Bit;
   subtype PLL0USB_CTRL_CLKEN_Field is LPC43_SVD.Bit;
   subtype PLL0USB_CTRL_RESERVED_Field is LPC43_SVD.Bit;
   subtype PLL0USB_CTRL_FRM_Field is LPC43_SVD.Bit;
   --  PLL0USB_CTRL_RESERVED array element
   subtype PLL0USB_CTRL_RESERVED_Element is LPC43_SVD.Bit;
   ...
   subtype PLL0USB_CTRL_RESERVED_Field_2 is LPC43_SVD.UInt12;
   ...
   subtype PLL0USB_CTRL_RESERVED_Field_3 is LPC43_SVD.UInt3;

   --  PLL0USB control register
   type PLL0USB_CTRL_Register is record
      --  PLL0 power down
      PD         : PLL0USB_CTRL_ENUM := LPC43_SVD.CGU.Pll0_Powered_Down;
      --  Input clock bypass control
      BYPASS     : PLL0USB_CTRL_ENUM_1 := LPC43_SVD.CGU.Pll0_Input_Clock_Sen;
      --  PLL0 direct input
      ...
      --  Block clock automatically during frequency change
      AUTOBLOCK  : PLL0USB_CTRL_ENUM_2 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_2 : PLL0USB_CTRL_RESERVED_Field_2 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : PLL0USB_CTRL_ENUM_3 := LPC43_SVD.CGU.Irc;
      --  Reserved
   ...
   subtype PLL0USB_MDIV_MDEC_Field is LPC43_SVD.UInt17;
   subtype PLL0USB_MDIV_SELP_Field is LPC43_SVD.UInt5;
   subtype PLL0USB_MDIV_SELI_Field is LPC43_SVD.UInt6;
   subtype PLL0USB_MDIV_SELR_Field is LPC43_SVD.UInt4;
   ...
   subtype PLL0USB_NP_DIV_PDEC_Field is LPC43_SVD.UInt7;
   subtype PLL0USB_NP_DIV_RESERVED_Field is LPC43_SVD.UInt5;
   subtype PLL0USB_NP_DIV_NDEC_Field is LPC43_SVD.UInt10;
   subtype PLL0USB_NP_DIV_RESERVED_Field_1 is LPC43_SVD.UInt10;
   ...
   subtype PLL0AUDIO_STAT_LOCK_Field is LPC43_SVD.Bit;
   subtype PLL0AUDIO_STAT_FR_Field is LPC43_SVD.Bit;
   subtype PLL0AUDIO_STAT_RESERVED_Field is LPC43_SVD.UInt30;
   ...
   subtype PLL0AUDIO_CTRL_DIRECTI_Field is LPC43_SVD.Bit;
   subtype PLL0AUDIO_CTRL_DIRECTO_Field is LPC43_SVD.Bit;
   subtype PLL0AUDIO_CTRL_CLKEN_Field is LPC43_SVD.Bit;
   subtype PLL0AUDIO_CTRL_RESERVED_Field is LPC43_SVD.Bit;
   subtype PLL0AUDIO_CTRL_FRM_Field is LPC43_SVD.Bit;
   --  PLL0AUDIO_CTRL_RESERVED array element
   subtype PLL0AUDIO_CTRL_RESERVED_Element is LPC43_SVD.Bit;
   ...
   subtype PLL0AUDIO_CTRL_PLLFRACT_REQ_Field is LPC43_SVD.Bit;
   ...
   subtype PLL0AUDIO_CTRL_RESERVED_Field_2 is LPC43_SVD.UInt9;
   ...
   subtype PLL0AUDIO_CTRL_RESERVED_Field_3 is LPC43_SVD.UInt3;

   --  PLL0AUDIO control register
   type PLL0AUDIO_CTRL_Register is record
      --  PLL0 power down
      PD           : PLL0AUDIO_CTRL_ENUM := LPC43_SVD.CGU.Pll0_Powered_Down;
      --  Input clock bypass control
      BYPASS       : PLL0AUDIO_CTRL_ENUM_1 :=
                      LPC43_SVD.CGU.Pll0_Input_Clock_Sen;
      --  PLL0 direct input
      ...
      RESERVED_1   : PLL0AUDIO_CTRL_RESERVED_Field_1 :=
                      (As_Array => False, Val => 16#0#);
      --  Block clock automatically during frequency change
      AUTOBLOCK    : PLL0AUDIO_CTRL_ENUM_2 := LPC43_SVD.CGU.Disabled;
      ...
      --  Select fractional divider.
      SEL_EXT      : PLL0AUDIO_CTRL_ENUM_3 := LPC43_SVD.CGU.Frac_Enabled;
      --  Sigma-Delta modulator power-down
      MOD_PD       : PLL0AUDIO_CTRL_ENUM_4 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_2   : PLL0AUDIO_CTRL_RESERVED_Field_2 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL      : PLL0AUDIO_CTRL_ENUM_5 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype PLL0AUDIO_MDIV_MDEC_Field is LPC43_SVD.UInt17;
   subtype PLL0AUDIO_MDIV_RESERVED_Field is LPC43_SVD.UInt15;
   ...
   subtype PLL0AUDIO_NP_DIV_PDEC_Field is LPC43_SVD.UInt7;
   subtype PLL0AUDIO_NP_DIV_RESERVED_Field is LPC43_SVD.UInt5;
   subtype PLL0AUDIO_NP_DIV_NDEC_Field is LPC43_SVD.UInt10;
   subtype PLL0AUDIO_NP_DIV_RESERVED_Field_1 is LPC43_SVD.UInt10;
   ...
   subtype PLL0AUDIO_FRAC_PLLFRACT_CTRL_Field is LPC43_SVD.UInt22;
   subtype PLL0AUDIO_FRAC_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype PLL1_STAT_LOCK_Field is LPC43_SVD.Bit;
   subtype PLL1_STAT_RESERVED_Field is LPC43_SVD.UInt31;
   ...
   subtype PLL1_CTRL_RESERVED_Field is LPC43_SVD.Bit;
   subtype PLL1_CTRL_RESERVED_Field_1 is LPC43_SVD.UInt3;
   ...
   subtype PLL1_CTRL_RESERVED_Field_2 is LPC43_SVD.UInt2;
   subtype PLL1_CTRL_MSEL_Field is LPC43_SVD.Byte;
   ...
   type PLL1_CTRL_Register is record
      --  PLL1 power down
      PD         : PLL1_CTRL_ENUM := LPC43_SVD.CGU.Pll1_Powered_Down;
      --  Input clock bypass control
      BYPASS     : PLL1_CTRL_ENUM_1 := LPC43_SVD.CGU.Input_Clock;
      ...
      --  PLL feedback select.
      FBSEL      : PLL1_CTRL_ENUM_2 := LPC43_SVD.CGU.Cco_Out;
      --  PLL direct CCO output
      DIRECT     : PLL1_CTRL_ENUM_3 := LPC43_SVD.CGU.Disabled;
      --  Post-divider division ratio P. The value applied is 2xP.
      PSEL       : PLL1_CTRL_ENUM_4 := LPC43_SVD.CGU.PLL1_CTRL_ENUM_1_1;
      --  Reserved
      RESERVED_2 : PLL1_CTRL_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : PLL1_CTRL_ENUM_3 := LPC43_SVD.CGU.Disabled;
      --  Pre-divider division ratio N
      NSEL       : PLL1_CTRL_ENUM_5 := LPC43_SVD.CGU.PLL1_CTRL_ENUM_1_1;
      --  Reserved
      ...
      --  Clock-source selection.
      CLK_SEL    : PLL1_CTRL_ENUM_6 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype IDIVA_CTRL_RESERVED_Field is LPC43_SVD.Bit;
   ...
   subtype IDIVA_CTRL_RESERVED_Field_1 is LPC43_SVD.UInt7;
   ...
   subtype IDIVA_CTRL_RESERVED_Field_2 is LPC43_SVD.UInt12;
   ...
   subtype IDIVA_CTRL_RESERVED_Field_3 is LPC43_SVD.UInt3;

   --  Integer divider A control register
   type IDIVA_CTRL_Register is record
      --  Integer divider A power down
      PD         : IDIVA_CTRL_ENUM := LPC43_SVD.CGU.Enabled;
      --  Reserved
      RESERVED   : IDIVA_CTRL_RESERVED_Field := 16#0#;
      --  Integer divider A divider values (1/(IDIV + 1))
      IDIV       : IDIVA_CTRL_ENUM_1 := LPC43_SVD.CGU.Div1;
      --  Reserved
      RESERVED_1 : IDIVA_CTRL_RESERVED_Field_1 := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : IDIVA_CTRL_ENUM_2 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_2 : IDIVA_CTRL_RESERVED_Field_2 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : IDIVA_CTRL_ENUM_3 := LPC43_SVD.CGU.Irc;
      --  Reserved
   ...
   subtype IDIVB_CTRL_RESERVED_Field is LPC43_SVD.Bit;
   subtype IDIVB_CTRL_IDIV_Field is LPC43_SVD.UInt4;
   subtype IDIVB_CTRL_RESERVED_Field_1 is LPC43_SVD.UInt5;
   ...
   subtype IDIVB_CTRL_RESERVED_Field_2 is LPC43_SVD.UInt12;
   ...
   subtype IDIVB_CTRL_RESERVED_Field_3 is LPC43_SVD.UInt3;

   --  Integer divider B control register
   type IDIVB_CTRL_Register is record
      --  Integer divider power down
      PD         : IDIVB_CTRL_ENUM := LPC43_SVD.CGU.Enabled;
      --  Reserved
      ...
      --  Block clock automatically during frequency change
      AUTOBLOCK  : IDIVB_CTRL_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_2 : IDIVB_CTRL_RESERVED_Field_2 := 16#0#;
      --  Clock-source selection. All other values are reserved.
      CLK_SEL    : IDIVB_CTRL_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype IDIVC_CTRL_RESERVED_Field is LPC43_SVD.Bit;
   subtype IDIVC_CTRL_IDIV_Field is LPC43_SVD.UInt4;
   subtype IDIVC_CTRL_RESERVED_Field_1 is LPC43_SVD.UInt5;
   ...
   subtype IDIVC_CTRL_RESERVED_Field_2 is LPC43_SVD.UInt12;
   ...
   subtype IDIVC_CTRL_RESERVED_Field_3 is LPC43_SVD.UInt3;

   --  Integer divider C control register
   type IDIVC_CTRL_Register is record
      --  Integer divider power down
      PD         : IDIVC_CTRL_ENUM := LPC43_SVD.CGU.Enabled;
      --  Reserved
      ...
      --  Block clock automatically during frequency change
      AUTOBLOCK  : IDIVC_CTRL_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_2 : IDIVC_CTRL_RESERVED_Field_2 := 16#0#;
      --  Clock-source selection. All other values are reserved.
      CLK_SEL    : IDIVC_CTRL_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype IDIVD_CTRL_RESERVED_Field is LPC43_SVD.Bit;
   subtype IDIVD_CTRL_IDIV_Field is LPC43_SVD.UInt4;
   subtype IDIVD_CTRL_RESERVED_Field_1 is LPC43_SVD.UInt5;
   ...
   subtype IDIVD_CTRL_RESERVED_Field_2 is LPC43_SVD.UInt12;
   ...
   subtype IDIVD_CTRL_RESERVED_Field_3 is LPC43_SVD.UInt3;

   --  Integer divider D control register
   type IDIVD_CTRL_Register is record
      --  Integer divider power down
      PD         : IDIVD_CTRL_ENUM := LPC43_SVD.CGU.Enabled;
      --  Reserved
      ...
      --  Block clock automatically during frequency change
      AUTOBLOCK  : IDIVD_CTRL_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_2 : IDIVD_CTRL_RESERVED_Field_2 := 16#0#;
      --  Clock-source selection. All other values are reserved.
      CLK_SEL    : IDIVD_CTRL_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype IDIVE_CTRL_RESERVED_Field is LPC43_SVD.Bit;
   subtype IDIVE_CTRL_IDIV_Field is LPC43_SVD.Byte;
   ...
   subtype IDIVE_CTRL_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype IDIVE_CTRL_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Integer divider E control register
   type IDIVE_CTRL_Register is record
      --  Integer divider power down
      PD         : IDIVE_CTRL_ENUM := LPC43_SVD.CGU.Enabled;
      --  Reserved
      ...
      --  Block clock automatically during frequency change
      AUTOBLOCK  : IDIVE_CTRL_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_2 : IDIVE_CTRL_RESERVED_Field_1 := 16#0#;
      --  Clock-source selection. All other values are reserved.
      CLK_SEL    : IDIVE_CTRL_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_SAFE_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_SAFE_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_SAFE_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;
   ...
   subtype BASE_USB0_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_USB0_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_USB0_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage 1 control register for base clock BASE_USB0_CLK
   type BASE_USB0_CLK_Register is record
      --  Output stage power down
      PD         : BASE_USB0_CLK_ENUM := LPC43_SVD.CGU.Enabled;
      --  Reserved
      RESERVED   : BASE_USB0_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_USB0_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_USB0_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock-source selection.
      CLK_SEL    : BASE_USB0_CLK_ENUM_2 := LPC43_SVD.CGU.Pll0Usb;
      --  Reserved
   ...
   subtype BASE_PERIPH_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_PERIPH_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_PERIPH_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage 2 control register for base clock BASE_PERIPH_CLK
   type BASE_PERIPH_CLK_Register is record
      --  Output stage power down
      PD         : BASE_PERIPH_CLK_ENUM := LPC43_SVD.CGU.Enabled;
      --  Reserved
      RESERVED   : BASE_PERIPH_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_PERIPH_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
   ...
   subtype BASE_USB1_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_USB1_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_USB1_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage 3 control register for base clock BASE_USB1_CLK
   type BASE_USB1_CLK_Register is record
      --  Output stage power down
      PD         : BASE_USB1_CLK_ENUM := LPC43_SVD.CGU.Enabled;
      --  Reserved
      RESERVED   : BASE_USB1_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_USB1_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_USB1_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_USB1_CLK_ENUM_2 := LPC43_SVD.CGU.Irc;
      --  Reserved
   ...
   subtype BASE_M4_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_M4_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_M4_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage BASE_M4_CLK control register
   type BASE_M4_CLK_Register is record
      --  Output stage power down
      PD         : BASE_M4_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_M4_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_M4_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_M4_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_M4_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_SPIFI_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_SPIFI_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_SPIFI_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage BASE_SPIFI_CLK control register
   type BASE_SPIFI_CLK_Register is record
      --  Output stage power down
      PD         : BASE_SPIFI_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_SPIFI_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_SPIFI_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_SPIFI_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_SPIFI_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_SPI_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_SPI_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_SPI_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage BASE_SPI_CLK control register
   type BASE_SPI_CLK_Register is record
      --  Output stage power down
      PD         : BASE_SPI_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_SPI_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_SPI_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_SPI_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_SPI_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_PHY_RX_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_PHY_RX_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_PHY_RX_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage BASE_PHY_RX_CLK control register
   type BASE_PHY_RX_CLK_Register is record
      --  Output stage power down
      PD         : BASE_PHY_RX_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_PHY_RX_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_PHY_RX_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_PHY_RX_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_PHY_RX_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_PHY_TX_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_PHY_TX_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_PHY_TX_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage BASE_PHY_TX_CLK control register
   type BASE_PHY_TX_CLK_Register is record
      --  Output stage power down
      PD         : BASE_PHY_TX_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_PHY_TX_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_PHY_TX_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_PHY_TX_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_PHY_TX_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_APB1_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_APB1_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_APB1_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage BASE_APB1_CLK control register
   type BASE_APB1_CLK_Register is record
      --  Output stage power down
      PD         : BASE_APB1_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_APB1_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_APB1_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_APB1_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_APB1_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_APB3_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_APB3_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_APB3_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage BASE_APB3_CLK control register
   type BASE_APB3_CLK_Register is record
      --  Output stage power down
      PD         : BASE_APB3_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_APB3_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_APB3_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_APB3_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_APB3_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_LCD_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_LCD_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_LCD_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage BASE_LCD_CLK control register
   type BASE_LCD_CLK_Register is record
      --  Output stage power down
      PD         : BASE_LCD_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_LCD_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_LCD_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_LCD_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_LCD_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_SDIO_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_SDIO_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_SDIO_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage BASE_SDIO_CLK control register
   type BASE_SDIO_CLK_Register is record
      --  Output stage power down
      PD         : BASE_SDIO_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_SDIO_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_SDIO_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_SDIO_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_SDIO_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_SSP0_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_SSP0_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_SSP0_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage BASE_SSP0_CLK control register
   type BASE_SSP0_CLK_Register is record
      --  Output stage power down
      PD         : BASE_SSP0_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_SSP0_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_SSP0_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_SSP0_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_SSP0_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_SSP1_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_SSP1_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_SSP1_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage BASE_SSP1_CLK control register
   type BASE_SSP1_CLK_Register is record
      --  Output stage power down
      PD         : BASE_SSP1_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_SSP1_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_SSP1_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_SSP1_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_SSP1_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_UART0_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_UART0_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_UART0_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage BASE_UART0_CLK control register
   type BASE_UART0_CLK_Register is record
      --  Output stage power down
      PD         : BASE_UART0_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_UART0_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_UART0_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_UART0_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_UART0_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_UART1_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_UART1_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_UART1_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage BASE_UART1_CLK control register
   type BASE_UART1_CLK_Register is record
      --  Output stage power down
      PD         : BASE_UART1_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_UART1_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_UART1_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_UART1_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_UART1_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_UART2_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_UART2_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_UART2_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage BASE_UART2_CLK control register
   type BASE_UART2_CLK_Register is record
      --  Output stage power down
      PD         : BASE_UART2_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_UART2_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_UART2_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_UART2_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_UART2_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_UART3_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_UART3_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_UART3_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage BASE_UART3_CLK control register
   type BASE_UART3_CLK_Register is record
      --  Output stage power down
      PD         : BASE_UART3_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_UART3_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_UART3_CLK_ENUM_1 := LPC43_SVD.CGU.Disabled;
      --  Reserved
      RESERVED_1 : BASE_UART3_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : BASE_UART3_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_OUT_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_OUT_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_OUT_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;

   --  Output stage 20 control register for base clock BASE_OUT_CLK
   type BASE_OUT_CLK_Register is record
      --  Output stage power down
      PD         : BASE_OUT_CLK_ENUM := LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      RESERVED   : BASE_OUT_CLK_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : BASE_OUT_CLK_ENUM_1 := LPC43_SVD.CGU.Autoblocking_Disable;
      --  Reserved
      RESERVED_1 : BASE_OUT_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock-source selection.
      CLK_SEL    : BASE_OUT_CLK_ENUM_2 := LPC43_SVD.CGU.Irc_Default;
      --  Reserved
   ...
   subtype BASE_AUDIO_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_AUDIO_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_CGU_OUT0_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_CGU_OUT0_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_CGU_OUT0_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;
   ...
   type BASE_CGU_OUT0_CLK_Register is record
      ...
      PD         : BASE_CGU_OUT0_CLK_ENUM :=
                    LPC43_SVD.CGU.Output_Stage_Enabled;
      --  Reserved
      ...
      CLK_SEL    : BASE_CGU_OUT0_CLK_ENUM_2 :=
                    LPC43_SVD.CGU.BASE_CGU_OUT0_CLK_ENUM_32_Khz_Oscillator;
      --  Reserved
   ...
   subtype BASE_CGU_OUT1_CLK_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype BASE_CGU_OUT1_CLK_RESERVED_Field_1 is LPC43_SVD.UInt12;
   ...
   subtype BASE_CGU_OUT1_CLK_RESERVED_Field_2 is LPC43_SVD.UInt3;
   ...
   type BASE_CGU_OUT1_CLK_Register is record
      ...
      CLK_SEL    : BASE_CGU_OUT1_CLK_ENUM_2 :=
                    LPC43_SVD.CGU.BASE_CGU_OUT1_CLK_ENUM_32_Khz_Oscillator;
      --  Reserved
