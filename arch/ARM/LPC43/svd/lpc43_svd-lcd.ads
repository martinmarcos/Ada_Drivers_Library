...
package LPC43_SVD.LCD is
   ...
   subtype TIMH_RESERVED_Field is HAL.UInt2;
   ...
   subtype LE_RESERVED_Field is HAL.UInt9;
   subtype LE_RESERVED_Field_1 is HAL.UInt15;
   ...
   subtype UPBASE_RESERVED_Field is HAL.UInt3;
   ...
   subtype LPBASE_RESERVED_Field is HAL.UInt3;
   ...
   subtype CTRL_RESERVED_Field is HAL.UInt2;
   subtype CTRL_RESERVED_Field_1 is HAL.UInt15;
   ...
   subtype INTMSK_RESERVED_Field is HAL.UInt27;
   ...
   type INTMSK_Register is record
      ...
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_1 : INTMSK_RESERVED_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype INTRAW_RESERVED_Field is HAL.UInt27;
   ...
   type INTRAW_Register is record
      ...
      --  Read-only. Reserved, user software should not write ones to reserved
      --  bits. The value read from a reserved bit is not defined.
      RESERVED_1 : INTRAW_RESERVED_Field;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype INTSTAT_RESERVED_Field is HAL.UInt27;
   ...
   type INTSTAT_Register is record
      ...
      --  Read-only. Reserved, user software should not write ones to reserved
      --  bits. The value read from a reserved bit is not defined.
      RESERVED_1 : INTSTAT_RESERVED_Field;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype INTCLR_RESERVED_Field is HAL.UInt27;
   ...
   type INTCLR_Register is record
      ...
      --  Write-only. Reserved, user software should not write ones to reserved
      --  bits. The value read from a reserved bit is not defined.
      RESERVED_1 : INTCLR_RESERVED_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CRSR_CTRL_RESERVED_Field is HAL.UInt3;
   subtype CRSR_CTRL_CRSRNUM1_0_Field is HAL.UInt2;
   subtype CRSR_CTRL_RESERVED_Field_1 is HAL.UInt26;
   ...
   subtype CRSR_CFG_RESERVED_Field is HAL.UInt30;
   ...
   subtype CRSR_PAL_RESERVED_Field is HAL.UInt8;
   ...
   subtype CRSR_XY_RESERVED_Field is HAL.UInt6;
   ...
   subtype CRSR_CLIP_RESERVED_Field is HAL.UInt2;
   subtype CRSR_CLIP_CRSRCLIPY_Field is HAL.UInt6;
   subtype CRSR_CLIP_RESERVED_Field_1 is HAL.UInt18;
   ...
   subtype CRSR_INTMSK_RESERVED_Field is HAL.UInt31;
   ...
   subtype CRSR_INTCLR_RESERVED_Field is HAL.UInt31;
   ...
   subtype CRSR_INTRAW_RESERVED_Field is HAL.UInt31;
   ...
   subtype CRSR_INTSTAT_RESERVED_Field is HAL.UInt31;
