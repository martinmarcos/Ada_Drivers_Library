...
package LPC43_SVD.LCD is
   ...
   subtype TIMH_RESERVED_Field is LPC43_SVD.UInt2;
   subtype TIMH_PPL_Field is LPC43_SVD.UInt6;
   subtype TIMH_HSW_Field is LPC43_SVD.Byte;
   subtype TIMH_HFP_Field is LPC43_SVD.Byte;
   subtype TIMH_HBP_Field is LPC43_SVD.Byte;
   ...
   subtype TIMV_LPP_Field is LPC43_SVD.UInt10;
   subtype TIMV_VSW_Field is LPC43_SVD.UInt6;
   subtype TIMV_VFP_Field is LPC43_SVD.Byte;
   subtype TIMV_VBP_Field is LPC43_SVD.Byte;
   ...
   subtype POL_PCD_LO_Field is LPC43_SVD.UInt5;
   subtype POL_CLKSEL_Field is LPC43_SVD.Bit;
   subtype POL_ACB_Field is LPC43_SVD.UInt5;
   subtype POL_IVS_Field is LPC43_SVD.Bit;
   subtype POL_IHS_Field is LPC43_SVD.Bit;
   subtype POL_IPC_Field is LPC43_SVD.Bit;
   subtype POL_IOE_Field is LPC43_SVD.Bit;
   subtype POL_RESERVED_Field is LPC43_SVD.Bit;
   subtype POL_CPL_Field is LPC43_SVD.UInt10;
   subtype POL_BCD_Field is LPC43_SVD.Bit;
   subtype POL_PCD_HI_Field is LPC43_SVD.UInt5;
   ...
   subtype LE_LED_Field is LPC43_SVD.UInt7;
   subtype LE_RESERVED_Field is LPC43_SVD.UInt9;
   subtype LE_LEE_Field is LPC43_SVD.Bit;
   subtype LE_RESERVED_Field_1 is LPC43_SVD.UInt15;
   ...
   subtype UPBASE_RESERVED_Field is LPC43_SVD.UInt3;
   subtype UPBASE_LCDUPBASE_Field is LPC43_SVD.UInt29;
   ...
   subtype LPBASE_RESERVED_Field is LPC43_SVD.UInt3;
   subtype LPBASE_LCDLPBASE_Field is LPC43_SVD.UInt29;
   ...
   subtype CTRL_LCDEN_Field is LPC43_SVD.Bit;
   subtype CTRL_LCDBPP_Field is LPC43_SVD.UInt3;
   subtype CTRL_LCDBW_Field is LPC43_SVD.Bit;
   subtype CTRL_LCDTFT_Field is LPC43_SVD.Bit;
   subtype CTRL_LCDMONO8_Field is LPC43_SVD.Bit;
   subtype CTRL_LCDDUAL_Field is LPC43_SVD.Bit;
   subtype CTRL_BGR_Field is LPC43_SVD.Bit;
   subtype CTRL_BEBO_Field is LPC43_SVD.Bit;
   subtype CTRL_BEPO_Field is LPC43_SVD.Bit;
   subtype CTRL_LCDPWR_Field is LPC43_SVD.Bit;
   subtype CTRL_LCDVCOMP_Field is LPC43_SVD.UInt2;
   subtype CTRL_RESERVED_Field is LPC43_SVD.UInt2;
   subtype CTRL_WATERMARK_Field is LPC43_SVD.Bit;
   subtype CTRL_RESERVED_Field_1 is LPC43_SVD.UInt15;
   ...
   subtype INTMSK_RESERVED_Field is LPC43_SVD.Bit;
   subtype INTMSK_FUFIM_Field is LPC43_SVD.Bit;
   subtype INTMSK_LNBUIM_Field is LPC43_SVD.Bit;
   subtype INTMSK_VCOMPIM_Field is LPC43_SVD.Bit;
   subtype INTMSK_BERIM_Field is LPC43_SVD.Bit;
   subtype INTMSK_RESERVED_Field_1 is LPC43_SVD.UInt27;
   ...
   subtype INTRAW_RESERVED_Field is LPC43_SVD.Bit;
   subtype INTRAW_FUFRIS_Field is LPC43_SVD.Bit;
   subtype INTRAW_LNBURIS_Field is LPC43_SVD.Bit;
   subtype INTRAW_VCOMPRIS_Field is LPC43_SVD.Bit;
   subtype INTRAW_BERRAW_Field is LPC43_SVD.Bit;
   subtype INTRAW_RESERVED_Field_1 is LPC43_SVD.UInt27;
   ...
   subtype INTSTAT_RESERVED_Field is LPC43_SVD.Bit;
   subtype INTSTAT_FUFMIS_Field is LPC43_SVD.Bit;
   subtype INTSTAT_LNBUMIS_Field is LPC43_SVD.Bit;
   subtype INTSTAT_VCOMPMIS_Field is LPC43_SVD.Bit;
   subtype INTSTAT_BERMIS_Field is LPC43_SVD.Bit;
   subtype INTSTAT_RESERVED_Field_1 is LPC43_SVD.UInt27;
   ...
   subtype INTCLR_RESERVED_Field is LPC43_SVD.Bit;
   subtype INTCLR_FUFIC_Field is LPC43_SVD.Bit;
   subtype INTCLR_LNBUIC_Field is LPC43_SVD.Bit;
   subtype INTCLR_VCOMPIC_Field is LPC43_SVD.Bit;
   subtype INTCLR_BERIC_Field is LPC43_SVD.Bit;
   subtype INTCLR_RESERVED_Field_1 is LPC43_SVD.UInt27;
   ...
   subtype PAL_R04_0_Field is LPC43_SVD.UInt5;
   subtype PAL_G04_0_Field is LPC43_SVD.UInt5;
   subtype PAL_B04_0_Field is LPC43_SVD.UInt5;
   subtype PAL_I0_Field is LPC43_SVD.Bit;
   subtype PAL_R14_0_Field is LPC43_SVD.UInt5;
   subtype PAL_G14_0_Field is LPC43_SVD.UInt5;
   subtype PAL_B14_0_Field is LPC43_SVD.UInt5;
   subtype PAL_I1_Field is LPC43_SVD.Bit;
   ...
   --  Cursor Image registers
   type CRSR_IMG_Registers is array (0 .. 255) of LPC43_SVD.UInt32
     with Volatile;

   subtype CRSR_CTRL_CrsrOn_Field is LPC43_SVD.Bit;
   subtype CRSR_CTRL_RESERVED_Field is LPC43_SVD.UInt3;
   subtype CRSR_CTRL_CRSRNUM1_0_Field is LPC43_SVD.UInt2;
   subtype CRSR_CTRL_RESERVED_Field_1 is LPC43_SVD.UInt26;
   ...
   subtype CRSR_CFG_CrsrSize_Field is LPC43_SVD.Bit;
   subtype CRSR_CFG_FRAMESYNC_Field is LPC43_SVD.Bit;
   subtype CRSR_CFG_RESERVED_Field is LPC43_SVD.UInt30;
   ...
   subtype CRSR_PAL_RED_Field is LPC43_SVD.Byte;
   subtype CRSR_PAL_GREEN_Field is LPC43_SVD.Byte;
   subtype CRSR_PAL_BLUE_Field is LPC43_SVD.Byte;
   subtype CRSR_PAL_RESERVED_Field is LPC43_SVD.Byte;
   ...
   subtype CRSR_XY_CRSRX_Field is LPC43_SVD.UInt10;
   subtype CRSR_XY_RESERVED_Field is LPC43_SVD.UInt6;
   subtype CRSR_XY_CRSRY_Field is LPC43_SVD.UInt10;
   ...
   subtype CRSR_CLIP_CRSRCLIPX_Field is LPC43_SVD.UInt6;
   subtype CRSR_CLIP_RESERVED_Field is LPC43_SVD.UInt2;
   subtype CRSR_CLIP_CRSRCLIPY_Field is LPC43_SVD.UInt6;
   subtype CRSR_CLIP_RESERVED_Field_1 is LPC43_SVD.UInt18;
   ...
   subtype CRSR_INTMSK_CRSRIM_Field is LPC43_SVD.Bit;
   subtype CRSR_INTMSK_RESERVED_Field is LPC43_SVD.UInt31;
   ...
   subtype CRSR_INTCLR_CRSRIC_Field is LPC43_SVD.Bit;
   subtype CRSR_INTCLR_RESERVED_Field is LPC43_SVD.UInt31;
   ...
   subtype CRSR_INTRAW_CRSRRIS_Field is LPC43_SVD.Bit;
   subtype CRSR_INTRAW_RESERVED_Field is LPC43_SVD.UInt31;
   ...
   subtype CRSR_INTSTAT_CRSRMIS_Field is LPC43_SVD.Bit;
   subtype CRSR_INTSTAT_RESERVED_Field is LPC43_SVD.UInt31;
   ...
   type LCD_Peripheral is record
      ...
      UPCURR       : aliased LPC43_SVD.UInt32;
      --  Lower Panel Current Address Value register
      LPCURR       : aliased LPC43_SVD.UInt32;
      --  256x16-bit Color Palette registers
