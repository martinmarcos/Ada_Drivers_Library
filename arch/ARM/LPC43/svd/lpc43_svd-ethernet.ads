...
package LPC43_SVD.ETHERNET is
   ...
   subtype MAC_CONFIG_RESERVED_Field is HAL.UInt2;
   subtype MAC_CONFIG_BL_Field is HAL.UInt2;
   subtype MAC_CONFIG_IFG_Field is HAL.UInt3;
   subtype MAC_CONFIG_RESERVED_Field_1 is HAL.UInt8;
   ...
   type MAC_CONFIG_Register is record
      ...
      WD         : Boolean := False;
      --  Reserved.
      RESERVED_4 : MAC_CONFIG_RESERVED_Field_1 := 16#0#;
   end record
   ...
   type MAC_FRAME_FILTER_RESERVED_Field_Array is array (1 .. 2) of Boolean
   ...
   subtype MAC_FRAME_FILTER_RESERVED_Field_1 is HAL.UInt20;
   ...
   subtype MAC_MII_ADDR_CR_Field is HAL.UInt4;
   subtype MAC_MII_ADDR_GR_Field is HAL.UInt5;
   subtype MAC_MII_ADDR_PA_Field is HAL.UInt5;
   subtype MAC_MII_ADDR_RESERVED_Field is HAL.UInt16;
   ...
   subtype MAC_MII_DATA_GD_Field is HAL.UInt16;
   subtype MAC_MII_DATA_RESERVED_Field is HAL.UInt16;
   ...
   subtype MAC_FLOW_CTRL_PLT_Field is HAL.UInt2;
   subtype MAC_FLOW_CTRL_RESERVED_Field is HAL.UInt8;
   subtype MAC_FLOW_CTRL_PT_Field is HAL.UInt16;
   ...
   type MAC_FLOW_CTRL_Register is record
      ...
      DZPQ       : Boolean := False;
      --  Reserved
      RESERVED_1 : MAC_FLOW_CTRL_RESERVED_Field := 16#0#;
   ...
   subtype MAC_VLAN_TAG_RESERVED_Field is HAL.UInt15;
   ...
   subtype MAC_DEBUG_FIFOSTAT0_Field is HAL.UInt2;
   subtype MAC_DEBUG_RXFIFOSTAT_Field is HAL.UInt2;
   subtype MAC_DEBUG_RXFIFOLVL_Field is HAL.UInt2;
   subtype MAC_DEBUG_RESERVED_Field is HAL.UInt6;
   subtype MAC_DEBUG_TXSTAT_Field is HAL.UInt2;
   subtype MAC_DEBUG_TXFIFOSTAT_Field is HAL.UInt2;
   ...
   type MAC_DEBUG_Register is record
      ...
      --  Read-only. Reserved
      RESERVED_2  : MAC_DEBUG_RESERVED_Field;
      ...
      TXFIFOFULL  : Boolean;
      --  Read-only. Reserved
      RESERVED_4  : MAC_DEBUG_RESERVED_Field;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype MAC_PMT_CTRL_STAT_RESERVED_Field is HAL.UInt2;
   subtype MAC_PMT_CTRL_STAT_RESERVED_Field_1 is HAL.UInt21;
   ...
   subtype MAC_INTR_RESERVED_Field is HAL.UInt3;
   subtype MAC_INTR_RESERVED_Field_1 is HAL.UInt5;
   subtype MAC_INTR_RESERVED_Field_2 is HAL.UInt21;
   ...
   type MAC_INTR_Register is record
      ...
      RESERVED_2 : Boolean;
      --  Read-only. Reserved
      RESERVED_3 : MAC_INTR_RESERVED_Field_2;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype MAC_INTR_MASK_RESERVED_Field is HAL.UInt3;
   subtype MAC_INTR_MASK_RESERVED_Field_1 is HAL.UInt5;
   ...
   subtype MAC_ADDR0_HIGH_A47_32_Field is HAL.UInt16;
   subtype MAC_ADDR0_HIGH_RESERVED_Field is HAL.UInt15;
   ...
   subtype MAC_TIMESTP_CTRL_RESERVED_Field is HAL.UInt2;
   subtype MAC_TIMESTP_CTRL_TSCLKTYPE_Field is HAL.UInt2;
   ...
   subtype SUBSECOND_INCR_SSINC_Field is HAL.UInt8;
   subtype SUBSECOND_INCR_RESERVED_Field is HAL.UInt24;
   ...
   subtype NANOSECONDS_TSSS_Field is HAL.UInt31;
   ...
   subtype NANOSECONDSUPDATE_TSSS_Field is HAL.UInt31;
   ...
   subtype TARGETNANOSECONDS_TSTR_Field is HAL.UInt31;
   ...
   subtype HIGHWORD_TSHWR_Field is HAL.UInt16;
   subtype HIGHWORD_RESERVED_Field is HAL.UInt16;
   ...
   subtype TIMESTAMPSTAT_RESERVED_Field is HAL.UInt30;
   ...
   subtype DMA_BUS_MODE_DSL_Field is HAL.UInt5;
   subtype DMA_BUS_MODE_PBL_Field is HAL.UInt6;
   subtype DMA_BUS_MODE_PR_Field is HAL.UInt2;
   subtype DMA_BUS_MODE_RPBL_Field is HAL.UInt6;
   subtype DMA_BUS_MODE_RESERVED_Field is HAL.UInt4;
   ...
   subtype DMA_STAT_RESERVED_Field is HAL.UInt2;
   subtype DMA_STAT_RS_Field is HAL.UInt3;
   subtype DMA_STAT_TS_Field is HAL.UInt3;

   --  DMA_STAT_EB array
   type DMA_STAT_EB_Field_Array is array (1 .. 3) of Boolean
   ...
   subtype DMA_STAT_RESERVED_Field_1 is HAL.UInt6;
   ...
   subtype DMA_OP_MODE_RTC_Field is HAL.UInt2;
   subtype DMA_OP_MODE_RESERVED_Field is HAL.UInt5;
   subtype DMA_OP_MODE_TTC_Field is HAL.UInt3;
   subtype DMA_OP_MODE_RESERVED_Field_1 is HAL.UInt3;
   subtype DMA_OP_MODE_RESERVED_Field_2 is HAL.UInt2;

   --  DMA_OP_MODE_RESERVED array
   type DMA_OP_MODE_RESERVED_Field_Array is array (1 .. 2) of Boolean
     with Component_Size => 1, Size => 2;

   --  Type definition for DMA_OP_MODE_RESERVED
   type DMA_OP_MODE_RESERVED_Field_3
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
   ...
   for DMA_OP_MODE_RESERVED_Field_3 use record
      Val at 0 range 0 .. 1;
      Arr at 0 range 0 .. 1;
   end record;
   ...
   type DMA_OP_MODE_Register is record
      ...
      FEF        : Boolean := False;
      --  Reserved
      RESERVED_2 : DMA_OP_MODE_RESERVED_Field := 16#0#;
      ...
      --  Reserved
      RESERVED_3 : DMA_OP_MODE_RESERVED_Field_1 := 16#0#;
      ...
      --  Reserved
      RESERVED_5 : DMA_OP_MODE_RESERVED_Field_2 := 16#0#;
      ...
      DFF        : Boolean := False;
      --  Reserved
      RESERVED_6 : DMA_OP_MODE_RESERVED_Field_3 :=
                    (As_Array => False, Val => 16#0#);
      --  Reserved
      RESERVED_7 : DMA_OP_MODE_RESERVED_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DMA_INT_EN_RESERVED_Field is HAL.UInt2;
   subtype DMA_INT_EN_RESERVED_Field_1 is HAL.UInt15;
   ...
   subtype DMA_MFRM_BUFOF_FMC_Field is HAL.UInt16;
   subtype DMA_MFRM_BUFOF_FMA_Field is HAL.UInt11;
   subtype DMA_MFRM_BUFOF_RESERVED_Field is HAL.UInt3;
   ...
   subtype DMA_REC_INT_WDT_RIWT_Field is HAL.UInt8;
   subtype DMA_REC_INT_WDT_RESERVED_Field is HAL.UInt24;
   ...
   type ETHERNET_Peripheral is record
      ...
      MAC_HASHTABLE_HIGH    : aliased HAL.UInt32;
      --  Hash table low register
      MAC_HASHTABLE_LOW     : aliased HAL.UInt32;
      --  MII address register
      ...
      DMA_TRANS_POLL_DEMAND : aliased HAL.UInt32;
      --  Receive poll demand register
      DMA_REC_POLL_DEMAND   : aliased HAL.UInt32;
      --  Receive descriptor list address register
      DMA_REC_DES_ADDR      : aliased HAL.UInt32;
      --  Transmit descriptor list address register
      DMA_TRANS_DES_ADDR    : aliased HAL.UInt32;
      --  Status register
      ...
      DMA_CURHOST_TRANS_DES : aliased HAL.UInt32;
      --  Current host receive descriptor register
      DMA_CURHOST_REC_DES   : aliased HAL.UInt32;
      --  Current host transmit buffer address register
      DMA_CURHOST_TRANS_BUF : aliased HAL.UInt32;
      --  Current host receive buffer address register
      DMA_CURHOST_REC_BUF   : aliased HAL.UInt32;
   end record
     with Volatile;
