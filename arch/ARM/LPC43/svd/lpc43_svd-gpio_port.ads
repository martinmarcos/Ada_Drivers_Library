...
package LPC43_SVD.GPIO_PORT is
   ...
   subtype B_PBYTE_Field is LPC43_SVD.Bit;
   ...
   subtype DIR_DIRP_Element is LPC43_SVD.Bit;
   ...
   subtype MASK_MASKP_Element is LPC43_SVD.Bit;
   ...
   subtype PIN_PORT_Element is LPC43_SVD.Bit;
   ...
   subtype MPIN_MPORTP_Element is LPC43_SVD.Bit;
   ...
   subtype SET_SETP_Element is LPC43_SVD.Bit;
   ...
   subtype CLR_CLRP_Element is LPC43_SVD.Bit;
   ...
   subtype NOT_NOTP_Element is LPC43_SVD.Bit;
