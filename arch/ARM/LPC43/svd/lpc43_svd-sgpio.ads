...
package LPC43_SVD.SGPIO is
   ...
   subtype OUT_MUX_CFG_RESERVED_Field is LPC43_SVD.UInt25;

   --  Pin multiplexer configuration registers.
   type OUT_MUX_CFG_Register is record
      --  Output control of output SGPIOn. All other values are reserved.
      P_OUT_CFG : OUT_MUX_CFG_ENUM := LPC43_SVD.SGPIO.Dout_Doutm1;
      --  Output enable source. All other values are reserved.
      P_OE_CFG  : OUT_MUX_CFG_ENUM_1 := LPC43_SVD.SGPIO.Gpio_Oe_State_Set_B;
      --  Reserved.
   ...
   subtype SGPIO_MUX_CFG_RESERVED_Field is LPC43_SVD.UInt18;

   --  SGPIO multiplexer configuration registers.
   type SGPIO_MUX_CFG_Register is record
      --  Select clock signal.
      EXT_CLK_ENABLE        : SGPIO_MUX_CFG_ENUM :=
                               LPC43_SVD.SGPIO.Internal_Clock_Signa;
      --  Select source clock pin.
      CLK_SOURCE_PIN_MODE   : SGPIO_MUX_CFG_ENUM_1 := LPC43_SVD.SGPIO.Sgpio8;
      --  Select clock source slice. Note that slices D, H, O and P do not
      --  support this mode.
      CLK_SOURCE_SLICE_MODE : SGPIO_MUX_CFG_ENUM_2 := LPC43_SVD.SGPIO.Slice_D;
      --  Select qualifier mode.
      QUALIFIER_MODE        : SGPIO_MUX_CFG_ENUM_3 := LPC43_SVD.SGPIO.Enable;
      --  Select qualifier pin.
      QUALIFIER_PIN_MODE    : SGPIO_MUX_CFG_ENUM_1 := LPC43_SVD.SGPIO.Sgpio8;
      --  Select qualifier slice.
      QUALIFIER_SLICE_MODE  : SGPIO_MUX_CFG_ENUM_4 := LPC43_SVD.SGPIO.Slice_A;
      --  Enable concatenation.
      CONCAT_ENABLE         : SGPIO_MUX_CFG_ENUM_5 :=
                               LPC43_SVD.SGPIO.External_Data_Pin;
      --  Select concatenation order
      CONCAT_ORDER          : SGPIO_MUX_CFG_ENUM_6 :=
                               LPC43_SVD.SGPIO.Self_Loop;
      --  Reserved
   ...
   subtype SLICE_MUX_CFG_RESERVED_Field is LPC43_SVD.UInt23;
   ...
   type SLICE_MUX_CFG_Register is record
      ...
      MATCH_MODE        : SLICE_MUX_CFG_ENUM :=
                           LPC43_SVD.SGPIO.Do_Not_Match_Data;
      --  Capture clock mode
      CLK_CAPTURE_MODE  : SLICE_MUX_CFG_ENUM_1 :=
                           LPC43_SVD.SGPIO.Use_Rising_Clock_Edg;
      ...
      CLKGEN_MODE       : SLICE_MUX_CFG_ENUM_2 :=
                           LPC43_SVD.SGPIO.Use_Clock_Internally;
      --  Invert output clock
      INV_OUT_CLK       : SLICE_MUX_CFG_ENUM_3 :=
                           LPC43_SVD.SGPIO.Normal_Clock;
      --  Condition for input bit match interrupt
      DATA_CAPTURE_MODE : SLICE_MUX_CFG_ENUM_4 :=
                           LPC43_SVD.SGPIO.Detect_Rising_Edge;
      --  Parallel mode
      PARALLEL_MODE     : SLICE_MUX_CFG_ENUM_5 :=
                           LPC43_SVD.SGPIO.Shift_1_Bit_Per_Cloc;
      --  Inversion qualifier
      INV_QUALIFIER     : SLICE_MUX_CFG_ENUM_6 :=
                           LPC43_SVD.SGPIO.Use_Normal_Qualifier;
      --  Reserved.
   ...
   type REG_Registers is array (0 .. 15) of LPC43_SVD.UInt32
     with Volatile;
   ...
   type REG_SS_Registers is array (0 .. 15) of LPC43_SVD.UInt32
     with Volatile;

   subtype PRESET_PRESET_Field is LPC43_SVD.UInt12;
   subtype PRESET_RESERVED_Field is LPC43_SVD.UInt20;
   ...
   subtype COUNT_COUNT_Field is LPC43_SVD.UInt12;
   subtype COUNT_RESERVED_Field is LPC43_SVD.UInt20;
   ...
   subtype POS_POS_Field is LPC43_SVD.Byte;
   subtype POS_POS_RESET_Field is LPC43_SVD.Byte;
   subtype POS_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype GPIO_INREG_GPIO_INi_Field is LPC43_SVD.UInt16;
   subtype GPIO_INREG_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype GPIO_OUTREG_GPIO_OUT_Field is LPC43_SVD.UInt16;
   subtype GPIO_OUTREG_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype GPIO_OENREG_GPIO_OE_Field is LPC43_SVD.UInt16;
   subtype GPIO_OENREG_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype CTRL_ENABLE_CTRL_EN_Field is LPC43_SVD.UInt16;
   subtype CTRL_ENABLE_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype CTRL_DISABLE_CTRL_DIS_Field is LPC43_SVD.UInt16;
   subtype CTRL_DISABLE_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype CLR_EN_0_CLR_SCI_Field is LPC43_SVD.UInt16;
   subtype CLR_EN_0_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype SET_EN_0_SET_SCI_Field is LPC43_SVD.UInt16;
   subtype SET_EN_0_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype ENABLE_0_ENABLE_SCI_Field is LPC43_SVD.UInt16;
   subtype ENABLE_0_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype STATUS_0_STATUS_SCI_Field is LPC43_SVD.UInt16;
   subtype STATUS_0_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype CLR_STATUS_0_CLR_STATUS_SCI_Field is LPC43_SVD.UInt16;
   subtype CLR_STATUS_0_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype SET_STATUS_0_SET_STATUS_SCI_Field is LPC43_SVD.UInt16;
   subtype SET_STATUS_0_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype CLR_EN_1_CLR_EN_CCI_Field is LPC43_SVD.UInt16;
   subtype CLR_EN_1_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype SET_EN_1_SET_EN_CCI_Field is LPC43_SVD.UInt16;
   subtype SET_EN_1_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype ENABLE_1_ENABLE_CCI_Field is LPC43_SVD.UInt16;
   subtype ENABLE_1_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype STATUS_1_STATUS_CCI_Field is LPC43_SVD.UInt16;
   subtype STATUS_1_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype CLR_STATUS_1_CLR_STATUS_CCI_Field is LPC43_SVD.UInt16;
   subtype CLR_STATUS_1_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype SET_STATUS_1_SET_STATUS_CCI_Field is LPC43_SVD.UInt16;
   subtype SET_STATUS_1_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype CLR_EN_2_CLR_EN2_PMI_Field is LPC43_SVD.UInt16;
   subtype CLR_EN_2_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype SET_EN_2_SET_EN_PMI_Field is LPC43_SVD.UInt16;
   subtype SET_EN_2_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype ENABLE_2_ENABLE_PMI_Field is LPC43_SVD.UInt16;
   subtype ENABLE_2_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype STATUS_2_STATUS_PMI_Field is LPC43_SVD.UInt16;
   subtype STATUS_2_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype CLR_STATUS_2_CLR_STATUS_PMI_Field is LPC43_SVD.UInt16;
   subtype CLR_STATUS_2_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype SET_STATUS_2_SET_STATUS_PMI_Field is LPC43_SVD.UInt16;
   subtype SET_STATUS_2_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype CLR_EN_3_CLR_EN_INPI_Field is LPC43_SVD.UInt16;
   subtype CLR_EN_3_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype SET_EN_3_SET_EN_INPI_Field is LPC43_SVD.UInt16;
   subtype SET_EN_3_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype ENABLE_3_ENABLE3_INPI_Field is LPC43_SVD.UInt16;
   subtype ENABLE_3_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype STATUS_3_STATUS_INPI_Field is LPC43_SVD.UInt16;
   subtype STATUS_3_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype CLR_STATUS_3_CLR_STATUS_INPI_Field is LPC43_SVD.UInt16;
   subtype CLR_STATUS_3_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype SET_STATUS_3_SET_STATUS_INPI_Field is LPC43_SVD.UInt16;
   subtype SET_STATUS_3_RESERVED_Field is LPC43_SVD.UInt16;
