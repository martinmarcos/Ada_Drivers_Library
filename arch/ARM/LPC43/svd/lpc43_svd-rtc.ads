...
package LPC43_SVD.RTC is
   ...
   subtype ILR_RTCCIF_Field is LPC43_SVD.Bit;
   subtype ILR_RTCALF_Field is LPC43_SVD.Bit;
   subtype ILR_RESERVED_Field is LPC43_SVD.UInt30;
   ...
   subtype CCR_RESERVED_Field is LPC43_SVD.UInt2;
   ...
   subtype CCR_RESERVED_Field_1 is LPC43_SVD.UInt27;

   --  Clock Control Register
   type CCR_Register is record
      --  Clock Enable.
      CLKEN      : CCR_ENUM := LPC43_SVD.RTC.Disabled;
      --  CTC Reset.
      CTCRST     : CCR_ENUM_1 := LPC43_SVD.RTC.No_Effect;
      --  Internal test mode controls. These bits must be 0 for normal RTC
      --  operation.
      RESERVED   : CCR_RESERVED_Field := 16#0#;
      --  Calibration counter enable.
      CCALEN     : CCR_ENUM_2 := LPC43_SVD.RTC.Enabled;
   ...
   subtype CIIR_IMSEC_Field is LPC43_SVD.Bit;
   subtype CIIR_IMMIN_Field is LPC43_SVD.Bit;
   subtype CIIR_IMHOUR_Field is LPC43_SVD.Bit;
   subtype CIIR_IMDOM_Field is LPC43_SVD.Bit;
   subtype CIIR_IMDOW_Field is LPC43_SVD.Bit;
   subtype CIIR_IMDOY_Field is LPC43_SVD.Bit;
   subtype CIIR_IMMON_Field is LPC43_SVD.Bit;
   subtype CIIR_IMYEAR_Field is LPC43_SVD.Bit;
   subtype CIIR_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype AMR_AMRSEC_Field is LPC43_SVD.Bit;
   subtype AMR_AMRMIN_Field is LPC43_SVD.Bit;
   subtype AMR_AMRHOUR_Field is LPC43_SVD.Bit;
   subtype AMR_AMRDOM_Field is LPC43_SVD.Bit;
   subtype AMR_AMRDOW_Field is LPC43_SVD.Bit;
   subtype AMR_AMRDOY_Field is LPC43_SVD.Bit;
   subtype AMR_AMRMON_Field is LPC43_SVD.Bit;
   subtype AMR_AMRYEAR_Field is LPC43_SVD.Bit;
   subtype AMR_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype CTIME0_SECONDS_Field is LPC43_SVD.UInt6;
   subtype CTIME0_RESERVED_Field is LPC43_SVD.UInt2;
   subtype CTIME0_MINUTES_Field is LPC43_SVD.UInt6;
   subtype CTIME0_HOURS_Field is LPC43_SVD.UInt5;
   subtype CTIME0_RESERVED_Field_1 is LPC43_SVD.UInt3;
   subtype CTIME0_DOW_Field is LPC43_SVD.UInt3;
   subtype CTIME0_RESERVED_Field_2 is LPC43_SVD.UInt5;
   ...
   subtype CTIME1_DOM_Field is LPC43_SVD.UInt5;
   subtype CTIME1_RESERVED_Field is LPC43_SVD.UInt3;
   subtype CTIME1_MONTH_Field is LPC43_SVD.UInt4;
   subtype CTIME1_RESERVED_Field_1 is LPC43_SVD.UInt4;
   subtype CTIME1_YEAR_Field is LPC43_SVD.UInt12;
   ...
   subtype CTIME2_DOY_Field is LPC43_SVD.UInt12;
   subtype CTIME2_RESERVED_Field is LPC43_SVD.UInt20;
   ...
   subtype SEC_SECONDS_Field is LPC43_SVD.UInt6;
   subtype SEC_RESERVED_Field is LPC43_SVD.UInt26;
   ...
   subtype MIN_MINUTES_Field is LPC43_SVD.UInt6;
   subtype MIN_RESERVED_Field is LPC43_SVD.UInt26;
   ...
   subtype HRS_HOURS_Field is LPC43_SVD.UInt5;
   subtype HRS_RESERVED_Field is LPC43_SVD.UInt27;
   ...
   subtype DOM_DOM_Field is LPC43_SVD.UInt5;
   subtype DOM_RESERVED_Field is LPC43_SVD.UInt27;
   ...
   subtype DOW_DOW_Field is LPC43_SVD.UInt3;
   subtype DOW_RESERVED_Field is LPC43_SVD.UInt29;
   ...
   subtype DOY_DOY_Field is LPC43_SVD.UInt9;
   subtype DOY_RESERVED_Field is LPC43_SVD.UInt23;
   ...
   subtype MONTH_MONTH_Field is LPC43_SVD.UInt4;
   subtype MONTH_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype YEAR_YEAR_Field is LPC43_SVD.UInt12;
   subtype YEAR_RESERVED_Field is LPC43_SVD.UInt20;
   ...
   subtype CALIBRATION_CALVAL_Field is LPC43_SVD.UInt17;
   ...
   type CALIBRATION_Register is record
      ...
      --  Calibration direction
      CALDIR         : CALIBRATION_ENUM := LPC43_SVD.RTC.Forward_Calibration;
      --  unspecified
      Reserved_18_31 : LPC43_SVD.UInt14 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype ASEC_SECONDS_Field is LPC43_SVD.UInt6;
   subtype ASEC_RESERVED_Field is LPC43_SVD.UInt26;
   ...
   subtype AMIN_MINUTES_Field is LPC43_SVD.UInt6;
   subtype AMIN_RESERVED_Field is LPC43_SVD.UInt26;
   ...
   subtype AHRS_HOURS_Field is LPC43_SVD.UInt5;
   subtype AHRS_RESERVED_Field is LPC43_SVD.UInt27;
   ...
   subtype ADOM_DOM_Field is LPC43_SVD.UInt5;
   subtype ADOM_RESERVED_Field is LPC43_SVD.UInt27;
   ...
   subtype ADOW_DOW_Field is LPC43_SVD.UInt3;
   subtype ADOW_RESERVED_Field is LPC43_SVD.UInt29;
   ...
   subtype ADOY_DOY_Field is LPC43_SVD.UInt9;
   subtype ADOY_RESERVED_Field is LPC43_SVD.UInt23;
   ...
   subtype AMON_MONTH_Field is LPC43_SVD.UInt4;
   subtype AMON_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype AYRS_YEAR_Field is LPC43_SVD.UInt12;
   subtype AYRS_RESERVED_Field is LPC43_SVD.UInt20;
   ...
   subtype ERSTATUS_RESERVED_Field is LPC43_SVD.UInt27;
   ...
   subtype ERCONTRO_RESERVED_Field is LPC43_SVD.UInt6;
   ...
   type ERCONTRO_Register is record
      --  Interrupt and wake-up enable for channel 0.
      INTWAKE_EN0  : ERCONTRO_ENUM := LPC43_SVD.RTC.Disabled;
      --  Enables automatically clearing the RTC general purpose registers when
      --  an event occurs on channel 0.
      GPCLEAR_EN0  : ERCONTRO_ENUM := LPC43_SVD.RTC.Disabled;
      --  Selects the polarity of an event on input pin WAKEUP0.
      POL0         : ERCONTRO_ENUM_1 := LPC43_SVD.RTC.Negative;
      ...
      ERMODE       : ERCONTRO_ENUM_2 := LPC43_SVD.RTC.Disable_Event_Monito;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype ERCOUNTERS_COUNTER0_Field is LPC43_SVD.UInt3;
   subtype ERCOUNTERS_RESERVED_Field is LPC43_SVD.UInt5;
   subtype ERCOUNTERS_COUNTER1_Field is LPC43_SVD.UInt3;
   subtype ERCOUNTERS_COUNTER2_Field is LPC43_SVD.UInt3;
   subtype ERCOUNTERS_RESERVED_Field_1 is LPC43_SVD.UInt13;
   ...
   subtype ERFIRSTSTAMP_SEC_Field is LPC43_SVD.UInt6;
   subtype ERFIRSTSTAMP_MIN_Field is LPC43_SVD.UInt6;
   subtype ERFIRSTSTAMP_HOUR_Field is LPC43_SVD.UInt5;
   subtype ERFIRSTSTAMP_DOY_Field is LPC43_SVD.UInt9;
   subtype ERFIRSTSTAMP_RESERVED_Field is LPC43_SVD.UInt6;
   ...
   subtype ERLASTSTAMP_SEC_Field is LPC43_SVD.UInt6;
   subtype ERLASTSTAMP_MIN_Field is LPC43_SVD.UInt6;
   subtype ERLASTSTAMP_HOUR_Field is LPC43_SVD.UInt5;
   subtype ERLASTSTAMP_DOY_Field is LPC43_SVD.UInt9;
   subtype ERLASTSTAMP_RESERVED_Field is LPC43_SVD.UInt6;
