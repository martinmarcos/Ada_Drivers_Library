...
package LPC43_SVD.SSP is
   ...
   subtype CR0_SCR_Field is LPC43_SVD.Byte;
   subtype CR0_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   type CR0_Register is record
      ...
      --  Frame Format.
      FRF      : CR0_ENUM_1 := LPC43_SVD.SSP.Spi;
      --  Clock Out Polarity. This bit is only used in SPI mode.
      CPOL     : CR0_ENUM_2 := LPC43_SVD.SSP.Bus_Low;
      --  Clock Out Phase. This bit is only used in SPI mode.
      CPHA     : CR0_ENUM_3 := LPC43_SVD.SSP.First_Clock;
   ...
   subtype CR1_SOD_Field is LPC43_SVD.Bit;
   subtype CR1_RESERVED_Field is LPC43_SVD.UInt28;

   --  Control Register 1. Selects master/slave and other modes.
   type CR1_Register is record
      --  Loop Back Mode.
      LBM      : CR1_ENUM := LPC43_SVD.SSP.Normal;
      --  SSP Enable.
      SSE      : CR1_ENUM_1 := LPC43_SVD.SSP.Disabled;
      --  Master/Slave Mode.This bit can only be written when the SSE bit is 0.
      MS       : CR1_ENUM_2 := LPC43_SVD.SSP.Master;
   ...
   subtype DR_DATA_Field is LPC43_SVD.UInt16;
   subtype DR_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype SR_TFE_Field is LPC43_SVD.Bit;
   subtype SR_TNF_Field is LPC43_SVD.Bit;
   subtype SR_RNE_Field is LPC43_SVD.Bit;
   subtype SR_RFF_Field is LPC43_SVD.Bit;
   subtype SR_BSY_Field is LPC43_SVD.Bit;
   subtype SR_RESERVED_Field is LPC43_SVD.UInt27;
   ...
   subtype CPSR_CPSDVSR_Field is LPC43_SVD.Byte;
   subtype CPSR_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype IMSC_RORIM_Field is LPC43_SVD.Bit;
   subtype IMSC_RTIM_Field is LPC43_SVD.Bit;
   subtype IMSC_RXIM_Field is LPC43_SVD.Bit;
   subtype IMSC_TXIM_Field is LPC43_SVD.Bit;
   subtype IMSC_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype RIS_RORRIS_Field is LPC43_SVD.Bit;
   subtype RIS_RTRIS_Field is LPC43_SVD.Bit;
   subtype RIS_RXRIS_Field is LPC43_SVD.Bit;
   subtype RIS_TXRIS_Field is LPC43_SVD.Bit;
   subtype RIS_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype MIS_RORMIS_Field is LPC43_SVD.Bit;
   subtype MIS_RTMIS_Field is LPC43_SVD.Bit;
   subtype MIS_RXMIS_Field is LPC43_SVD.Bit;
   subtype MIS_TXMIS_Field is LPC43_SVD.Bit;
   subtype MIS_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype ICR_RORIC_Field is LPC43_SVD.Bit;
   subtype ICR_RTIC_Field is LPC43_SVD.Bit;
   subtype ICR_RESERVED_Field is LPC43_SVD.UInt30;
   ...
   subtype DMACR_RXDMAE_Field is LPC43_SVD.Bit;
   subtype DMACR_TXDMAE_Field is LPC43_SVD.Bit;
   subtype DMACR_RESERVED_Field is LPC43_SVD.UInt30;
