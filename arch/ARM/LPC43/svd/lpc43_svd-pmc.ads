...
package LPC43_SVD.PMC is
   ...
   subtype PD0_SLEEP0_HW_ENA_ENA_EVENT_Element is LPC43_SVD.Bit;
   ...
   subtype PD0_SLEEP0_HW_ENA_RESERVED_Field is LPC43_SVD.UInt30;
   ...
   type PMC_Peripheral is record
      ...
      PD0_SLEEP0_MODE   : aliased LPC43_SVD.UInt32;
   end record
     with Volatile;
