...
package LPC43_SVD.I2S is
   ...
   subtype DAO_MONO_Field is LPC43_SVD.Bit;
   subtype DAO_STOP_Field is LPC43_SVD.Bit;
   subtype DAO_RESET_Field is LPC43_SVD.Bit;
   subtype DAO_WS_SEL_Field is LPC43_SVD.Bit;
   subtype DAO_WS_HALFPERIOD_Field is LPC43_SVD.UInt9;
   subtype DAO_MUTE_Field is LPC43_SVD.Bit;
   subtype DAO_RESERVED_Field is LPC43_SVD.UInt16;

   --  I2S Digital Audio Output Register. Contains control bits for the I2S
   --  transmit channel.
   type DAO_Register is record
      --  Selects the number of bytes in data as follows:
      WORDWIDTH     : DAO_ENUM := LPC43_SVD.I2S.DAO_ENUM_16_Bit_Data;
   ...
   subtype DAI_MONO_Field is LPC43_SVD.Bit;
   subtype DAI_STOP_Field is LPC43_SVD.Bit;
   subtype DAI_RESET_Field is LPC43_SVD.Bit;
   subtype DAI_WS_SEL_Field is LPC43_SVD.Bit;
   subtype DAI_WS_HALFPERIOD_Field is LPC43_SVD.UInt9;
   subtype DAI_RESERVED_Field is LPC43_SVD.UInt17;

   --  I2S Digital Audio Input Register. Contains control bits for the I2S
   --  receive channel.
   type DAI_Register is record
      --  Selects the number of bytes in data as follows:
      WORDWIDTH     : DAI_ENUM := LPC43_SVD.I2S.DAI_ENUM_16_Bit_Data;
      --  When 1, data is of monaural format. When 0, the data is in stereo
      --  format.
   ...
   subtype STATE_IRQ_Field is LPC43_SVD.Bit;
   --  STATE_DMAREQ array element
   subtype STATE_DMAREQ_Element is LPC43_SVD.Bit;
   ...
   subtype STATE_RESERVED_Field is LPC43_SVD.UInt5;
   subtype STATE_RX_LEVEL_Field is LPC43_SVD.UInt4;
   subtype STATE_RESERVED_Field_1 is LPC43_SVD.UInt4;
   subtype STATE_TX_LEVEL_Field is LPC43_SVD.UInt4;
   subtype STATE_RESERVED_Field_2 is LPC43_SVD.UInt12;
   ...
   subtype DMA1_RX_DMA1_ENABLE_Field is LPC43_SVD.Bit;
   subtype DMA1_TX_DMA1_ENABLE_Field is LPC43_SVD.Bit;
   subtype DMA1_RESERVED_Field is LPC43_SVD.UInt6;
   subtype DMA1_RX_DEPTH_DMA1_Field is LPC43_SVD.UInt4;
   subtype DMA1_RESERVED_Field_1 is LPC43_SVD.UInt4;
   subtype DMA1_TX_DEPTH_DMA1_Field is LPC43_SVD.UInt4;
   subtype DMA1_RESERVED_Field_2 is LPC43_SVD.UInt12;
   ...
   subtype DMA2_RX_DMA2_ENABLE_Field is LPC43_SVD.Bit;
   subtype DMA2_TX_DMA2_ENABLE_Field is LPC43_SVD.Bit;
   subtype DMA2_RESERVED_Field is LPC43_SVD.UInt6;
   subtype DMA2_RX_DEPTH_DMA2_Field is LPC43_SVD.UInt4;
   subtype DMA2_RESERVED_Field_1 is LPC43_SVD.UInt4;
   subtype DMA2_TX_DEPTH_DMA2_Field is LPC43_SVD.UInt4;
   subtype DMA2_RESERVED_Field_2 is LPC43_SVD.UInt12;
   ...
   subtype IRQ_RX_IRQ_ENABLE_Field is LPC43_SVD.Bit;
   subtype IRQ_TX_IRQ_ENABLE_Field is LPC43_SVD.Bit;
   subtype IRQ_RESERVED_Field is LPC43_SVD.UInt6;
   subtype IRQ_RX_DEPTH_IRQ_Field is LPC43_SVD.UInt4;
   subtype IRQ_RESERVED_Field_1 is LPC43_SVD.UInt4;
   subtype IRQ_TX_DEPTH_IRQ_Field is LPC43_SVD.UInt4;
   subtype IRQ_RESERVED_Field_2 is LPC43_SVD.UInt12;
   ...
   subtype TXRATE_Y_DIVIDER_Field is LPC43_SVD.Byte;
   subtype TXRATE_X_DIVIDER_Field is LPC43_SVD.Byte;
   subtype TXRATE_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype RXRATE_Y_DIVIDER_Field is LPC43_SVD.Byte;
   subtype RXRATE_X_DIVIDER_Field is LPC43_SVD.Byte;
   subtype RXRATE_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype TXBITRATE_TX_BITRATE_Field is LPC43_SVD.UInt6;
   subtype TXBITRATE_RESERVED_Field is LPC43_SVD.UInt26;
   ...
   subtype RXBITRATE_RX_BITRATE_Field is LPC43_SVD.UInt6;
   subtype RXBITRATE_RESERVED_Field is LPC43_SVD.UInt26;
   ...
   subtype TXMODE_TX4PIN_Field is LPC43_SVD.Bit;
   subtype TXMODE_TXMCENA_Field is LPC43_SVD.Bit;
   subtype TXMODE_RESERVED_Field is LPC43_SVD.UInt28;

   --  I2S Transmit mode control.
   type TXMODE_Register is record
      --  Clock source selection for the transmit bit clock divider.
      TXCLKSEL : TXMODE_ENUM := LPC43_SVD.I2S.Select_The_Tx_Fracti;
   ...
   subtype RXMODE_RX4PIN_Field is LPC43_SVD.Bit;
   subtype RXMODE_RXMCENA_Field is LPC43_SVD.Bit;
   subtype RXMODE_RESERVED_Field is LPC43_SVD.UInt28;

   --  I2S Receive mode control.
   type RXMODE_Register is record
      --  Clock source selection for the receive bit clock divider.
      RXCLKSEL : RXMODE_ENUM := LPC43_SVD.I2S.Select_The_Rx_Fracti;
