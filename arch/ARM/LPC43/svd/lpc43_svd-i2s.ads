...
package LPC43_SVD.I2S is
   ...
   subtype DAO_WS_HALFPERIOD_Field is HAL.UInt9;
   subtype DAO_RESERVED_Field is HAL.UInt16;
   ...
   subtype DAI_WS_HALFPERIOD_Field is HAL.UInt9;
   subtype DAI_RESERVED_Field is HAL.UInt17;
   ...
   --  STATE_DMAREQ array
   type STATE_DMAREQ_Field_Array is array (1 .. 2) of Boolean
   ...
   subtype STATE_RESERVED_Field is HAL.UInt5;
   subtype STATE_RX_LEVEL_Field is HAL.UInt4;
   subtype STATE_RESERVED_Field_1 is HAL.UInt4;
   subtype STATE_TX_LEVEL_Field is HAL.UInt4;
   subtype STATE_RESERVED_Field_2 is HAL.UInt12;
   ...
   subtype DMA1_RESERVED_Field is HAL.UInt6;
   subtype DMA1_RX_DEPTH_DMA1_Field is HAL.UInt4;
   subtype DMA1_RESERVED_Field_1 is HAL.UInt4;
   subtype DMA1_TX_DEPTH_DMA1_Field is HAL.UInt4;
   subtype DMA1_RESERVED_Field_2 is HAL.UInt12;
   ...
   type DMA1_Register is record
      ...
      RX_DMA1_ENABLE : Boolean := False;
      --  When 1, enables DMA1 for I2S transmit.
      TX_DMA1_ENABLE : Boolean := False;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype DMA2_RESERVED_Field is HAL.UInt6;
   subtype DMA2_RX_DEPTH_DMA2_Field is HAL.UInt4;
   subtype DMA2_RESERVED_Field_1 is HAL.UInt4;
   subtype DMA2_TX_DEPTH_DMA2_Field is HAL.UInt4;
   subtype DMA2_RESERVED_Field_2 is HAL.UInt12;

   --  I2S DMA Configuration Register 2. Contains control information for DMA
   --  request 2.
   type DMA2_Register is record
      --  When 1, enables DMA1 for I2S receive.
      RX_DMA2_ENABLE : Boolean := False;
      --  When 1, enables DMA1 for I2S transmit.
      TX_DMA2_ENABLE : Boolean := False;
      --  Reserved.
   ...
   subtype IRQ_RESERVED_Field is HAL.UInt6;
   subtype IRQ_RX_DEPTH_IRQ_Field is HAL.UInt4;
   subtype IRQ_RESERVED_Field_1 is HAL.UInt4;
   subtype IRQ_TX_DEPTH_IRQ_Field is HAL.UInt4;
   subtype IRQ_RESERVED_Field_2 is HAL.UInt12;
   ...
   type IRQ_Register is record
      ...
      RX_IRQ_ENABLE : Boolean := False;
      --  When 1, enables I2S transmit interrupt.
      TX_IRQ_ENABLE : Boolean := False;
      --  Reserved.
   ...
   subtype TXRATE_Y_DIVIDER_Field is HAL.UInt8;
   subtype TXRATE_X_DIVIDER_Field is HAL.UInt8;
   subtype TXRATE_RESERVED_Field is HAL.UInt16;
   ...
   subtype RXRATE_Y_DIVIDER_Field is HAL.UInt8;
   subtype RXRATE_X_DIVIDER_Field is HAL.UInt8;
   subtype RXRATE_RESERVED_Field is HAL.UInt16;
   ...
   subtype TXBITRATE_TX_BITRATE_Field is HAL.UInt6;
   subtype TXBITRATE_RESERVED_Field is HAL.UInt26;
   ...
   subtype RXBITRATE_RX_BITRATE_Field is HAL.UInt6;
   subtype RXBITRATE_RESERVED_Field is HAL.UInt26;
   ...
   subtype TXMODE_RESERVED_Field is HAL.UInt28;
   ...
   subtype RXMODE_RESERVED_Field is HAL.UInt28;
