...
package LPC43_SVD.SDMMC is
   ...
   subtype CTRL_RESERVED_Field is HAL.UInt4;
   ...
   subtype CTRL_RESERVED_Field_1 is HAL.UInt5;
   ...
   subtype CTRL_RESERVED_Field_2 is HAL.UInt6;
   ...
   subtype PWREN_RESERVED_Field is HAL.UInt31;
   ...
   subtype CLKDIV_CLK_DIVIDER_Element is HAL.UInt8;
   ...
   subtype CLKSRC_CLK_SOURCE_Field is HAL.UInt2;
   ...
   subtype CLKENA_RESERVED_Field is HAL.UInt15;
   ...
   subtype CTYPE_RESERVED_Field is HAL.UInt15;
   ...
   subtype BLKSIZ_RESERVED_Field is HAL.UInt16;
   ...
   subtype INTMASK_RESERVED_Field is HAL.UInt15;
   ...
   subtype CMD_RESERVED_Field is HAL.UInt5;
   ...
   subtype CMD_RESERVED_Field_1 is HAL.UInt2;
   ...
   subtype MINTSTS_RESERVED_Field is HAL.UInt15;
   ...
   subtype RINTSTS_RESERVED_Field is HAL.UInt15;
   ...
   subtype FIFOTH_RESERVED_Field is HAL.UInt4;
   ...
   subtype CDETECT_RESERVED_Field is HAL.UInt31;
   ...
   subtype WRTPRT_RESERVED_Field is HAL.UInt31;
   ...
   subtype DEBNCE_RESERVED_Field is HAL.UInt8;
   ...
   subtype RST_N_RESERVED_Field is HAL.UInt31;
   ...
   subtype BMOD_RESERVED_Field is HAL.UInt21;
   ...
   subtype IDSTS_RESERVED_Field is HAL.UInt2;
   subtype IDSTS_EB_Field is HAL.UInt3;
   subtype IDSTS_FSM_Field is HAL.UInt4;
   subtype IDSTS_RESERVED_Field_1 is HAL.UInt15;
   ...
   type IDSTS_Register is record
      ...
      CES        : Boolean := False;
      --  Reserved
      RESERVED_1 : IDSTS_RESERVED_Field := 16#0#;
      ...
      --  Reserved
      RESERVED_2 : IDSTS_RESERVED_Field_1 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype IDINTEN_RESERVED_Field is HAL.UInt2;
   subtype IDINTEN_RESERVED_Field_1 is HAL.UInt22;
   ...
   type IDINTEN_Register is record
      ...
      CES        : Boolean := False;
      --  Reserved
      RESERVED_1 : IDINTEN_RESERVED_Field := 16#0#;
      ...
      AIS        : Boolean := False;
      --  Reserved
      RESERVED_2 : IDINTEN_RESERVED_Field_1 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
