...
package LPC43_SVD.SDMMC is
   ...
   subtype CTRL_RESERVED_Field is LPC43_SVD.Bit;
   ...
   subtype CTRL_RESERVED_Field_1 is LPC43_SVD.UInt4;
   --  CTRL_CARD_VOLTAGE_A array element
   subtype CTRL_CARD_VOLTAGE_A_Element is LPC43_SVD.Bit;
   ...
   subtype CTRL_RESERVED_Field_2 is LPC43_SVD.UInt5;
   ...
   subtype CTRL_RESERVED_Field_3 is LPC43_SVD.UInt6;
   ...
   type CTRL_Register is record
      ...
      --  register - start_cmd bit of Command register Does not affect any
      --  registers or DMA interface, or FIFO. or host interrupts.
      CONTROLLER_RESET              : CTRL_ENUM := LPC43_SVD.SDMMC.No_Change;
      ...
      SEND_AUTO_STOP                : CTRL_ENUM_6 :=
                                       LPC43_SVD.SDMMC.Clear_This_Bit_If_Th;
      --  CEATA device interrupt status. Software should appropriately write to
      ...
      --  this bit.
      CEATA_DEVICE_INTERRUPT_STATUS : CTRL_ENUM_7 := LPC43_SVD.SDMMC.Disabled;
      --  Reserved
      ...
      --  SD/MMC DMA use.
      USE_INTERNAL_DMAC             : CTRL_ENUM_8 := LPC43_SVD.SDMMC.Host;
      --  Reserved
   ...
   subtype PWREN_POWER_ENABLE_Field is LPC43_SVD.Bit;
   subtype PWREN_RESERVED_Field is LPC43_SVD.UInt31;
   ...
   subtype CLKDIV_CLK_DIVIDER_Element is LPC43_SVD.Byte;
   ...
   subtype CLKSRC_CLK_SOURCE_Field is LPC43_SVD.UInt2;
   ...
   type CLKSRC_Register is record
      ...
      --  unspecified
      Reserved_2_31 : LPC43_SVD.UInt30 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CLKENA_CCLK_ENABLE_Field is LPC43_SVD.Bit;
   subtype CLKENA_RESERVED_Field is LPC43_SVD.UInt15;
   subtype CLKENA_CCLK_LOW_POWER_Field is LPC43_SVD.Bit;
   ...
   subtype TMOUT_RESPONSE_TIMEOUT_Field is LPC43_SVD.Byte;
   subtype TMOUT_DATA_TIMEOUT_Field is LPC43_SVD.UInt24;
   ...
   subtype CTYPE_CARD_WIDTH0_Field is LPC43_SVD.Bit;
   subtype CTYPE_RESERVED_Field is LPC43_SVD.UInt15;
   subtype CTYPE_CARD_WIDTH1_Field is LPC43_SVD.Bit;
   ...
   subtype BLKSIZ_BLOCK_SIZE_Field is LPC43_SVD.UInt16;
   subtype BLKSIZ_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype INTMASK_CDET_Field is LPC43_SVD.Bit;
   subtype INTMASK_RE_Field is LPC43_SVD.Bit;
   subtype INTMASK_CDONE_Field is LPC43_SVD.Bit;
   subtype INTMASK_DTO_Field is LPC43_SVD.Bit;
   subtype INTMASK_TXDR_Field is LPC43_SVD.Bit;
   subtype INTMASK_RXDR_Field is LPC43_SVD.Bit;
   subtype INTMASK_RCRC_Field is LPC43_SVD.Bit;
   subtype INTMASK_DCRC_Field is LPC43_SVD.Bit;
   subtype INTMASK_RTO_Field is LPC43_SVD.Bit;
   subtype INTMASK_DRTO_Field is LPC43_SVD.Bit;
   subtype INTMASK_HTO_Field is LPC43_SVD.Bit;
   subtype INTMASK_FRUN_Field is LPC43_SVD.Bit;
   subtype INTMASK_HLE_Field is LPC43_SVD.Bit;
   subtype INTMASK_SBE_Field is LPC43_SVD.Bit;
   subtype INTMASK_ACD_Field is LPC43_SVD.Bit;
   subtype INTMASK_EBE_Field is LPC43_SVD.Bit;
   subtype INTMASK_SDIO_INT_MASK_Field is LPC43_SVD.Bit;
   subtype INTMASK_RESERVED_Field is LPC43_SVD.UInt15;
   ...
   subtype CMD_CMD_INDEX_Field is LPC43_SVD.UInt6;
   ...
   subtype CMD_RESERVED_Field is LPC43_SVD.UInt5;
   ...
   subtype CMD_ENABLE_BOOT_Field is LPC43_SVD.Bit;
   subtype CMD_EXPECT_BOOT_ACK_Field is LPC43_SVD.Bit;
   subtype CMD_DISABLE_BOOT_Field is LPC43_SVD.Bit;
   ...
   subtype CMD_RESERVED_Field_1 is LPC43_SVD.UInt2;
   subtype CMD_START_CMD_Field is LPC43_SVD.Bit;
   ...
   type CMD_Register is record
      ...
      --  Response expect
      RESPONSE_EXPECT             : CMD_ENUM := LPC43_SVD.SDMMC.None;
      --  Response length
      RESPONSE_LENGTH             : CMD_ENUM_1 := LPC43_SVD.SDMMC.Short;
      --  Check response crc. Some of command responses do not return valid CRC
      ...
      CHECK_RESPONSE_CRC          : CMD_ENUM_2 :=
                                     LPC43_SVD.SDMMC.Do_Not_Check_Respons;
      --  Data expected
      DATA_EXPECTED               : CMD_ENUM_3 := LPC43_SVD.SDMMC.None;
      --  read/write. Don't care if no data expected from card.
      READ_WRITE                  : CMD_ENUM_4 :=
                                     LPC43_SVD.SDMMC.Read_From_Card;
      --  Transfer mode. Don't care if no data expected.
      TRANSFER_MODE               : CMD_ENUM_5 :=
                                     LPC43_SVD.SDMMC.Block_Data_Transfer;
      --  Send auto stop. When set, the SD/MMC interface sends stop command to
      --  SD_MMC_CEATA cards at end of data transfer. Refer to Table 339 to
      --  determine: - when send_auto_stop bit should be set, since some data
      ...
      SEND_AUTO_STOP              : CMD_ENUM_6 :=
                                     LPC43_SVD.SDMMC.No_Stop_Command_Sent;
      --  Wait prvdata complete. The wait_prvdata_complete = 0 option typically
      --  used to query status of card during data transfer or to stop current
      --  data transfer; card_number should be same as in previous command.
      WAIT_PRVDATA_COMPLETE       : CMD_ENUM_7 := LPC43_SVD.SDMMC.Send;
      --  Stop abort command. When open-ended or predefined data transfer is in
      ...
      STOP_ABORT_CMD              : CMD_ENUM_8 := LPC43_SVD.SDMMC.Disabled;
      ...
      SEND_INITIALIZATION         : CMD_ENUM_9 := LPC43_SVD.SDMMC.No;
      ...
      UPDATE_CLOCK_REGISTERS_ONLY : CMD_ENUM_10 := LPC43_SVD.SDMMC.Normal;
      ...
      READ_CEATA_DEVICE           : CMD_ENUM_11 := LPC43_SVD.SDMMC.No_Read;
      ...
      CCS_EXPECTED                : CMD_ENUM_8 := LPC43_SVD.SDMMC.Disabled;
      ...
      BOOT_MODE                   : CMD_ENUM_12 :=
                                     LPC43_SVD.SDMMC.Mandatory_Boot_Opera;
      --  Voltage switch bit
      VOLT_SWITCH                 : CMD_ENUM_8 := LPC43_SVD.SDMMC.Disabled;
      --  Reserved
   ...
   subtype MINTSTS_CDET_Field is LPC43_SVD.Bit;
   subtype MINTSTS_RE_Field is LPC43_SVD.Bit;
   subtype MINTSTS_CDONE_Field is LPC43_SVD.Bit;
   subtype MINTSTS_DTO_Field is LPC43_SVD.Bit;
   subtype MINTSTS_TXDR_Field is LPC43_SVD.Bit;
   subtype MINTSTS_RXDR_Field is LPC43_SVD.Bit;
   subtype MINTSTS_RCRC_Field is LPC43_SVD.Bit;
   subtype MINTSTS_DCRC_Field is LPC43_SVD.Bit;
   subtype MINTSTS_RTO_Field is LPC43_SVD.Bit;
   subtype MINTSTS_DRTO_Field is LPC43_SVD.Bit;
   subtype MINTSTS_HTO_Field is LPC43_SVD.Bit;
   subtype MINTSTS_FRUN_Field is LPC43_SVD.Bit;
   subtype MINTSTS_HLE_Field is LPC43_SVD.Bit;
   subtype MINTSTS_SBE_Field is LPC43_SVD.Bit;
   subtype MINTSTS_ACD_Field is LPC43_SVD.Bit;
   subtype MINTSTS_EBE_Field is LPC43_SVD.Bit;
   subtype MINTSTS_SDIO_INTERRUPT_Field is LPC43_SVD.Bit;
   subtype MINTSTS_RESERVED_Field is LPC43_SVD.UInt15;
   ...
   subtype RINTSTS_CDET_Field is LPC43_SVD.Bit;
   subtype RINTSTS_RE_Field is LPC43_SVD.Bit;
   subtype RINTSTS_CDONE_Field is LPC43_SVD.Bit;
   subtype RINTSTS_DTO_Field is LPC43_SVD.Bit;
   subtype RINTSTS_TXDR_Field is LPC43_SVD.Bit;
   subtype RINTSTS_RXDR_Field is LPC43_SVD.Bit;
   subtype RINTSTS_RCRC_Field is LPC43_SVD.Bit;
   subtype RINTSTS_DCRC_Field is LPC43_SVD.Bit;
   subtype RINTSTS_RTO_BAR_Field is LPC43_SVD.Bit;
   subtype RINTSTS_DRTO_BDS_Field is LPC43_SVD.Bit;
   subtype RINTSTS_HTO_Field is LPC43_SVD.Bit;
   subtype RINTSTS_FRUN_Field is LPC43_SVD.Bit;
   subtype RINTSTS_HLE_Field is LPC43_SVD.Bit;
   subtype RINTSTS_SBE_Field is LPC43_SVD.Bit;
   subtype RINTSTS_ACD_Field is LPC43_SVD.Bit;
   subtype RINTSTS_EBE_Field is LPC43_SVD.Bit;
   subtype RINTSTS_SDIO_INTERRUPT_Field is LPC43_SVD.Bit;
   subtype RINTSTS_RESERVED_Field is LPC43_SVD.UInt15;
   ...
   subtype STATUS_FIFO_RX_WATERMARK_Field is LPC43_SVD.Bit;
   subtype STATUS_FIFO_TX_WATERMARK_Field is LPC43_SVD.Bit;
   subtype STATUS_FIFO_EMPTY_Field is LPC43_SVD.Bit;
   subtype STATUS_FIFO_FULL_Field is LPC43_SVD.Bit;
   subtype STATUS_CMDFSMSTATES_Field is LPC43_SVD.UInt4;
   subtype STATUS_DATA_3_STATUS_Field is LPC43_SVD.Bit;
   subtype STATUS_DATA_BUSY_Field is LPC43_SVD.Bit;
   subtype STATUS_DATA_STATE_MC_BUSY_Field is LPC43_SVD.Bit;
   subtype STATUS_RESPONSE_INDEX_Field is LPC43_SVD.UInt6;
   subtype STATUS_FIFO_COUNT_Field is LPC43_SVD.UInt13;
   subtype STATUS_DMA_ACK_Field is LPC43_SVD.Bit;
   subtype STATUS_DMA_REQ_Field is LPC43_SVD.Bit;
   ...
   subtype FIFOTH_TX_WMARK_Field is LPC43_SVD.UInt12;
   subtype FIFOTH_RESERVED_Field is LPC43_SVD.UInt4;
   subtype FIFOTH_RX_WMARK_Field is LPC43_SVD.UInt12;
   ...
   subtype FIFOTH_RESERVED_Field_1 is LPC43_SVD.Bit;
   ...
   type FIFOTH_Register is record
      ...
      --  RX_WMark = 7
      DMA_MTS    : FIFOTH_ENUM := LPC43_SVD.SDMMC.FIFOTH_ENUM_1_Transfer;
      --  Reserved
   ...
   subtype CDETECT_CARD_DETECT_Field is LPC43_SVD.Bit;
   subtype CDETECT_RESERVED_Field is LPC43_SVD.UInt31;
   ...
   subtype WRTPRT_WRITE_PROTECT_Field is LPC43_SVD.Bit;
   subtype WRTPRT_RESERVED_Field is LPC43_SVD.UInt31;
   ...
   subtype DEBNCE_DEBOUNCE_COUNT_Field is LPC43_SVD.UInt24;
   subtype DEBNCE_RESERVED_Field is LPC43_SVD.Byte;
   ...
   subtype RST_N_CARD_RESET_Field is LPC43_SVD.Bit;
   subtype RST_N_RESERVED_Field is LPC43_SVD.UInt31;
   ...
   subtype BMOD_SWR_Field is LPC43_SVD.Bit;
   subtype BMOD_FB_Field is LPC43_SVD.Bit;
   subtype BMOD_DSL_Field is LPC43_SVD.UInt5;
   subtype BMOD_DE_Field is LPC43_SVD.Bit;
   ...
   subtype BMOD_RESERVED_Field is LPC43_SVD.UInt21;
   ...
   type BMOD_Register is record
      ...
      PBL      : BMOD_ENUM := LPC43_SVD.SDMMC.BMOD_ENUM_1_Transfer;
      --  Reserved
   ...
   subtype IDSTS_TI_Field is LPC43_SVD.Bit;
   subtype IDSTS_RI_Field is LPC43_SVD.Bit;
   subtype IDSTS_FBE_Field is LPC43_SVD.Bit;
   subtype IDSTS_RESERVED_Field is LPC43_SVD.Bit;
   subtype IDSTS_DU_Field is LPC43_SVD.Bit;
   subtype IDSTS_CES_Field is LPC43_SVD.Bit;
   subtype IDSTS_RESERVED_Field_1 is LPC43_SVD.UInt2;
   subtype IDSTS_NIS_Field is LPC43_SVD.Bit;
   subtype IDSTS_AIS_Field is LPC43_SVD.Bit;
   subtype IDSTS_EB_Field is LPC43_SVD.UInt3;
   subtype IDSTS_FSM_Field is LPC43_SVD.UInt4;
   subtype IDSTS_RESERVED_Field_2 is LPC43_SVD.UInt15;
   ...
   subtype IDINTEN_TI_Field is LPC43_SVD.Bit;
   subtype IDINTEN_RI_Field is LPC43_SVD.Bit;
   subtype IDINTEN_FBE_Field is LPC43_SVD.Bit;
   subtype IDINTEN_RESERVED_Field is LPC43_SVD.Bit;
   subtype IDINTEN_DU_Field is LPC43_SVD.Bit;
   subtype IDINTEN_CES_Field is LPC43_SVD.Bit;
   subtype IDINTEN_RESERVED_Field_1 is LPC43_SVD.UInt2;
   subtype IDINTEN_NIS_Field is LPC43_SVD.Bit;
   subtype IDINTEN_AIS_Field is LPC43_SVD.Bit;
   subtype IDINTEN_RESERVED_Field_2 is LPC43_SVD.UInt22;
   ...
   type SDMMC_Peripheral is record
      ...
      --  Byte Count Register
      BYTCNT  : aliased LPC43_SVD.UInt32;
      --  Interrupt Mask Register
      INTMASK : aliased INTMASK_Register;
      --  Command Argument Register
      CMDARG  : aliased LPC43_SVD.UInt32;
      --  Command Register
      CMD     : aliased CMD_Register;
      --  Response Register 0
      RESP0   : aliased LPC43_SVD.UInt32;
      --  Response Register 1
      RESP1   : aliased LPC43_SVD.UInt32;
      --  Response Register 2
      RESP2   : aliased LPC43_SVD.UInt32;
      --  Response Register 3
      RESP3   : aliased LPC43_SVD.UInt32;
      --  Masked Interrupt Status Register
      ...
      TCBCNT  : aliased LPC43_SVD.UInt32;
      --  Transferred Host to BIU-FIFO Byte Count Register
      TBBCNT  : aliased LPC43_SVD.UInt32;
      --  Debounce Count Register
