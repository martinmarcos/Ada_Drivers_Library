...
package LPC43_SVD.SPI is
   ...
   subtype CR_RESERVED_Field is LPC43_SVD.UInt2;
   ...
   subtype CR_RESERVED_Field_1 is LPC43_SVD.UInt20;
   ...
   type CR_Register is record
      ...
      CPHA       : CR_ENUM_1 := LPC43_SVD.SPI.First_Edge;
      --  Clock polarity control.
      CPOL       : CR_ENUM_2 := LPC43_SVD.SPI.Sck_Is_Active_High;
      --  Master mode select.
      MSTR       : CR_ENUM_3 := LPC43_SVD.SPI.Slave;
      --  LSB First controls which direction each byte is shifted when
      --  transferred.
      LSBF       : CR_ENUM_4 := LPC43_SVD.SPI.Msb;
      --  Serial peripheral interrupt enable.
      SPIE       : CR_ENUM_5 := LPC43_SVD.SPI.Intblock;
      --  When bit 2 of this register is 1, this field controls the number of
      --  bits per transfer:
      BITS       : CR_ENUM_6 := LPC43_SVD.SPI.CR_ENUM_16_Bits_Per_Transfer;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype SR_RESERVED_Field is LPC43_SVD.UInt3;
   subtype SR_ABRT_Field is LPC43_SVD.Bit;
   subtype SR_MODF_Field is LPC43_SVD.Bit;
   subtype SR_ROVR_Field is LPC43_SVD.Bit;
   subtype SR_WCOL_Field is LPC43_SVD.Bit;
   subtype SR_SPIF_Field is LPC43_SVD.Bit;
   subtype SR_RESERVED_Field_1 is LPC43_SVD.UInt24;
   ...
   subtype DR_DATALOW_Field is LPC43_SVD.Byte;
   subtype DR_DATAHIGH_Field is LPC43_SVD.Byte;
   ...
   subtype CCR_COUNTER_Field is LPC43_SVD.Byte;
   subtype CCR_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype TCR_RESERVED_Field is LPC43_SVD.Bit;
   subtype TCR_TEST_Field is LPC43_SVD.UInt7;
   subtype TCR_RESERVED_Field_1 is LPC43_SVD.UInt24;
   ...
   subtype TSR_RESERVED_Field is LPC43_SVD.UInt3;
   subtype TSR_ABRT_Field is LPC43_SVD.Bit;
   subtype TSR_MODF_Field is LPC43_SVD.Bit;
   subtype TSR_ROVR_Field is LPC43_SVD.Bit;
   subtype TSR_WCOL_Field is LPC43_SVD.Bit;
   subtype TSR_SPIF_Field is LPC43_SVD.Bit;
   subtype TSR_RESERVED_Field_1 is LPC43_SVD.UInt24;
   ...
   subtype INT_SPIF_Field is LPC43_SVD.Bit;
   subtype INT_RESERVED_Field is LPC43_SVD.UInt7;
   subtype INT_RESERVED_Field_1 is LPC43_SVD.UInt24;
