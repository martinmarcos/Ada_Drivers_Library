...
package LPC43_SVD.RGU is
   ...
   type RESET_CTRL0_RESERVED_Field_Array is array (1 .. 2) of Boolean
     with Component_Size => 1, Size => 2;

   --  Type definition for RESET_CTRL0_RESERVED
   type RESET_CTRL0_RESERVED_Field
   ...
   for RESET_CTRL0_RESERVED_Field use record
      Val at 0 range 0 .. 1;
      Arr at 0 range 0 .. 1;
   end record;
   ...
   type RESET_CTRL0_Register is record
      ...
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      EMC_RST      : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      ETHERNET_RST : Boolean := False;
      --  Write-only. Reserved
      RESERVED_4   : RESET_CTRL0_RESERVED_Field :=
                      (As_Array => False, Val => 16#0#);
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      FLASHA_RST   : Boolean := False;
      --  Write-only. Reserved
      ...
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      GPIO_RST     : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      FLASHB_RST   : Boolean := False;
      --  Write-only. Reserved
      RESERVED_6   : RESET_CTRL0_RESERVED_Field :=
                      (As_Array => False, Val => 16#0#);
   end record
   ...
   type RESET_CTRL1_RESERVED_Field_Array is array (1 .. 3) of Boolean
     with Component_Size => 1, Size => 3;

   --  Type definition for RESET_CTRL1_RESERVED
   type RESET_CTRL1_RESERVED_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
   ...
   for RESET_CTRL1_RESERVED_Field use record
      Val at 0 range 0 .. 2;
      Arr at 0 range 0 .. 2;
   end record;
   ...
   type RESET_CTRL1_Register is record
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      TIMER0_RST     : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      TIMER1_RST     : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      TIMER2_RST     : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      TIMER3_RST     : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      RITIMER_RST    : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      SCT_RST        : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      MOTOCONPWM_RST : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      QEI_RST        : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      ADC0_RST       : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      ADC1_RST       : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      DAC_RST        : Boolean := False;
      --  Write-only. Reserved
      RESERVED       : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      UART0_RST      : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      ...
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      UART3_RST      : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      I2C0_RST       : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      I2C1_RST       : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      SSP0_RST       : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      SSP1_RST       : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      I2S_RST        : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      SPIFI_RST      : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      CAN1_RST       : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      CAN0_RST       : Boolean := False;
      --  Write-only. Writing a one activates the reset. Writing a 0 clears the
      --  reset. This bit must be cleared by software.
      M0APP_RST      : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      SGPIO_RST      : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      SPI_RST        : Boolean := False;
      --  Write-only. Reserved
      RESERVED_1     : Boolean := False;
      --  Write-only. Writing a one activates the reset. This bit is
      --  automatically cleared to 0 after one clock cycle.
      ADCHS_RST      : Boolean := False;
      --  Write-only. Reserved
      RESERVED_2     : RESET_CTRL1_RESERVED_Field :=
                        (As_Array => False, Val => 16#0#);
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype RESET_STATUS0_RESERVED_Field is HAL.UInt2;
   subtype RESET_STATUS0_PERIPH_RST_Field is HAL.UInt2;
   subtype RESET_STATUS0_MASTER_RST_Field is HAL.UInt2;
   subtype RESET_STATUS0_WWDT_RST_Field is HAL.UInt2;
   subtype RESET_STATUS0_CREG_RST_Field is HAL.UInt2;
   --  RESET_STATUS0_RESERVED array element
   subtype RESET_STATUS0_RESERVED_Element is HAL.UInt2;
   ...
   subtype RESET_STATUS0_BUS_RST_Field is HAL.UInt2;
   subtype RESET_STATUS0_SCU_RST_Field is HAL.UInt2;
   subtype RESET_STATUS0_M0SUB_RST_Field is HAL.UInt2;
   subtype RESET_STATUS0_M4_RST_Field is HAL.UInt2;
   ...
   subtype RESET_STATUS1_LCD_RST_Field is HAL.UInt2;
   subtype RESET_STATUS1_USB0_RST_Field is HAL.UInt2;
   subtype RESET_STATUS1_USB1_RST_Field is HAL.UInt2;
   subtype RESET_STATUS1_DMA_RST_Field is HAL.UInt2;
   subtype RESET_STATUS1_SDIO_RST_Field is HAL.UInt2;
   subtype RESET_STATUS1_EMC_RST_Field is HAL.UInt2;
   subtype RESET_STATUS1_ETHERNET_RST_Field is HAL.UInt2;
   --  RESET_STATUS1_RESERVED array element
   subtype RESET_STATUS1_RESERVED_Element is HAL.UInt2;
   ...
   subtype RESET_STATUS1_FLASHA_RST_Field is HAL.UInt2;
   subtype RESET_STATUS1_RESERVED_Field_1 is HAL.UInt2;
   subtype RESET_STATUS1_EEPROM_RST_Field is HAL.UInt2;
   subtype RESET_STATUS1_GPIO_RST_Field is HAL.UInt2;
   subtype RESET_STATUS1_FLASHB_RST_Field is HAL.UInt2;
   ...
   subtype RESET_STATUS2_TIMER0_RST_Field is HAL.UInt2;
   subtype RESET_STATUS2_TIMER1_RST_Field is HAL.UInt2;
   subtype RESET_STATUS2_TIMER2_RST_Field is HAL.UInt2;
   subtype RESET_STATUS2_TIMER3_RST_Field is HAL.UInt2;
   subtype RESET_STATUS2_RITIMER_RST_Field is HAL.UInt2;
   subtype RESET_STATUS2_SCT_RST_Field is HAL.UInt2;
   subtype RESET_STATUS2_MOTOCONPWM_RST_Field is HAL.UInt2;
   subtype RESET_STATUS2_QEI_RST_Field is HAL.UInt2;
   subtype RESET_STATUS2_ADC0_RST_Field is HAL.UInt2;
   subtype RESET_STATUS2_ADC1_RST_Field is HAL.UInt2;
   subtype RESET_STATUS2_DAC_RST_Field is HAL.UInt2;
   subtype RESET_STATUS2_RESERVED_Field is HAL.UInt2;
   subtype RESET_STATUS2_UART0_RST_Field is HAL.UInt2;
   subtype RESET_STATUS2_UART1_RST_Field is HAL.UInt2;
   subtype RESET_STATUS2_UART2_RST_Field is HAL.UInt2;
   subtype RESET_STATUS2_UART3_RST_Field is HAL.UInt2;
   ...
   subtype RESET_STATUS3_I2C0_RST_Field is HAL.UInt2;
   subtype RESET_STATUS3_I2C1_RST_Field is HAL.UInt2;
   subtype RESET_STATUS3_SSP0_RST_Field is HAL.UInt2;
   subtype RESET_STATUS3_SSP1_RST_Field is HAL.UInt2;
   subtype RESET_STATUS3_I2S_RST_Field is HAL.UInt2;
   subtype RESET_STATUS3_SPIFI_RST_Field is HAL.UInt2;
   subtype RESET_STATUS3_CAN1_RST_Field is HAL.UInt2;
   subtype RESET_STATUS3_CAN0_RST_Field is HAL.UInt2;
   subtype RESET_STATUS3_M0APP_RST_Field is HAL.UInt2;
   subtype RESET_STATUS3_SGPIO_RST_Field is HAL.UInt2;
   subtype RESET_STATUS3_SPI_RST_Field is HAL.UInt2;
   subtype RESET_STATUS3_RESERVED_Field is HAL.UInt2;
   subtype RESET_STATUS3_ADCHS_RST_Field is HAL.UInt2;
   --  RESET_STATUS3_RESERVED array element
   subtype RESET_STATUS3_RESERVED_Element is HAL.UInt2;
   ...
   type RESET_ACTIVE_STATUS0_RESERVED_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
   ...
   for RESET_ACTIVE_STATUS0_RESERVED_Field use record
      Val at 0 range 0 .. 1;
      Arr at 0 range 0 .. 1;
   end record;
   ...
   type RESET_ACTIVE_STATUS0_Register is record
      ...
      CREG_RST     : Boolean;
      --  Read-only. Reserved
      RESERVED_1   : RESET_ACTIVE_STATUS0_RESERVED_Field;
      ...
      SCU_RST      : Boolean;
      --  Read-only. Reserved
      RESERVED_2   : RESET_ACTIVE_STATUS0_RESERVED_Field;
      ...
      M4_RST       : Boolean;
      --  Read-only. Reserved
      RESERVED_3   : RESET_ACTIVE_STATUS0_RESERVED_Field;
      ...
      --  No reset
      ETHERNET_RST : Boolean;
      --  Read-only. Reserved
      RESERVED_4   : RESET_ACTIVE_STATUS0_RESERVED_Field;
      ...
      FLASHB_RST   : Boolean;
      --  Read-only. Reserved
      RESERVED_6   : RESET_ACTIVE_STATUS0_RESERVED_Field;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type RESET_ACTIVE_STATUS1_RESERVED_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
   ...
   for RESET_ACTIVE_STATUS1_RESERVED_Field use record
      Val at 0 range 0 .. 2;
      Arr at 0 range 0 .. 2;
   end record;
   ...
   type RESET_ACTIVE_STATUS1_Register is record
      ...
      ADCHS_RST      : Boolean;
      --  Read-only. Reserved.
      RESERVED_2     : RESET_ACTIVE_STATUS1_RESERVED_Field;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype RESET_EXT_STAT_RESERVED_Field is HAL.UInt30;
   ...
   type RESET_EXT_STAT_Register is record
      ...
      CORE_RESET : Boolean := False;
      --  Reserved. Do not modify; read as logic 0.
      RESERVED_1 : RESET_EXT_STAT_RESERVED_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype RESET_EXT_STAT_RESERVED_Field_1 is HAL.UInt2;
   subtype RESET_EXT_STAT_RESERVED_Field_2 is HAL.UInt29;

   --  Reset external status register 2 for MASTER_RST
   type RESET_EXT_STAT_Register_1 is record
      --  Reserved. Do not modify; read as logic 0.
      RESERVED         : RESET_EXT_STAT_RESERVED_Field_1 := 16#0#;
      --  Reset activated by PERIPHERAL_RST output. Write 0 to clear. 0 = Reset
      --  not activated 1 = Reset activated
      PERIPHERAL_RESET : Boolean := True;
      --  Reserved. Do not modify; read as logic 0.
      RESERVED_1       : RESET_EXT_STAT_RESERVED_Field_2 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype RESET_EXT_STAT_RESERVED_Field_3 is HAL.UInt3;
   subtype RESET_EXT_STAT_RESERVED_Field_4 is HAL.UInt28;

   --  Reset external status register
   type RESET_EXT_STAT_Register_2 is record
      --  Reserved. Do not modify; read as logic 0.
      RESERVED     : RESET_EXT_STAT_RESERVED_Field_3 := 16#0#;
      --  Reset activated by MASTER_RST output. Write 0 to clear. 0 = Reset not
      --  activated 1 = Reset activated
      MASTER_RESET : Boolean := True;
      --  Reserved. Do not modify; read as logic 0.
      RESERVED_1   : RESET_EXT_STAT_RESERVED_Field_4 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
