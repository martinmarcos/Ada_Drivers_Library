...
package LPC43_SVD.SCT is
   ...
   subtype CONFIG_INSYNC_Field is HAL.UInt8;
   subtype CONFIG_RESERVED_Field is HAL.UInt13;
   ...
   subtype CTRL_RESERVED_Field is HAL.UInt3;
   ...
   subtype DITHER_DITHMSK_L_Field is HAL.UInt16;
   subtype DITHER_DITHMSK_H_Field is HAL.UInt16;
   ...
   subtype STATE_RESERVED_Field is HAL.UInt11;
   ...
   --  INPUT_AIN array
   type INPUT_AIN_Field_Array is array (0 .. 7) of Boolean
   ...
   subtype INPUT_RESERVED_Field is HAL.UInt8;

   --  INPUT_SIN array
   type INPUT_SIN_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype OUTPUT_RESERVED_Field is HAL.UInt16;
   ...
   subtype DMAREQ0_RESERVED_Field is HAL.UInt14;
   ...
   type DMAREQ0_Register is record
      ...
      DEV_00   : Boolean := False;
      --  If bit n is one, event n sets DMA request 0 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_01   : Boolean := False;
      --  If bit n is one, event n sets DMA request 0 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_02   : Boolean := False;
      --  If bit n is one, event n sets DMA request 0 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_03   : Boolean := False;
      --  If bit n is one, event n sets DMA request 0 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_04   : Boolean := False;
      --  If bit n is one, event n sets DMA request 0 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_05   : Boolean := False;
      --  If bit n is one, event n sets DMA request 0 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_06   : Boolean := False;
      --  If bit n is one, event n sets DMA request 0 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_07   : Boolean := False;
      --  If bit n is one, event n sets DMA request 0 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_08   : Boolean := False;
      --  If bit n is one, event n sets DMA request 0 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_09   : Boolean := False;
      --  If bit n is one, event n sets DMA request 0 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_010  : Boolean := False;
      --  If bit n is one, event n sets DMA request 0 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_011  : Boolean := False;
      --  If bit n is one, event n sets DMA request 0 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_012  : Boolean := False;
      --  If bit n is one, event n sets DMA request 0 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_013  : Boolean := False;
      --  If bit n is one, event n sets DMA request 0 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_014  : Boolean := False;
      --  If bit n is one, event n sets DMA request 0 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_015  : Boolean := False;
      --  Reserved
   ...
   subtype DMAREQ1_RESERVED_Field is HAL.UInt14;
   ...
   type DMAREQ1_Register is record
      ...
      --  = bit 1,..., event 15 = bit 15).
      DEV_10   : Boolean := False;
      --  If bit n is one, event n sets DMA request 1 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_11   : Boolean := False;
      --  If bit n is one, event n sets DMA request 1 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_12   : Boolean := False;
      --  If bit n is one, event n sets DMA request 1 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_13   : Boolean := False;
      --  If bit n is one, event n sets DMA request 1 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_14   : Boolean := False;
      --  If bit n is one, event n sets DMA request 1 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_15   : Boolean := False;
      --  If bit n is one, event n sets DMA request 1 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_16   : Boolean := False;
      --  If bit n is one, event n sets DMA request 1 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_17   : Boolean := False;
      --  If bit n is one, event n sets DMA request 1 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_18   : Boolean := False;
      --  If bit n is one, event n sets DMA request 1 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_19   : Boolean := False;
      --  If bit n is one, event n sets DMA request 1 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_110  : Boolean := False;
      --  If bit n is one, event n sets DMA request 1 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_111  : Boolean := False;
      --  If bit n is one, event n sets DMA request 1 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_112  : Boolean := False;
      --  If bit n is one, event n sets DMA request 1 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_113  : Boolean := False;
      --  If bit n is one, event n sets DMA request 1 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_114  : Boolean := False;
      --  If bit n is one, event n sets DMA request 1 (event 0 = bit 0, event 1
      --  = bit 1,..., event 15 = bit 15).
      DEV_115  : Boolean := False;
      --  Reserved
   ...
   --  EVEN_IEN array
   type EVEN_IEN_Field_Array is array (0 .. 15) of Boolean
   ...
   subtype EVEN_RESERVED_Field is HAL.UInt16;
   ...
   --  EVFLAG_FLAG array
   type EVFLAG_FLAG_Field_Array is array (0 .. 15) of Boolean
     with Component_Size => 1, Size => 16;
   ...
   subtype EVFLAG_RESERVED_Field is HAL.UInt16;
   ...
   --  CONEN_NCEN array
   type CONEN_NCEN_Field_Array is array (0 .. 15) of Boolean
     with Component_Size => 1, Size => 16;
   ...
   subtype CONEN_RESERVED_Field is HAL.UInt16;
   ...
   type CONFLAG_NCFLAG_Field_Array is array (0 .. 15) of Boolean
     with Component_Size => 1, Size => 16;
   ...
   subtype CONFLAG_RESERVED_Field is HAL.UInt14;
   ...
   subtype MATCH_MATCH_L_Field is HAL.UInt16;
   subtype MATCH_MATCH_H_Field is HAL.UInt16;
   ...
   subtype CAP_CAP_L_Field is HAL.UInt16;
   subtype CAP_CAP_H_Field is HAL.UInt16;
   ...
   subtype FRACMAT_FRACMAT_L_Field is HAL.UInt4;
   subtype FRACMAT_RESERVED_Field is HAL.UInt12;
   subtype FRACMAT_FRACMAT_H_Field is HAL.UInt4;
   ...
   subtype MATCHREL_RELOAD_L_Field is HAL.UInt16;
   subtype MATCHREL_RELOAD_H_Field is HAL.UInt16;
   ...
   subtype CAPCTRL_CAPCON_L_Field is HAL.UInt16;
   subtype CAPCTRL_CAPCON_H_Field is HAL.UInt16;
   ...
   subtype FRACMATREL_RELFRAC_L_Field is HAL.UInt4;
   subtype FRACMATREL_RESERVED_Field is HAL.UInt12;
   subtype FRACMATREL_RELFRAC_H_Field is HAL.UInt4;
   ...
   type EV_STATE_STATEMSK_Field_Array is array (0 .. 31) of Boolean
   ...
   subtype EV_CTRL_MATCHSEL_Field is HAL.UInt4;
   ...
   subtype EV_CTRL_IOSEL_Field is HAL.UInt4;
   ...
   subtype EV_CTRL_STATEV_Field is HAL.UInt5;
   ...
   subtype EV_CTRL_RESERVED_Field is HAL.UInt9;
   ...
   --  OUT_SET_SET array
   type OUT_SET_SET_Field_Array is array (0 .. 15) of Boolean
     with Component_Size => 1, Size => 16;
   ...
   subtype OUT_SET_RESERVED_Field is HAL.UInt16;
   ...
   --  OUT_CLR_CLR array
   type OUT_CLR_CLR_Field_Array is array (0 .. 15) of Boolean
     with Component_Size => 1, Size => 16;
   ...
   subtype OUT_CLR_RESERVED_Field is HAL.UInt16;
