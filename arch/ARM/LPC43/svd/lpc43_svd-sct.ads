...
package LPC43_SVD.SCT is
   ...
   subtype CONFIG_NORELAOD_L_Field is LPC43_SVD.Bit;
   subtype CONFIG_NORELOAD_H_Field is LPC43_SVD.Bit;
   subtype CONFIG_INSYNC_Field is LPC43_SVD.Byte;
   subtype CONFIG_AUTOLIMIT_L_Field is LPC43_SVD.Bit;
   subtype CONFIG_AUTOLIMIT_H_Field is LPC43_SVD.Bit;
   subtype CONFIG_RESERVED_Field is LPC43_SVD.UInt13;

   --  SCT configuration register
   type CONFIG_Register is record
      --  SCT operation
      UNIFY       : CONFIG_ENUM := LPC43_SVD.SCT.CONFIG_ENUM_16_Bit;
      --  SCT clock mode
      CLKMODE     : CONFIG_ENUM_1 := LPC43_SVD.SCT.Bus_Clock;
      --  SCT clock select
      CKSEL       : CONFIG_ENUM_2 := LPC43_SVD.SCT.Rising_Edges_On_Inpu;
   ...
   subtype CTRL_DOWN_L_Field is LPC43_SVD.Bit;
   subtype CTRL_STOP_L_Field is LPC43_SVD.Bit;
   subtype CTRL_HALT_L_Field is LPC43_SVD.Bit;
   subtype CTRL_CLRCTR_L_Field is LPC43_SVD.Bit;
   ...
   subtype CTRL_PRE_L_Field is LPC43_SVD.Byte;
   subtype CTRL_RESERVED_Field is LPC43_SVD.UInt3;
   subtype CTRL_DOWN_H_Field is LPC43_SVD.Bit;
   subtype CTRL_STOP_H_Field is LPC43_SVD.Bit;
   subtype CTRL_HALT_H_Field is LPC43_SVD.Bit;
   subtype CTRL_CLRCTR_H_Field is LPC43_SVD.Bit;
   subtype CTRL_PRE_H_Field is LPC43_SVD.Byte;
   ...
   type CTRL_Register is record
      ...
      --  L or unified counter direction select
      BIDIR_L    : CTRL_ENUM := LPC43_SVD.SCT.Up;
      ...
      --  Direction select
      BIDIR_H    : CTRL_ENUM := LPC43_SVD.SCT.Up;
      --  Specifies the factor by which the SCT clock is prescaled to produce
   ...
   subtype LIMIT_LIMMSK_L_Field is LPC43_SVD.UInt16;
   subtype LIMIT_LIMMSK_H_Field is LPC43_SVD.UInt16;
   ...
   subtype HALT_HALTMSK_L_Field is LPC43_SVD.UInt16;
   subtype HALT_HALTMSK_H_Field is LPC43_SVD.UInt16;
   ...
   subtype STOP_STOPMSK_L_Field is LPC43_SVD.UInt16;
   subtype STOP_STOPMSK_H_Field is LPC43_SVD.UInt16;
   ...
   subtype START_STARTMSK_L_Field is LPC43_SVD.UInt16;
   subtype START_STARTMSK_H_Field is LPC43_SVD.UInt16;
   ...
   subtype DITHER_DITHMSK_L_Field is LPC43_SVD.UInt16;
   subtype DITHER_DITHMSK_H_Field is LPC43_SVD.UInt16;
   ...
   subtype COUNT_CTR_L_Field is LPC43_SVD.UInt16;
   subtype COUNT_CTR_H_Field is LPC43_SVD.UInt16;
   ...
   subtype STATE_STATE_L_Field is LPC43_SVD.UInt5;
   subtype STATE_RESERVED_Field is LPC43_SVD.UInt11;
   subtype STATE_STATE_H_Field is LPC43_SVD.UInt5;
   ...
   subtype INPUT_AIN_Element is LPC43_SVD.Bit;
   ...
   subtype INPUT_RESERVED_Field is LPC43_SVD.Byte;
   --  INPUT_SIN array element
   subtype INPUT_SIN_Element is LPC43_SVD.Bit;
   ...
   subtype REGMODE_REGMOD_L_Field is LPC43_SVD.UInt16;
   subtype REGMODE_REGMOD_H_Field is LPC43_SVD.UInt16;
   ...
   subtype OUTPUT_OUT_Field is LPC43_SVD.UInt16;
   subtype OUTPUT_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype DMAREQ0_DEV_00_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DEV_01_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DEV_02_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DEV_03_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DEV_04_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DEV_05_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DEV_06_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DEV_07_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DEV_08_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DEV_09_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DEV_010_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DEV_011_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DEV_012_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DEV_013_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DEV_014_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DEV_015_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_RESERVED_Field is LPC43_SVD.UInt14;
   subtype DMAREQ0_DRL0_Field is LPC43_SVD.Bit;
   subtype DMAREQ0_DRQ0_Field is LPC43_SVD.Bit;
   ...
   subtype DMAREQ1_DEV_10_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DEV_11_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DEV_12_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DEV_13_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DEV_14_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DEV_15_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DEV_16_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DEV_17_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DEV_18_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DEV_19_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DEV_110_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DEV_111_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DEV_112_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DEV_113_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DEV_114_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DEV_115_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_RESERVED_Field is LPC43_SVD.UInt14;
   subtype DMAREQ1_DRL1_Field is LPC43_SVD.Bit;
   subtype DMAREQ1_DRQ1_Field is LPC43_SVD.Bit;
   ...
   subtype EVEN_IEN_Element is LPC43_SVD.Bit;
   ...
   subtype EVEN_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype EVFLAG_FLAG_Element is LPC43_SVD.Bit;
   ...
   subtype EVFLAG_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype CONEN_NCEN_Element is LPC43_SVD.Bit;
   ...
   subtype CONEN_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype CONFLAG_NCFLAG_Element is LPC43_SVD.Bit;
   ...
   subtype CONFLAG_RESERVED_Field is LPC43_SVD.UInt14;
   subtype CONFLAG_BUSERRL_Field is LPC43_SVD.Bit;
   subtype CONFLAG_BUSERRH_Field is LPC43_SVD.Bit;
   ...
   subtype MATCH_MATCH_L_Field is LPC43_SVD.UInt16;
   subtype MATCH_MATCH_H_Field is LPC43_SVD.UInt16;
   ...
   subtype CAP_CAP_L_Field is LPC43_SVD.UInt16;
   subtype CAP_CAP_H_Field is LPC43_SVD.UInt16;
   ...
   subtype FRACMAT_FRACMAT_L_Field is LPC43_SVD.UInt4;
   subtype FRACMAT_RESERVED_Field is LPC43_SVD.UInt12;
   subtype FRACMAT_FRACMAT_H_Field is LPC43_SVD.UInt4;
   ...
   subtype MATCHREL_RELOAD_L_Field is LPC43_SVD.UInt16;
   subtype MATCHREL_RELOAD_H_Field is LPC43_SVD.UInt16;
   ...
   subtype CAPCTRL_CAPCON_L_Field is LPC43_SVD.UInt16;
   subtype CAPCTRL_CAPCON_H_Field is LPC43_SVD.UInt16;
   ...
   subtype FRACMATREL_RELFRAC_L_Field is LPC43_SVD.UInt4;
   subtype FRACMATREL_RESERVED_Field is LPC43_SVD.UInt12;
   subtype FRACMATREL_RELFRAC_H_Field is LPC43_SVD.UInt4;
   ...
   subtype EV_STATE_STATEMSK_Element is LPC43_SVD.Bit;
   ...
   subtype EV_CTRL_MATCHSEL_Field is LPC43_SVD.UInt4;
   ...
   subtype EV_CTRL_IOSEL_Field is LPC43_SVD.UInt4;
   ...
   subtype EV_CTRL_STATEV_Field is LPC43_SVD.UInt5;
   subtype EV_CTRL_MATCHMEM_Field is LPC43_SVD.Bit;
   ...
   subtype EV_CTRL_RESERVED_Field is LPC43_SVD.UInt9;
   ...
   type EV_CTRL_Register is record
      ...
      --  Select L/H counter. Do not set this bit if UNIFY = 1.
      HEVENT    : EV_CTRL0_ENUM := LPC43_SVD.SCT.L_State;
      --  Input/output select
      OUTSEL    : EV_CTRL0_ENUM_1 := LPC43_SVD.SCT.Input;
      ...
      IOCOND    : EV_CTRL0_ENUM_2 := LPC43_SVD.SCT.Low;
      --  Selects how the specified match and I/O condition are used and
      --  combined.
      COMBMODE  : EV_CTRL0_ENUM_3 := LPC43_SVD.SCT.Or_k;
      --  This bit controls how the STATEV value modifies the state selected by
      --  HEVENT when this event is the highest-numbered event occurring for
      --  that state.
      STATELD   : EV_CTRL0_ENUM_4 := LPC43_SVD.SCT.Statev_Value_Is_Adde;
      ...
      DIRECTION : EV_CTRL0_ENUM_5 := LPC43_SVD.SCT.Direction_Independen;
      --  Reserved
   ...
   subtype OUT_SET_SET_Element is LPC43_SVD.Bit;
   ...
   subtype OUT_SET_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype OUT_CLR_CLR_Element is LPC43_SVD.Bit;
   ...
   subtype OUT_CLR_RESERVED_Field is LPC43_SVD.UInt16;
