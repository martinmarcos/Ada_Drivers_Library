...
package LPC43_SVD.C_CAN1 is
   ...
   subtype CNTL_RESERVED_Field is LPC43_SVD.Bit;
   ...
   subtype CNTL_RESERVED_Field_1 is LPC43_SVD.UInt24;

   --  CAN control
   type CNTL_Register is record
      --  Initialization
      INIT       : CNTL_ENUM := LPC43_SVD.C_CAN1.Initialization_Is_St;
      --  Module interrupt enable
      IE         : CNTL_ENUM_1 := LPC43_SVD.C_CAN1.Disable_Can_Interrup;
      --  Status change interrupt enable
      SIE        : CNTL_ENUM_2 := LPC43_SVD.C_CAN1.Disable_Status_Chang;
      --  Error interrupt enable
      EIE        : CNTL_ENUM_3 := LPC43_SVD.C_CAN1.Disable_Error_Interr;
      --  reserved
      RESERVED   : CNTL_RESERVED_Field := 16#0#;
      --  Disable automatic retransmission
      DAR        : CNTL_ENUM_4 := LPC43_SVD.C_CAN1.Enabled;
      --  Configuration change enable
      CCE        : CNTL_ENUM_5 := LPC43_SVD.C_CAN1.The_Cpu_Has_No_Write;
      --  Test mode enable
      TEST       : CNTL_ENUM_6 := LPC43_SVD.C_CAN1.Normal_Operation;
      --  reserved
   ...
   subtype STAT_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   type STAT_Register is record
      ...
      LEC      : STAT_ENUM := LPC43_SVD.C_CAN1.No_Error;
      --  Transmitted a message successfully This bit is reset by the CPU. It
      --  is never reset by the CAN controller.
      TXOK     : STAT_ENUM_1 := LPC43_SVD.C_CAN1.Nomsgtransfer;
      --  Received a message successfully This bit is reset by the CPU. It is
      --  never reset by the CAN controller.
      RXOK     : STAT_ENUM_1 := LPC43_SVD.C_CAN1.Nomsgtransfer;
      --  Error passive
      EPASS    : STAT_ENUM_2 := LPC43_SVD.C_CAN1.Active;
      --  Warning status
      EWARN    : STAT_ENUM_3 := LPC43_SVD.C_CAN1.Both_Error_Counters;
      --  Busoff status
      BOFF     : STAT_ENUM_4 := LPC43_SVD.C_CAN1.Nobusoff;
      --  reserved
   ...
   subtype EC_TEC_7_0_Field is LPC43_SVD.Byte;
   subtype EC_REC_6_0_Field is LPC43_SVD.UInt7;
   ...
   subtype EC_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype BT_BRP_Field is LPC43_SVD.UInt6;
   subtype BT_SJW_Field is LPC43_SVD.UInt2;
   subtype BT_TSEG1_Field is LPC43_SVD.UInt4;
   subtype BT_TSEG2_Field is LPC43_SVD.UInt3;
   subtype BT_RESERVED_Field is LPC43_SVD.UInt17;
   ...
   subtype INT_INTID15_0_Field is LPC43_SVD.UInt16;
   subtype INT_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype TEST_RESERVED_Field is LPC43_SVD.UInt2;
   ...
   subtype TEST_RESERVED_Field_1 is LPC43_SVD.UInt24;
   ...
   type TEST_Register is record
      ...
      --  Basic mode
      BASIC      : TEST_ENUM := LPC43_SVD.C_CAN1.Basic_Mode_Disabled;
      --  Silent mode
      SILENT     : TEST_ENUM_1 := LPC43_SVD.C_CAN1.Normal_Operation;
      --  Loop back mode
      LBACK      : TEST_ENUM_2 := LPC43_SVD.C_CAN1.Disabled;
      --  Control of TD pins
      TX1_0      : TEST_ENUM_3 := LPC43_SVD.C_CAN1.Level_At_The_Td_Pin;
      --  Monitors the actual value of the RD Pin
      RX         : TEST_ENUM_4 := LPC43_SVD.C_CAN1.The_Can_Bus_Is_Domin;
      --  Reserved
   ...
   subtype BRPE_BRPE_Field is LPC43_SVD.UInt4;
   subtype BRPE_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype IF_CMDREQ_MESSNUM_Field is LPC43_SVD.UInt6;
   subtype IF_CMDREQ_RESERVED_Field is LPC43_SVD.UInt9;
   subtype IF_CMDREQ_BUSY_Field is LPC43_SVD.Bit;
   subtype IF_CMDREQ_RESERVED_Field_1 is LPC43_SVD.UInt16;
   ...
   subtype IF_CMDMSK_W_CLRINTPND_Field is LPC43_SVD.Bit;
   ...
   subtype IF_CMDMSK_W_WR_RD_Field is LPC43_SVD.Bit;
   subtype IF_CMDMSK_W_RESERVED_Field is LPC43_SVD.UInt24;

   --  Message interface command mask (write direction)
   type IF_CMDMSK_W_Register is record
      --  Access data bytes 4-7
      DATA_B    : IF_CMDMSK_W0_ENUM := LPC43_SVD.C_CAN1.Data_Bytes_4_7_Uncha;
      --  Access data bytes 0-3
      DATA_A    : IF_CMDMSK_W0_ENUM_1 :=
                   LPC43_SVD.C_CAN1.Data_Bytes_0_3_Uncha;
      --  Access transmission request bit
      TXRQST    : IF_CMDMSK_W0_ENUM_2 :=
                   LPC43_SVD.C_CAN1.No_Transmission_Requ;
      --  This bit is ignored in the write direction.
      CLRINTPND : IF_CMDMSK_W_CLRINTPND_Field := 16#0#;
      --  Access control bits
      CTRL      : IF_CMDMSK_W0_ENUM_3 :=
                   LPC43_SVD.C_CAN1.Control_Bits_Unchang;
      --  Access arbitration bits
      ARB       : IF_CMDMSK_W0_ENUM_4 :=
                   LPC43_SVD.C_CAN1.Arbitration_Bits_Unc;
      --  Access mask bits
      MASK      : IF_CMDMSK_W0_ENUM_5 := LPC43_SVD.C_CAN1.Mask_Bits_Unchanged;
   ...
   subtype IF_CMDMSK_R_WR_RD_Field is LPC43_SVD.Bit;
   subtype IF_CMDMSK_R_RESERVED_Field is LPC43_SVD.UInt24;

   --  Message interface command mask (read direction)
   type IF_CMDMSK_R_Register is record
      --  Access data bytes 4-7
      DATA_B    : IF_CMDMSK_R0_ENUM := LPC43_SVD.C_CAN1.Data_Bytes_4_7_Uncha;
      --  Access data bytes 0-3
      DATA_A    : IF_CMDMSK_R0_ENUM_1 :=
                   LPC43_SVD.C_CAN1.Data_Bytes_0_3_Uncha;
      --  Access new data bit
      NEWDAT    : IF_CMDMSK_R0_ENUM_2 :=
                   LPC43_SVD.C_CAN1.Newdat_Bit_Remains_U;
      --  Clear interrupt pending bit.
      CLRINTPND : IF_CMDMSK_R0_ENUM_3 :=
                   LPC43_SVD.C_CAN1.Intpnd_Bit_Remains_U;
      --  Access control bits
      ...
      ARB       : IF_CMDMSK_R0_ENUM_5 :=
                   LPC43_SVD.C_CAN1.Arbitration_Bits_Unc;
      --  Access mask bits
      MASK      : IF_CMDMSK_R0_ENUM_6 := LPC43_SVD.C_CAN1.Mask_Bits_Unchanged;
   ...
   subtype IF_MSK_MSK15_0_Field is LPC43_SVD.UInt16;
   subtype IF_MSK_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype IF_MSK_MSK28_16_Field is LPC43_SVD.UInt13;
   subtype IF_MSK_RESERVED_Field_1 is LPC43_SVD.Bit;
   ...
   type IF_MSK_Register_1 is record
      ...
      --  Mask message direction
      MDIR       : IF_MSK20_ENUM := LPC43_SVD.C_CAN1.The_Message_Directio;
      --  Mask extend identifier
      MXTD       : IF_MSK20_ENUM_1 := LPC43_SVD.C_CAN1.The_Extended_Identif;
      --  Reserved
   ...
   subtype IF_ARB_ID15_0_Field is LPC43_SVD.UInt16;
   subtype IF_ARB_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype IF_ARB_ID28_16_Field is LPC43_SVD.UInt13;
   ...
   type IF_ARB_Register_1 is record
      ...
      --  Message direction
      DIR      : IF_ARB20_ENUM := LPC43_SVD.C_CAN1.Direction_Eq_Receive;
      --  Extend identifier
      XTD      : IF_ARB20_ENUM_1 := LPC43_SVD.C_CAN1.The_11_Bit_Standard;
      ...
      MSGVAL   : IF_ARB20_ENUM_2 := LPC43_SVD.C_CAN1.The_Message_Object_I_1;
      --  Reserved
      RESERVED : IF_ARB_RESERVED_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype IF_MCTRL_DLC3_0_Field is LPC43_SVD.UInt4;
   subtype IF_MCTRL_RESERVED_Field is LPC43_SVD.UInt3;
   ...
   subtype IF_MCTRL_RESERVED_Field_1 is LPC43_SVD.UInt16;
   ...
   type IF_MCTRL_Register is record
      ...
      --  End of buffer
      EOB        : IF_MCTRL0_ENUM := LPC43_SVD.C_CAN1.Message_Object_Belon;
      --  Transmit request
      TXRQST     : IF_MCTRL0_ENUM_1 := LPC43_SVD.C_CAN1.Wait;
      --  Remote enable
      RMTEN      : IF_MCTRL0_ENUM_2 := LPC43_SVD.C_CAN1.Unchanged;
      --  Receive interrupt enable
      RXIE       : IF_MCTRL0_ENUM_3 := LPC43_SVD.C_CAN1.Unchanged;
      --  Transmit interrupt enable
      TXIE       : IF_MCTRL0_ENUM_3 := LPC43_SVD.C_CAN1.Unchanged;
      ...
      UMASK      : IF_MCTRL0_ENUM_4 := LPC43_SVD.C_CAN1.Mask_Ignored;
      --  Interrupt pending
      INTPND     : IF_MCTRL0_ENUM_5 := LPC43_SVD.C_CAN1.Nointsource;
      --  Message lost (only valid for message objects in the direction
      --  receive).
      MSGLST     : IF_MCTRL0_ENUM_6 := LPC43_SVD.C_CAN1.No_Message_Lost_Sinc;
      --  New data
      NEWDAT     : IF_MCTRL0_ENUM_7 := LPC43_SVD.C_CAN1.No_New_Data_Has_Been;
      --  Reserved
   ...
   subtype IF_DA_DATA_Element is LPC43_SVD.Byte;
   ...
   subtype IF_DA_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype IF_DB_DATA_Element is LPC43_SVD.Byte;
   ...
   subtype IF_DB_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype TXREQ1_TXRQST16_1_Field is LPC43_SVD.UInt16;
   subtype TXREQ1_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype TXREQ2_TXRQST32_17_Field is LPC43_SVD.UInt16;
   subtype TXREQ2_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype ND1_NEWDAT16_1_Field is LPC43_SVD.UInt16;
   subtype ND1_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype ND2_NEWDAT32_17_Field is LPC43_SVD.UInt16;
   subtype ND2_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype IR1_INTPND16_1_Field is LPC43_SVD.UInt16;
   subtype IR1_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype IR2_INTPND32_17_Field is LPC43_SVD.UInt16;
   subtype IR2_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype MSGV1_MSGVAL16_1_Field is LPC43_SVD.UInt16;
   subtype MSGV1_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype MSGV2_MSGVAL32_17_Field is LPC43_SVD.UInt16;
   subtype MSGV2_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype CLKDIV_CLKDIVVAL_Field is LPC43_SVD.UInt4;
   subtype CLKDIV_RESERVED_Field is LPC43_SVD.UInt28;
