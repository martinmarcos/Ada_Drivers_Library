...
package LPC43_SVD.RITIMER is
   ...
   type CTRL_Register is record
      --  Interrupt flag
      RITINT   : CTRL_ENUM := LPC43_SVD.RITIMER.The_Counter_Value_Do;
      --  Timer enable clear
      RITENCLR : CTRL_ENUM_1 := LPC43_SVD.RITIMER.The_Timer_Will_Not_B;
      --  Timer enable for debug
      RITENBR  : CTRL_ENUM_2 := LPC43_SVD.RITIMER.The_Timer_Is_Halted;
      --  Timer enable.
      RITEN    : CTRL_ENUM_3 := LPC43_SVD.RITIMER.Timer_Enabled_This;
   ...
   type RITIMER_Peripheral is record
      --  Compare register
      COMPVAL : aliased LPC43_SVD.UInt32;
      ...
      MASK    : aliased LPC43_SVD.UInt32;
      --  Control register.
      CTRL    : aliased CTRL_Register;
      --  32-bit counter
      COUNTER : aliased LPC43_SVD.UInt32;
   end record
     with Volatile;
