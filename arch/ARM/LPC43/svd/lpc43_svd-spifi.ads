...
package LPC43_SVD.SPIFI is
   ...
   subtype CTRL_TIMEOUT_Field is LPC43_SVD.UInt16;
   subtype CTRL_CSHIGH_Field is LPC43_SVD.UInt4;
   subtype CTRL_RESERVED_Field is LPC43_SVD.Bit;
   subtype CTRL_D_PRFTCH_DIS_Field is LPC43_SVD.Bit;
   subtype CTRL_INTEN_Field is LPC43_SVD.Bit;
   ...
   subtype CTRL_RESERVED_Field_1 is LPC43_SVD.UInt3;
   ...
   subtype CTRL_DMAEN_Field is LPC43_SVD.Bit;
   ...
   type CTRL_Register is record
      ...
      --  SPI Mode 3 select.
      MODE3        : CTRL_ENUM := LPC43_SVD.SPIFI.Sck_Low;
      --  Reserved.
      ...
      PRFTCH_DIS   : CTRL_ENUM_1 := LPC43_SVD.SPIFI.Enable;
      --  Select dual protocol.
      DUAL         : CTRL_ENUM_2 := LPC43_SVD.SPIFI.Quad_Protocol;
      --  Select active clock edge for input data.
      RFCLK        : CTRL_ENUM_3 := LPC43_SVD.SPIFI.Rising_Edge;
      --  Feedback clock select.
      FBCLK        : CTRL_ENUM_4 := LPC43_SVD.SPIFI.Feedback_Clock;
   ...
   subtype CMD_DATALEN_Field is LPC43_SVD.UInt14;
   subtype CMD_POLL_Field is LPC43_SVD.Bit;
   ...
   subtype CMD_INTLEN_Field is LPC43_SVD.UInt3;
   ...
   subtype CMD_OPCODE_Field is LPC43_SVD.Byte;
   ...
   type CMD_Register is record
      ...
      --  the data:
      DOUT      : CMD_ENUM := LPC43_SVD.SPIFI.Input_From_Serial_Fl;
      ...
      --  This field controls how the fields of the command are sent.
      FIELDFORM : CMD_ENUM_1 := LPC43_SVD.SPIFI.All_Serial;
      --  This field controls the opcode and address fields.
      FRAMEFORM : CMD_ENUM_2 := LPC43_SVD.SPIFI.Reserved;
   ...
   subtype MCMD_RESERVED_Field is LPC43_SVD.UInt14;
   subtype MCMD_POLL_Field is LPC43_SVD.Bit;
   subtype MCMD_DOUT_Field is LPC43_SVD.Bit;
   subtype MCMD_INTLEN_Field is LPC43_SVD.UInt3;
   ...
   subtype MCMD_OPCODE_Field is LPC43_SVD.Byte;
   ...
   type MCMD_Register is record
      ...
      --  This field controls how the fields of the command are sent.
      FIELDFORM : MCMD_ENUM := LPC43_SVD.SPIFI.All_Serial;
      --  This field controls the opcode and address fields.
      FRAMEFORM : MCMD_ENUM_1 := LPC43_SVD.SPIFI.Reserved;
      --  The opcode of the command (not used for some FRAMEFORM values).
   ...
   subtype STAT_MCINIT_Field is LPC43_SVD.Bit;
   subtype STAT_CMD_Field is LPC43_SVD.Bit;
   subtype STAT_RESET_Field is LPC43_SVD.Bit;
   subtype STAT_INTRQ_Field is LPC43_SVD.Bit;
   subtype STAT_RESERVED_Field is LPC43_SVD.UInt18;
   subtype STAT_VERSION_Field is LPC43_SVD.Byte;
   ...
   type STAT_Register is record
      ...
      --  unspecified
      Reserved_2_3 : LPC43_SVD.UInt2 := 16#0#;
   ...
   type SPIFI_Peripheral is record
      ...
      ADDR   : aliased LPC43_SVD.UInt32;
      --  SPIFI intermediate data register
      IDATA  : aliased LPC43_SVD.UInt32;
      --  SPIFI cache limit register
      CLIMIT : aliased LPC43_SVD.UInt32;
      --  SPIFI data register
      DATA   : aliased LPC43_SVD.UInt32;
      --  SPIFI memory command register
