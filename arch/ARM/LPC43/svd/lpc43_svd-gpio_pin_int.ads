...
package LPC43_SVD.GPIO_PIN_INT is
   pragma Preelaborate;
   ...
   --  ISEL_PMODE array
   type ISEL_PMODE_Field_Array is array (0 .. 7) of Boolean
   ...
   subtype ISEL_RESERVED_Field is HAL.UInt24;
   ...
   --  IENR_ENRL array
   type IENR_ENRL_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype IENR_RESERVED_Field is HAL.UInt24;
   ...
   --  SIENR_SETENRL array
   type SIENR_SETENRL_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype SIENR_RESERVED_Field is HAL.UInt24;
   ...
   --  CIENR_CENRL array
   type CIENR_CENRL_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype CIENR_RESERVED_Field is HAL.UInt24;
   ...
   --  IENF_ENAF array
   type IENF_ENAF_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype IENF_RESERVED_Field is HAL.UInt24;
   ...
   --  SIENF_SETENAF array
   type SIENF_SETENAF_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype SIENF_RESERVED_Field is HAL.UInt24;
   ...
   --  CIENF_CENAF array
   type CIENF_CENAF_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype CIENF_RESERVED_Field is HAL.UInt24;
   ...
   --  RISE_RDET array
   type RISE_RDET_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype RISE_RESERVED_Field is HAL.UInt24;
   ...
   --  FALL_FDET array
   type FALL_FDET_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype FALL_RESERVED_Field is HAL.UInt24;
   ...
   --  IST_PSTAT array
   type IST_PSTAT_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype IST_RESERVED_Field is HAL.UInt24;
