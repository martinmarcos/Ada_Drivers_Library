...
package LPC43_SVD.UART1 is
   ...
   subtype MCR_RESERVED_Field is HAL.UInt2;
   ...
   subtype MCR_RESERVED_Field_1 is HAL.UInt24;
   ...
   type MCR_Register is record
      ...
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_2 : MCR_RESERVED_Field_1 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype LSR_RESERVED_Field is HAL.UInt24;
   ...
   subtype MSR_RESERVED_Field is HAL.UInt24;
