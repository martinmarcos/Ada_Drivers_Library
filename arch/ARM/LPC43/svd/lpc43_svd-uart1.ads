...
package LPC43_SVD.UART1 is
   ...
   subtype IER_RESERVED_Field is LPC43_SVD.UInt3;
   subtype IER_RESERVED_Field_1 is LPC43_SVD.UInt22;
   ...
   type IER_Register is record
      ...
      CTSIE      : IER_ENUM := LPC43_SVD.UART1.Disable;
      --  Enables the end of auto-baud interrupt.
      ABEOIE     : IER_ENUM := LPC43_SVD.UART1.Disable;
      --  Enables the auto-baud time-out interrupt.
      ABTOIE     : IER_ENUM := LPC43_SVD.UART1.Disable;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type FCR_Register is record
      ...
      FIFOEN     : FCR_ENUM := LPC43_SVD.UART1.Disabled;
      --  Write-only. RX FIFO Reset.
      RXFIFORES  : FCR_ENUM_1 := LPC43_SVD.UART1.No_Effect;
      --  Write-only. TX FIFO Reset.
      TXFIFORES  : FCR_ENUM_1 := LPC43_SVD.UART1.No_Effect;
      ...
      --  activated.
      RXTRIGLVL  : FCR_ENUM_2 := LPC43_SVD.UART1.Level_0;
      --  Write-only. Reserved, user software should not write ones to reserved
      --  bits.
   ...
   type LCR_Register is record
      --  Word Length Select.
      WLS      : LCR_ENUM := LPC43_SVD.UART1.LCR_ENUM_5_Bit_Character_Leng;
      --  Stop Bit Select.
      SBS      : LCR_ENUM_1 := LPC43_SVD.UART1.LCR_ENUM_1_Stop_Bit;
      --  Parity Enable.
      PE       : LCR_ENUM_2 := LPC43_SVD.UART1.Disable_Parity_Gener;
      --  Parity Select.
      PS       : LCR_ENUM_3 := LPC43_SVD.UART1.Odd_Parity;
      --  Break Control.
      BC       : LCR_ENUM_4 := LPC43_SVD.UART1.Disabled;
      --  Divisor Latch Access Bit (DLAB)
      DLAB     : LCR_ENUM_4 := LPC43_SVD.UART1.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype MCR_DTRCTRL_Field is LPC43_SVD.Bit;
   subtype MCR_RTSCTRL_Field is LPC43_SVD.Bit;
   subtype MCR_RESERVED_Field is LPC43_SVD.UInt2;
   ...
   subtype MCR_RESERVED_Field_1 is LPC43_SVD.Bit;
   subtype MCR_RESERVED_Field_2 is LPC43_SVD.UInt24;
   ...
   type MCR_Register is record
      ...
      LMS        : MCR_ENUM := LPC43_SVD.UART1.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_1 : MCR_RESERVED_Field_1 := 16#0#;
      --  RTS enable.
      RTSEN      : MCR_ENUM := LPC43_SVD.UART1.Disabled;
      --  CTS enable.
      CTSEN      : MCR_ENUM := LPC43_SVD.UART1.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype LSR_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype MSR_CTS_Field is LPC43_SVD.Bit;
   subtype MSR_DSR_Field is LPC43_SVD.Bit;
   subtype MSR_RI_Field is LPC43_SVD.Bit;
   subtype MSR_DCD_Field is LPC43_SVD.Bit;
   subtype MSR_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   type ACR_Register is record
      ...
      START       : ACR_ENUM := LPC43_SVD.UART1.Stop;
      --  Auto-baud mode select bit.
      MODE        : ACR_ENUM_1 := LPC43_SVD.UART1.Mode_0;
      --  Auto-baud restart bit.
      AUTORESTART : ACR_ENUM_2 := LPC43_SVD.UART1.No_Restart;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED    : ACR_RESERVED_Field := 16#0#;
      --  End of auto-baud interrupt clear bit (write-only).
      ABEOINTCLR  : ACR_ENUM_3 := LPC43_SVD.UART1.No_Effect;
      --  Auto-baud time-out interrupt clear bit (write-only).
      ABTOINTCLR  : ACR_ENUM_3 := LPC43_SVD.UART1.No_Effect;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype RS485CTRL_RESERVED_Field is LPC43_SVD.UInt26;
   ...
   type RS485CTRL_Register is record
      --  Multidrop mode select.
      NMMEN    : RS485CTRL_ENUM := LPC43_SVD.UART1.Disabled;
      --  Receive enable.
      RXDIS    : RS485CTRL_ENUM_1 := LPC43_SVD.UART1.Enabled;
      --  Auto Address Detect enable.
      AADEN    : RS485CTRL_ENUM := LPC43_SVD.UART1.Disabled;
      --  Direction control.
      SEL      : RS485CTRL_ENUM_2 := LPC43_SVD.UART1.Rts;
      --  Direction control enable.
      DCTRL    : RS485CTRL_ENUM := LPC43_SVD.UART1.Disabled;
      --  Polarity. This bit reverses the polarity of the direction control
      --  signal on the RTS (or DTR) pin.
      OINV     : RS485CTRL_ENUM_3 := LPC43_SVD.UART1.Low;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
