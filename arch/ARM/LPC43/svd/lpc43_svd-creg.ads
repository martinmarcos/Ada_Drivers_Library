...
package LPC43_SVD.CREG is
   ...
   subtype CREG0_RESERVED_Field is LPC43_SVD.Bit;
   ...
   subtype CREG0_RESERVED_Field_1 is LPC43_SVD.UInt14;
   ...
   type CREG0_Register is record
      --  Enable 1 kHz output.
      EN1KHZ      : CREG0_ENUM :=
                     LPC43_SVD.CREG.CREG0_ENUM_1_Khz_Output_Disable;
      --  Enable 32 kHz output
      EN32KHZ     : CREG0_ENUM_1 :=
                     LPC43_SVD.CREG.CREG0_ENUM_32_Khz_Output_Disabl;
      --  32 kHz oscillator reset
      RESET32KHZ  : CREG0_ENUM_2 := LPC43_SVD.CREG.Clear_Reset;
      --  32 kHz power control.
      PD32KHZ     : CREG0_ENUM_3 := LPC43_SVD.CREG.Powered;
      --  Reserved
      RESERVED    : CREG0_RESERVED_Field := 16#0#;
      --  USB0 PHY power control.
      USB0PHY     : CREG0_ENUM_4 := LPC43_SVD.CREG.Enable_Usb0_Phy_Powe;
      --  RTC_ALARM pin output control
      ALARMCTRL   : CREG0_ENUM_5 := LPC43_SVD.CREG.Rtc_Alarm;
      --  BOD trip level to generate an interrupt. See the LPC43xx data sheets
      --  for the trip values.
      BODLVL1     : CREG0_ENUM_6 := LPC43_SVD.CREG.Level_0_Interrupt;
      --  BOD trip level to generate a reset. See the LPC43xx data sheets for
      --  the trip values.
      BODLVL2     : CREG0_ENUM_7 := LPC43_SVD.CREG.Level_0_Reset;
      --  SAMPLE pin input/output control
      SAMPLECTRL  : CREG0_ENUM_8 := LPC43_SVD.CREG.Reserved;
      --  WAKEUP0 pin input/output control
      WAKEUP0CTRL : CREG0_ENUM_9 := LPC43_SVD.CREG.Input_To_The_Event_R;
      --  WAKEUP1 pin input/output control
      WAKEUP1CTRL : CREG0_ENUM_10 := LPC43_SVD.CREG.Input_To_Event_Route;
      --  Reserved
   ...
   subtype M4MEMMAP_M4MAP_Field is LPC43_SVD.UInt20;

   --  ARM Cortex-M4 memory mapping
   type M4MEMMAP_Register is record
      --  unspecified
      Reserved_0_11 : LPC43_SVD.UInt12 := 16#0#;
   ...
   subtype CREG5_RESERVED_Field is LPC43_SVD.UInt10;
   ...
   subtype CREG5_RESERVED_Field_1 is LPC43_SVD.UInt19;
   ...
   type CREG5_Register is record
      ...
      M0SUBTAPSEL : CREG5_ENUM := LPC43_SVD.CREG.No_Effect;
      --  JTAG debug disable for M4 main processor. If this bit is set to 1, it
      --  can be changed to 0 only through a chip reset.
      M4TAPSEL    : CREG5_ENUM := LPC43_SVD.CREG.No_Effect;
      --  JTAG debug disable for M0APPco-processor. If this bit is set to 1, it
      --  can be changed to 0 only through a chip reset.
      M0APPTAPSEL : CREG5_ENUM := LPC43_SVD.CREG.No_Effect;
      --  Reserved.
   ...
   type DMAMUX_Register is record
      --  Select DMA to peripheral connection for DMA peripheral 0.
      DMAMUXPER0  : DMAMUX_ENUM := LPC43_SVD.CREG.Spifi;
      --  Select DMA to peripheral connection for DMA peripheral 1
      DMAMUXPER1  : DMAMUX_ENUM_1 := LPC43_SVD.CREG.Timer0_Match_0;
      --  Select DMA to peripheral connection for DMA peripheral 2.
      DMAMUXPER2  : DMAMUX_ENUM_2 := LPC43_SVD.CREG.Timer0_Match_1;
      --  Select DMA to peripheral connection for DMA peripheral 3.
      DMAMUXPER3  : DMAMUX_ENUM_3 := LPC43_SVD.CREG.Timer1_Match_0;
      --  Select DMA to peripheral connection for DMA peripheral 4.
      DMAMUXPER4  : DMAMUX_ENUM_4 := LPC43_SVD.CREG.Timer1_Match_1;
      --  Select DMA to peripheral connection for DMA peripheral 5.
      DMAMUXPER5  : DMAMUX_ENUM_5 := LPC43_SVD.CREG.Timer2_Match_0;
      --  Selects DMA to peripheral connection for DMA peripheral 6.
      DMAMUXPER6  : DMAMUX_ENUM_6 := LPC43_SVD.CREG.Timer2_Match_1;
      --  Selects DMA to peripheral connection for DMA peripheral 7.
      DMAMUXPER7  : DMAMUX_ENUM_7 := LPC43_SVD.CREG.Timer3_Match_0;
      --  Select DMA to peripheral connection for DMA peripheral 8.
      DMAMUXPER8  : DMAMUX_ENUM_8 := LPC43_SVD.CREG.Timer3_Match_1;
      --  Select DMA to peripheral connection for DMA peripheral 9.
      DMAMUXPER9  : DMAMUX_ENUM_9 := LPC43_SVD.CREG.Ssp0_Receive;
      --  Select DMA to peripheral connection for DMA peripheral 10.
      DMAMUXPER10 : DMAMUX_ENUM_10 := LPC43_SVD.CREG.Ssp0_Transmit;
      --  Selects DMA to peripheral connection for DMA peripheral 11.
      DMAMUXPER11 : DMAMUX_ENUM_11 := LPC43_SVD.CREG.Ssp1_Receive;
      --  Select DMA to peripheral connection for DMA peripheral 12.
      DMAMUXPER12 : DMAMUX_ENUM_12 := LPC43_SVD.CREG.Ssp1_Transmit;
      --  Select DMA to peripheral connection for DMA peripheral 13.
      DMAMUXPER13 : DMAMUX_ENUM_13 := LPC43_SVD.CREG.Adc0;
      --  Select DMA to peripheral connection for DMA peripheral 14.
      DMAMUXPER14 : DMAMUX_ENUM_14 := LPC43_SVD.CREG.Adc1;
      --  Select DMA to peripheral connection for DMA peripheral 15.
      DMAMUXPER15 : DMAMUX_ENUM_15 := LPC43_SVD.CREG.Dac;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype FLASHCFGA_RESERVED_Field is LPC43_SVD.UInt12;
   ...
   subtype FLASHCFGA_RESERVED_Field_1 is LPC43_SVD.UInt15;
   ...
   type FLASHCFGA_Register is record
      ...
      --  Flash bank A power control
      POW        : FLASHCFGA_ENUM_1 := LPC43_SVD.CREG.Active;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype FLASHCFGB_RESERVED_Field is LPC43_SVD.UInt12;
   ...
   subtype FLASHCFGB_RESERVED_Field_1 is LPC43_SVD.UInt15;
   ...
   type FLASHCFGB_Register is record
      ...
      --  Flash bank A power control
      POW        : FLASHCFGB_ENUM_1 := LPC43_SVD.CREG.Active;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype ETBCFG_RESERVED_Field is LPC43_SVD.UInt31;

   --  ETB RAM configuration
   type ETBCFG_Register is record
      --  Select SRAM interface
      ETB      : ETBCFG_ENUM := LPC43_SVD.CREG.Ahb_Accesses_Sram_At;
      --  Reserved.
   ...
   subtype CREG6_RESERVED_Field is LPC43_SVD.Bit;
   ...
   subtype CREG6_RESERVED_Field_1 is LPC43_SVD.UInt7;
   ...
   subtype CREG6_RESERVED_Field_2 is LPC43_SVD.UInt15;
   ...
   type CREG6_Register is record
      --  Selects the Ethernet mode. Reset the ethernet after changing the PHY
      --  interface. All other settings are reserved.
      ETHMODE            : CREG6_ENUM := LPC43_SVD.CREG.Mii;
      --  Reserved.
      RESERVED           : CREG6_RESERVED_Field := 16#0#;
      --  Selects the functionality of the SCT outputs.
      CTOUTCTRL          : CREG6_ENUM_1 :=
                            LPC43_SVD.CREG.Combine_Sct_And_Time;
      --  Reserved.
      RESERVED_1         : CREG6_RESERVED_Field_1 := 16#0#;
      --  I2S0_TX_SCK input select
      I2S0_TX_SCK_IN_SEL : CREG6_ENUM_2 := LPC43_SVD.CREG.I2S_Register;
      --  I2S0_RX_SCK input select
      I2S0_RX_SCK_IN_SEL : CREG6_ENUM_2 := LPC43_SVD.CREG.I2S_Register;
      --  I2S1_TX_SCK input select
      I2S1_TX_SCK_IN_SEL : CREG6_ENUM_2 := LPC43_SVD.CREG.I2S_Register;
      --  I2S1_RX_SCK input select
      I2S1_RX_SCK_IN_SEL : CREG6_ENUM_2 := LPC43_SVD.CREG.I2S_Register;
      --  EMC_CLK divided clock select (see Section 21.1).
      EMC_CLK_SEL        : CREG6_ENUM_3 := LPC43_SVD.CREG.Divide_By_1;
      --  Reserved.
   ...
   subtype M4TXEVENT_RESERVED_Field is LPC43_SVD.UInt31;

   --  Cortex-M4 TXEV event clear
   type M4TXEVENT_Register is record
      --  Cortex-M4 TXEV event.
      TXEVCLR  : M4TXEVENT_ENUM := LPC43_SVD.CREG.Clear_The_Txev_Event;
      --  Reserved.
   ...
   subtype M0SUBMEMMAP_M0SUBMAP_Field is LPC43_SVD.UInt20;
   ...
   subtype M0SUBTXEVENT_RESERVED_Field is LPC43_SVD.UInt31;

   --  Cortex-M0SUB TXEV event clear
   type M0SUBTXEVENT_Register is record
      --  Cortex-M0SUB TXEV event handling.
      TXEVCLR  : M0SUBTXEVENT_ENUM := LPC43_SVD.CREG.Clear_The_Txev_Event;
      --  Reserved.
   ...
   subtype M0APPTXEVENT_RESERVED_Field is LPC43_SVD.UInt31;

   --  Cortex-M0APP TXEV event clear
   type M0APPTXEVENT_Register is record
      --  Cortex-M0APP TXEV event handling.
      TXEVCLR  : M0APPTXEVENT_ENUM := LPC43_SVD.CREG.Clear_The_Txev_Event;
      --  Reserved.
   ...
   subtype M0APPMEMMAP_M0APPMAP_Field is LPC43_SVD.UInt20;
   ...
   subtype USB0FLADJ_FLTV_Field is LPC43_SVD.UInt6;
   subtype USB0FLADJ_RESERVED_Field is LPC43_SVD.UInt26;
   ...
   subtype USB1FLADJ_FLTV_Field is LPC43_SVD.UInt6;
   subtype USB1FLADJ_RESERVED_Field is LPC43_SVD.UInt26;
   ...
   type CREG_Peripheral is record
      ...
      --  Part ID
      CHIPID       : aliased LPC43_SVD.UInt32;
      --  ARM Cortex-M0SUB memory mapping
