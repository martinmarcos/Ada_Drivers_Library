...
package LPC43_SVD.USB0 is
   ...
   subtype CAPLENGTH_CAPLENGTH_Field is LPC43_SVD.Byte;
   subtype CAPLENGTH_HCIVERSION_Field is LPC43_SVD.UInt16;
   subtype CAPLENGTH_RESERVED_Field is LPC43_SVD.Byte;
   ...
   subtype HCSPARAMS_N_PORTS_Field is LPC43_SVD.UInt4;
   subtype HCSPARAMS_PPC_Field is LPC43_SVD.Bit;
   subtype HCSPARAMS_RESERVED_Field is LPC43_SVD.UInt3;
   subtype HCSPARAMS_N_PCC_Field is LPC43_SVD.UInt4;
   subtype HCSPARAMS_N_CC_Field is LPC43_SVD.UInt4;
   subtype HCSPARAMS_PI_Field is LPC43_SVD.Bit;
   subtype HCSPARAMS_N_PTT_Field is LPC43_SVD.UInt4;
   subtype HCSPARAMS_N_TT_Field is LPC43_SVD.UInt4;
   subtype HCSPARAMS_RESERVED_Field_1 is LPC43_SVD.UInt4;
   ...
   subtype HCCPARAMS_ADC_Field is LPC43_SVD.Bit;
   subtype HCCPARAMS_PFL_Field is LPC43_SVD.Bit;
   subtype HCCPARAMS_ASP_Field is LPC43_SVD.Bit;
   subtype HCCPARAMS_IST_Field is LPC43_SVD.UInt4;
   subtype HCCPARAMS_EECP_Field is LPC43_SVD.Byte;
   subtype HCCPARAMS_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype DCIVERSION_DCIVERSION_Field is LPC43_SVD.UInt16;
   ...
   type DCIVERSION_Register is record
      ...
      --  unspecified
      Reserved_16_31 : LPC43_SVD.UInt16;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype USBCMD_D_RESERVED_Field is LPC43_SVD.UInt2;
   --  USBCMD_D_RESERVED array element
   subtype USBCMD_D_RESERVED_Element is LPC43_SVD.Bit;
   ...
   subtype USBCMD_D_SUTW_Field is LPC43_SVD.Bit;
   subtype USBCMD_D_ATDTW_Field is LPC43_SVD.Bit;
   subtype USBCMD_D_RESERVED_Field_3 is LPC43_SVD.Bit;
   subtype USBCMD_D_ITC_Field is LPC43_SVD.Byte;
   subtype USBCMD_D_RESERVED_Field_4 is LPC43_SVD.Byte;

   --  USB command (device mode)
   type USBCMD_D_Register is record
      --  Run/Stop
      RS         : USBCMD_D_ENUM := LPC43_SVD.USB0.Detach;
      ...
      RST        : USBCMD_D_ENUM_1 := LPC43_SVD.USB0.Resetcomplete;
   ...
   subtype USBCMD_H_FS_Element is LPC43_SVD.Bit;
   ...
   subtype USBCMD_H_RESERVED_Field is LPC43_SVD.Bit;
   subtype USBCMD_H_ASP1_0_Field is LPC43_SVD.UInt2;
   ...
   subtype USBCMD_H_RESERVED_Element is LPC43_SVD.Bit;
   ...
   subtype USBCMD_H_FS2_Field is LPC43_SVD.Bit;
   subtype USBCMD_H_ITC_Field is LPC43_SVD.Byte;
   subtype USBCMD_H_RESERVED_Field_2 is LPC43_SVD.Byte;

   --  USB command (host mode)
   type USBCMD_H_Register is record
      --  Run/Stop
      RS         : USBCMD_H_ENUM := LPC43_SVD.USB0.Halt;
      --  Controller reset. Software uses this bit to reset the controller.
      --  This bit is set to zero by the Host/Device Controller when the reset
      --  process is complete. Software cannot terminate the reset process
      --  early by writing a zero to this register.
      RST        : USBCMD_H_ENUM_1 := LPC43_SVD.USB0.Resetcomplete;
      ...
      --  This bit controls whether the host controller skips processing the
      --  periodic schedule.
      PSE        : USBCMD_H_ENUM_2 := LPC43_SVD.USB0.Do_Not_Process_The_P;
      --  This bit controls whether the host controller skips processing the
      --  asynchronous schedule.
      ASE        : USBCMD_H_ENUM_3 := LPC43_SVD.USB0.Do_Not_Process_The_A;
      --  This bit is used as a doorbell by software to tell the host
      --  controller to issue an interrupt the next time it advances
      --  asynchronous schedule.
      IAA        : USBCMD_H_ENUM_4 := LPC43_SVD.USB0.The_Host_Controller;
      --  Reserved
      ...
      --  Asynchronous Schedule Park Mode Enable
      ASPE       : USBCMD_H_ENUM_5 := LPC43_SVD.USB0.Park_Mode_Is_Disable;
      --  Reserved.
   ...
   subtype USBSTS_D_RESERVED_Element is LPC43_SVD.Bit;
   ...
   subtype USBSTS_D_AAI_Field is LPC43_SVD.Bit;
   subtype USBSTS_D_RESERVED_Field_1 is LPC43_SVD.UInt3;
   ...
   subtype USBSTS_D_RESERVED_Field_4 is LPC43_SVD.UInt12;

   --  USB status (device mode)
   type USBSTS_D_Register is record
      --  USB interrupt
      UI         : USBSTS_D_ENUM := LPC43_SVD.USB0.St;
      --  USB error interrupt
      UEI        : USBSTS_D_ENUM := LPC43_SVD.USB0.St;
      --  Port change detect.
      PCI        : USBSTS_D_ENUM := LPC43_SVD.USB0.St;
      --  Not used in Device mode.
      ...
      --  USB reset received
      URI        : USBSTS_D_ENUM := LPC43_SVD.USB0.St;
      --  SOF received
      SRI        : USBSTS_D_ENUM := LPC43_SVD.USB0.St;
      --  DCSuspend
      SLI        : USBSTS_D_ENUM := LPC43_SVD.USB0.St;
      ...
      RESERVED_2 : USBSTS_D_RESERVED_Field_2 :=
                    (As_Array => False, Val => 16#0#);
      --  NAK interrupt bit
      NAKI       : USBSTS_D_ENUM := LPC43_SVD.USB0.St;
      --  Reserved. Software should only write 0 to reserved bits.
   ...
   subtype USBSTS_H_RESERVED_Field is LPC43_SVD.Bit;
   subtype USBSTS_H_RESERVED_Field_1 is LPC43_SVD.UInt3;
   ...
   subtype USBSTS_H_RESERVED_Element is LPC43_SVD.Bit;
   ...
   subtype USBSTS_H_RESERVED_Field_3 is LPC43_SVD.UInt12;

   --  USB status (host mode)
   type USBSTS_H_Register is record
      --  USB interrupt (USBINT)
      UI         : USBSTS_H_ENUM := LPC43_SVD.USB0.St;
      --  USB error interrupt (USBERRINT)
      UEI        : USBSTS_H_ENUM := LPC43_SVD.USB0.St;
      --  Port change detect.
      PCI        : USBSTS_H_ENUM := LPC43_SVD.USB0.St;
      --  Frame list roll-over
      FRI        : USBSTS_H_ENUM := LPC43_SVD.USB0.St;
      --  Reserved.
      RESERVED   : USBSTS_H_RESERVED_Field := 16#0#;
      --  Interrupt on async advance
      AAI        : USBSTS_H_ENUM := LPC43_SVD.USB0.St;
      --  Not used by the Host controller.
      RESERVED_1 : USBSTS_H_RESERVED_Field := 16#0#;
      --  SOF received
      SRI        : USBSTS_H_ENUM := LPC43_SVD.USB0.St;
      --  Not used by the Host controller.
      RESERVED_2 : USBSTS_H_RESERVED_Field := 16#0#;
      --  Reserved.
      RESERVED_3 : USBSTS_H_RESERVED_Field_1 := 16#0#;
      --  HCHalted
      HCH        : USBSTS_H_ENUM_1 := LPC43_SVD.USB0.Rs;
      --  Reclamation
      RCL        : USBSTS_H_ENUM_2 := LPC43_SVD.USB0.No_Empty_Asynchronou;
      ...
      PS         : USBSTS_H_ENUM_3 := LPC43_SVD.USB0.Disabled;
   ...
   subtype USBINTR_D_UE_Field is LPC43_SVD.Bit;
   subtype USBINTR_D_UEE_Field is LPC43_SVD.Bit;
   subtype USBINTR_D_PCE_Field is LPC43_SVD.Bit;
   --  USBINTR_D_RESERVED array element
   subtype USBINTR_D_RESERVED_Element is LPC43_SVD.Bit;
   ...
   subtype USBINTR_D_URE_Field is LPC43_SVD.Bit;
   subtype USBINTR_D_SRE_Field is LPC43_SVD.Bit;
   subtype USBINTR_D_SLE_Field is LPC43_SVD.Bit;
   subtype USBINTR_D_RESERVED_Field_1 is LPC43_SVD.UInt7;
   subtype USBINTR_D_NAKE_Field is LPC43_SVD.Bit;
   subtype USBINTR_D_RESERVED_Field_2 is LPC43_SVD.UInt12;
   ...
   subtype USBINTR_H_UE_Field is LPC43_SVD.Bit;
   subtype USBINTR_H_UEE_Field is LPC43_SVD.Bit;
   subtype USBINTR_H_PCE_Field is LPC43_SVD.Bit;
   subtype USBINTR_H_FRE_Field is LPC43_SVD.Bit;
   subtype USBINTR_H_RESERVED_Field is LPC43_SVD.Bit;
   subtype USBINTR_H_AAE_Field is LPC43_SVD.Bit;
   subtype USBINTR_H_SRE_Field is LPC43_SVD.Bit;
   subtype USBINTR_H_RESERVED_Field_1 is LPC43_SVD.UInt7;
   --  USBINTR_H_RESERVED array element
   subtype USBINTR_H_RESERVED_Element is LPC43_SVD.Bit;
   ...
   subtype USBINTR_H_UAIE_Field is LPC43_SVD.Bit;
   subtype USBINTR_H_UPIA_Field is LPC43_SVD.Bit;
   subtype USBINTR_H_RESERVED_Field_3 is LPC43_SVD.UInt12;
   ...
   subtype FRINDEX_D_FRINDEX2_0_Field is LPC43_SVD.UInt3;
   subtype FRINDEX_D_FRINDEX13_3_Field is LPC43_SVD.UInt11;
   subtype FRINDEX_D_RESERVED_Field is LPC43_SVD.UInt18;
   ...
   subtype FRINDEX_H_FRINDEX2_0_Field is LPC43_SVD.UInt3;
   subtype FRINDEX_H_FRINDEX12_3_Field is LPC43_SVD.UInt10;
   subtype FRINDEX_H_RESERVED_Field is LPC43_SVD.UInt19;
   ...
   subtype DEVICEADDR_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype DEVICEADDR_USBADR_Field is LPC43_SVD.UInt7;
   ...
   type DEVICEADDR_Register is record
      ...
      --  Device address advance
      USBADRA  : DEVICEADDR_ENUM := LPC43_SVD.USB0.Instantaneous;
      --  USB device address
   ...
   subtype PERIODICLISTBASE_RESERVED_Field is LPC43_SVD.UInt12;
   subtype PERIODICLISTBASE_PERBASE31_12_Field is LPC43_SVD.UInt20;
   ...
   subtype ENDPOINTLISTADDR_RESERVED_Field is LPC43_SVD.UInt11;
   subtype ENDPOINTLISTADDR_EPBASE31_11_Field is LPC43_SVD.UInt21;
   ...
   subtype ASYNCLISTADDR_RESERVED_Field is LPC43_SVD.UInt5;
   subtype ASYNCLISTADDR_ASYBASE31_5_Field is LPC43_SVD.UInt27;
   ...
   subtype TTCTRL_RESERVED_Field is LPC43_SVD.UInt24;
   subtype TTCTRL_TTHA_Field is LPC43_SVD.UInt7;
   subtype TTCTRL_RESERVED_Field_1 is LPC43_SVD.Bit;
   ...
   subtype BURSTSIZE_RXPBURST_Field is LPC43_SVD.Byte;
   subtype BURSTSIZE_TXPBURST_Field is LPC43_SVD.Byte;
   subtype BURSTSIZE_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype TXFILLTUNING_TXSCHOH_Field is LPC43_SVD.Byte;
   subtype TXFILLTUNING_TXSCHEATLTH_Field is LPC43_SVD.UInt5;
   subtype TXFILLTUNING_RESERVED_Field is LPC43_SVD.UInt3;
   subtype TXFILLTUNING_TXFIFOTHRES_Field is LPC43_SVD.UInt6;
   subtype TXFILLTUNING_RESERVED_Field_1 is LPC43_SVD.UInt10;
   ...
   subtype BINTERVAL_BINT_Field is LPC43_SVD.UInt4;
   subtype BINTERVAL_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype ENDPTNAK_EPRN_Element is LPC43_SVD.Bit;
   ...
   subtype ENDPTNAK_RESERVED_Field is LPC43_SVD.UInt10;
   --  ENDPTNAK_EPTN array element
   subtype ENDPTNAK_EPTN_Element is LPC43_SVD.Bit;
   ...
   subtype ENDPTNAKEN_EPRNE_Element is LPC43_SVD.Bit;
   ...
   subtype ENDPTNAKEN_RESERVED_Field is LPC43_SVD.UInt10;
   --  ENDPTNAKEN_EPTNE array element
   subtype ENDPTNAKEN_EPTNE_Element is LPC43_SVD.Bit;
   ...
   subtype PORTSC1_D_RESERVED_Field is LPC43_SVD.Bit;
   subtype PORTSC1_D_PE_Field is LPC43_SVD.Bit;
   subtype PORTSC1_D_PEC_Field is LPC43_SVD.Bit;
   subtype PORTSC1_D_RESERVED_Field_1 is LPC43_SVD.UInt2;
   ...
   subtype PORTSC1_D_RESERVED_Element is LPC43_SVD.Bit;
   ...
   subtype PORTSC1_D_RESERVED_Field_4 is LPC43_SVD.UInt4;

   --  Port 1 status/control (device mode)
   type PORTSC1_D_Register is record
      --  Current connect status
      CCS        : PORTSC1_D_ENUM := LPC43_SVD.USB0.Device_Not_Attached;
      --  Not used in device mode
      ...
      --  one as well.
      FPR        : PORTSC1_D_ENUM_1 := LPC43_SVD.USB0.No_Resume;
      --  Suspend In device mode, this is a read-only status bit .
      SUSP       : PORTSC1_D_ENUM_2 := LPC43_SVD.USB0.Port_Not_In_Suspend;
      --  Port reset In device mode, this is a read-only status bit. A device
      --  reset from the USB bus is also indicated in the USBSTS register.
      PR         : PORTSC1_D_ENUM_3 := LPC43_SVD.USB0.Port_Is_Not_In_The_R;
      --  High-speed status This bit is redundant with bits 27:26 (PSPD) in
      --  this register. It is implemented for compatibility reasons.
      HSP        : PORTSC1_D_ENUM_4 := LPC43_SVD.USB0.Not_Highsspeed;
      --  Not used in device mode.
      ...
      --  Port indicator control Writing to this field effects the value of the
      --  USB0_IND[1:0] pins.
      PIC1_0     : PORTSC1_D_ENUM_5 := LPC43_SVD.USB0.Off;
      ...
      PTC3_0     : PORTSC1_D_ENUM_6 := LPC43_SVD.USB0.Test_Mode_Disable;
      ...
      PHCD       : PORTSC1_D_ENUM_7 := LPC43_SVD.USB0.Enable;
      --  Port force full speed connect
      PFSC       : PORTSC1_D_ENUM_8 := LPC43_SVD.USB0.Anyspeed;
      --  reserved
      RESERVED_5 : PORTSC1_D_RESERVED_Field := 16#0#;
      --  Port speed This register field indicates the speed at which the port
      --  is operating.
      PSPD       : PORTSC1_D_ENUM_9 := LPC43_SVD.USB0.Full_Speed;
      --  Reserved
   ...
   subtype PORTSC1_H_OCC_Field is LPC43_SVD.Bit;
   ...
   subtype PORTSC1_H_RESERVED_Field is LPC43_SVD.Bit;
   ...
   type PORTSC1_H_Register is record
      ...
      CCS            : PORTSC1_H_ENUM := LPC43_SVD.USB0.No_Device_Is_Present;
      --  Connect status change Indicates a change has occurred in the port's
      ...
      CSC            : PORTSC1_H_ENUM_1 :=
                        LPC43_SVD.USB0.No_Change_In_Current;
      ...
      PE             : PORTSC1_H_ENUM_2 := LPC43_SVD.USB0.Port_Disabled;
      ...
      PEC            : PORTSC1_H_ENUM_3 := LPC43_SVD.USB0.No_Change;
      ...
      OCA            : PORTSC1_H_ENUM_4 :=
                        LPC43_SVD.USB0.The_Port_Does_Not_Ha;
      ...
      --  (Port Power bit) is 0.
      FPR            : PORTSC1_H_ENUM_5 := LPC43_SVD.USB0.No_Resume;
      ...
      SUSP           : PORTSC1_H_ENUM_6 := LPC43_SVD.USB0.Port_Not_In_Suspend;
      ...
      --  Power bit) is 0.
      PR             : PORTSC1_H_ENUM_7 :=
                        LPC43_SVD.USB0.Port_Is_Not_In_The_R;
      --  High-speed status
      HSP            : PORTSC1_H_ENUM_8 := LPC43_SVD.USB0.No_Hispeed;
      ...
      LS             : PORTSC1_H_ENUM_9 := LPC43_SVD.USB0.Se0;
      --  Port power control Host/OTG controller requires port power control
      ...
      PP             : PORTSC1_H_ENUM_10 := LPC43_SVD.USB0.Port_Power_Off;
      --  Reserved
      RESERVED       : PORTSC1_H_RESERVED_Field := 16#0#;
      --  Port indicator control Writing to this field effects the value of the
      --  pins USB0_IND1 and USB0_IND0.
      PIC1_0         : PORTSC1_H_ENUM_11 :=
                        LPC43_SVD.USB0.Port_Indicators_Are;
      --  Port test control Any value other than 0000 indicates that the port
      --  is operating in test mode. The FORCE_ENABLE_FS and FORCE ENABLE_LS
      --  are extensions to the test mode support specified in the EHCI
      --  specification. Writing the PTC field to any of the
      ...
      PTC3_0         : PORTSC1_H_ENUM_12 := LPC43_SVD.USB0.Test_Mode_Disable;
      --  Wake on connect enable (WKCNNT_E) This bit is 0 if PP (Port Power
      --  bit) is 0
      WKCN           : PORTSC1_H_ENUM_13 :=
                        LPC43_SVD.USB0.Disables_The_Port_To;
      ...
      PHCD           : PORTSC1_H_ENUM_15 :=
                        LPC43_SVD.USB0.Writing_A_0_Enables;
      --  Port force full speed connect
      PFSC           : PORTSC1_H_ENUM_16 :=
                        LPC43_SVD.USB0.Port_Connects_At_Any;
      --  Reserved
      ...
      PSPD           : PORTSC1_H_ENUM_17 := LPC43_SVD.USB0.Full_Speed;
      --  unspecified
      Reserved_28_31 : LPC43_SVD.UInt4 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTGSC_VD_Field is LPC43_SVD.Bit;
   subtype OTGSC_VC_Field is LPC43_SVD.Bit;
   ...
   subtype OTGSC_OT_Field is LPC43_SVD.Bit;
   subtype OTGSC_DP_Field is LPC43_SVD.Bit;
   ...
   subtype OTGSC_HADP_Field is LPC43_SVD.Bit;
   ...
   subtype OTGSC_AVV_Field is LPC43_SVD.Bit;
   subtype OTGSC_ASV_Field is LPC43_SVD.Bit;
   subtype OTGSC_BSV_Field is LPC43_SVD.Bit;
   subtype OTGSC_BSE_Field is LPC43_SVD.Bit;
   subtype OTGSC_MS1T_Field is LPC43_SVD.Bit;
   subtype OTGSC_DPS_Field is LPC43_SVD.Bit;
   subtype OTGSC_RESERVED_Field is LPC43_SVD.Bit;
   subtype OTGSC_IDIS_Field is LPC43_SVD.Bit;
   subtype OTGSC_AVVIS_Field is LPC43_SVD.Bit;
   subtype OTGSC_ASVIS_Field is LPC43_SVD.Bit;
   subtype OTGSC_BSVIS_Field is LPC43_SVD.Bit;
   subtype OTGSC_BSEIS_Field is LPC43_SVD.Bit;
   subtype OTGSC_ms1S_Field is LPC43_SVD.Bit;
   subtype OTGSC_DPIS_Field is LPC43_SVD.Bit;
   subtype OTGSC_IDIE_Field is LPC43_SVD.Bit;
   subtype OTGSC_AVVIE_Field is LPC43_SVD.Bit;
   subtype OTGSC_ASVIE_Field is LPC43_SVD.Bit;
   subtype OTGSC_BSVIE_Field is LPC43_SVD.Bit;
   subtype OTGSC_BSEIE_Field is LPC43_SVD.Bit;
   subtype OTGSC_MS1E_Field is LPC43_SVD.Bit;
   subtype OTGSC_DPIE_Field is LPC43_SVD.Bit;
   ...
   type OTGSC_Register is record
      ...
      --  Hardware assist auto_reset
      HAAR       : OTGSC_ENUM := LPC43_SVD.USB0.Disabled;
      ...
      --  ID pull-up. This bit provides control over the pull-up resistor.
      IDPU       : OTGSC_ENUM_1 := LPC43_SVD.USB0.Pull_Up_Off_The_Id;
      --  Hardware assist data pulse Write a 1 to start data pulse sequence.
      HADP       : OTGSC_HADP_Field := 16#0#;
      --  Hardware assist B-disconnect to A-connect
      HABA       : OTGSC_ENUM_2 := LPC43_SVD.USB0.Disabled;
      --  USB ID
      ID         : OTGSC_ENUM_3 := LPC43_SVD.USB0.A_Device;
   ...
   subtype USBMODE_D_RESERVED_Field is LPC43_SVD.Bit;
   subtype USBMODE_D_RESERVED_Field_1 is LPC43_SVD.UInt26;
   ...
   type USBMODE_D_Register is record
      ...
      CM1_0      : USBMODE_D_ENUM := LPC43_SVD.USB0.Idle;
      --  Endian select This bit can change the byte ordering of the transfer
      --  buffers to match the host microprocessor bus architecture. The bit
      --  fields in the microprocessor interface and the DMA data structures
      ...
      ES         : USBMODE_D_ENUM_1 := LPC43_SVD.USB0.Little_Endian_First;
      --  Setup Lockout mode In device mode, this bit controls behavior of the
      --  setup lock mechanism. See Section 18.10.8.
      SLOM       : USBMODE_D_ENUM_2 := LPC43_SVD.USB0.Setup_Lockouts_On;
      --  Stream disable mode The use of this feature substantially limits the
      --  overall USB performance that can be achieved.
      SDIS       : USBMODE_D_ENUM_3 := LPC43_SVD.USB0.Not_Disabled;
      --  Not used in device mode.
   ...
   subtype USBMODE_H_RESERVED_Field is LPC43_SVD.Bit;
   ...
   subtype USBMODE_H_RESERVED_Field_1 is LPC43_SVD.UInt26;
   ...
   type USBMODE_H_Register is record
      ...
      --  switch modes, software must reset the controller by writing to the
      --  RESET bit in the USBCMD register before reprogramming this register.
      CM         : USBMODE_H_ENUM := LPC43_SVD.USB0.Idle;
      --  Endian select This bit can change the byte ordering of the transfer
      ...
      --  32-bit words.
      ES         : USBMODE_H_ENUM_1 := LPC43_SVD.USB0.Little_Endian_First;
      --  Not used in host mode
      RESERVED   : USBMODE_H_RESERVED_Field := 16#0#;
      --  Stream disable mode The use of this feature substantially limits the
      --  overall USB performance that can be achieved.
      SDIS       : USBMODE_H_ENUM_2 := LPC43_SVD.USB0.Not_Disabled;
      --  VBUS power select
      VBPS       : USBMODE_H_ENUM_3 := LPC43_SVD.USB0.Low;
      --  reserved
   ...
   subtype ENDPTSETUPSTAT_Element is LPC43_SVD.Bit;
   ...
   subtype ENDPTSETUPSTAT_RESERVED_Field is LPC43_SVD.UInt26;
   ...
   subtype ENDPTPRIME_PERB_Element is LPC43_SVD.Bit;
   ...
   subtype ENDPTPRIME_RESERVED_Field is LPC43_SVD.UInt10;
   --  ENDPTPRIME_PETB array element
   subtype ENDPTPRIME_PETB_Element is LPC43_SVD.Bit;
   ...
   subtype ENDPTFLUSH_FERB_Element is LPC43_SVD.Bit;
   ...
   subtype ENDPTFLUSH_RESERVED_Field is LPC43_SVD.UInt10;
   --  ENDPTFLUSH_FETB array element
   subtype ENDPTFLUSH_FETB_Element is LPC43_SVD.Bit;
   ...
   subtype ENDPTSTAT_ERBR_Element is LPC43_SVD.Bit;
   ...
   subtype ENDPTSTAT_RESERVED_Field is LPC43_SVD.UInt10;
   --  ENDPTSTAT_ETBR array element
   subtype ENDPTSTAT_ETBR_Element is LPC43_SVD.Bit;
   ...
   subtype ENDPTCOMPLETE_ERCE_Element is LPC43_SVD.Bit;
   ...
   subtype ENDPTCOMPLETE_RESERVED_Field is LPC43_SVD.UInt10;
   --  ENDPTCOMPLETE_ETCE array element
   subtype ENDPTCOMPLETE_ETCE_Element is LPC43_SVD.Bit;
   ...
   subtype ENDPTCTRL0_RESERVED_Field is LPC43_SVD.Bit;
   subtype ENDPTCTRL0_RXT1_0_Field is LPC43_SVD.UInt2;
   subtype ENDPTCTRL0_RESERVED_Field_1 is LPC43_SVD.UInt3;
   subtype ENDPTCTRL0_RXE_Field is LPC43_SVD.Bit;
   subtype ENDPTCTRL0_RESERVED_Field_2 is LPC43_SVD.Byte;
   subtype ENDPTCTRL0_TXT1_0_Field is LPC43_SVD.UInt2;
   subtype ENDPTCTRL0_TXE_Field is LPC43_SVD.Bit;

   --  Endpoint control 0
   type ENDPTCTRL0_Register is record
      --  Rx endpoint stall
      RXS        : ENDPTCTRL0_ENUM := LPC43_SVD.USB0.Endpoint_Ok;
      --  reserved
      ...
      --  Tx endpoint stall
      TXS        : ENDPTCTRL0_ENUM := LPC43_SVD.USB0.Endpoint_Ok;
      --  reserved
   ...
   subtype ENDPTCTRL_RESERVED_Field is LPC43_SVD.Bit;
   ...
   subtype ENDPTCTRL_RXR_Field is LPC43_SVD.Bit;
   ...
   subtype ENDPTCTRL_RESERVED_Field_1 is LPC43_SVD.Byte;
   ...
   subtype ENDPTCTRL_TXR_Field is LPC43_SVD.Bit;

   --  Endpoint control
   type ENDPTCTRL_Register is record
      --  Rx endpoint stall
      RXS        : ENDPTCTRL_ENUM := LPC43_SVD.USB0.Endpoint_Ok_This_Bi;
      --  Reserved
      RESERVED   : ENDPTCTRL_RESERVED_Field := 16#0#;
      --  Endpoint type
      RXT        : ENDPTCTRL_ENUM_1 := LPC43_SVD.USB0.Control;
      --  Reserved
      ...
      RXI        : ENDPTCTRL_ENUM_2 := LPC43_SVD.USB0.Disabled;
      ...
      --  been configured.
      RXE        : ENDPTCTRL_ENUM_3 := LPC43_SVD.USB0.Endpoint_Disabled;
      --  reserved
      RESERVED_2 : ENDPTCTRL_RESERVED_Field_1 := 16#0#;
      --  Tx endpoint stall
      TXS        : ENDPTCTRL_ENUM := LPC43_SVD.USB0.Endpoint_Ok_This_Bi;
      --  Reserved
      RESERVED_3 : ENDPTCTRL_RESERVED_Field := 16#0#;
      --  Tx endpoint type
      TXT1_0     : ENDPTCTRL_ENUM_4 := LPC43_SVD.USB0.Control;
      --  reserved
      ...
      --  endpoint to ignore the data toggle sequence and always accept data
      --  packets regardless of their data PID.
      TXI        : ENDPTCTRL_ENUM_5 := LPC43_SVD.USB0.Enabled;
      ...
      --  been configured
      TXE        : ENDPTCTRL_ENUM_3 := LPC43_SVD.USB0.Endpoint_Disabled;
      --  reserved
