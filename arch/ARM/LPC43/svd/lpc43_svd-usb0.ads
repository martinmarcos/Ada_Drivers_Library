...
package LPC43_SVD.USB0 is
   ...
   type USBCMD_D_Register is record
      ...
      --  Reserved
      RESERVED_5 : USBCMD_D_RESERVED_Field_3 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type USBSTS_D_RESERVED_Field_Array is array (1 .. 2) of Boolean
     with Component_Size => 1, Size => 2;
   ...
   --  USBSTS_D_RESERVED array
   type USBSTS_D_RESERVED_Field_Array_2 is array (1 .. 3) of Boolean
     with Component_Size => 1, Size => 3;
   ...
   subtype USBSTS_D_RESERVED_Field_4 is HAL.UInt12;
   ...
   type USBSTS_H_Register is record
      ...
      --  Reserved.
      RESERVED_3 : USBSTS_H_RESERVED_Field := 16#0#;
      --  HCHalted
      ...
      RESERVED_4 : USBSTS_H_RESERVED_Field_1 :=
                    (As_Array => False, Val => 16#0#);
      ...
      --  Reserved.
      RESERVED_5 : USBSTS_H_RESERVED_Field_2 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   --  ENDPTNAK_EPRN array
   type ENDPTNAK_EPRN_Field_Array is array (0 .. 5) of Boolean
   ...
   subtype ENDPTNAK_RESERVED_Field is HAL.UInt10;

   --  ENDPTNAK_EPTN array
   type ENDPTNAK_EPTN_Field_Array is array (0 .. 5) of Boolean
     with Component_Size => 1, Size => 6;
   ...
   type ENDPTNAKEN_EPRNE_Field_Array is array (0 .. 5) of Boolean
     with Component_Size => 1, Size => 6;
   ...
   subtype ENDPTNAKEN_RESERVED_Field is HAL.UInt10;

   --  ENDPTNAKEN_EPTNE array
   type ENDPTNAKEN_EPTNE_Field_Array is array (0 .. 5) of Boolean
     with Component_Size => 1, Size => 6;
   ...
   type PORTSC1_D_RESERVED_Field_Array is array (1 .. 2) of Boolean
     with Component_Size => 1, Size => 2;
   ...
   --  PORTSC1_D_RESERVED array
   type PORTSC1_D_RESERVED_Field_Array_1 is array (1 .. 3) of Boolean
     with Component_Size => 1, Size => 3;
   ...
   subtype PORTSC1_D_RESERVED_Field_3 is HAL.UInt4;
   ...
   type PORTSC1_D_Register is record
      ...
      PEC        : Boolean := False;
      --  Reserved
      RESERVED_1 : PORTSC1_D_RESERVED_Field := 16#0#;
      ...
      --  Not used in device mode.
      RESERVED_2 : PORTSC1_D_RESERVED_Field := 16#0#;
      --  Not used in device mode.
      RESERVED_3 : PORTSC1_D_RESERVED_Field_1 :=
                    (As_Array => False, Val => 16#0#);
      --  Port indicator control Writing to this field effects the value of the
      --  USB0_IND[1:0] pins.
      ...
      RESERVED_4 : PORTSC1_D_RESERVED_Field_2 :=
                    (As_Array => False, Val => 16#0#);
      ...
      --  Reserved
      RESERVED_6 : PORTSC1_D_RESERVED_Field_3 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type ENDPTSETUPSTAT_Field_Array is array (0 .. 5) of Boolean
     with Component_Size => 1, Size => 6;
   ...
   subtype ENDPTSETUPSTAT_RESERVED_Field is HAL.UInt26;
   ...
   type ENDPTPRIME_PERB_Field_Array is array (0 .. 5) of Boolean
     with Component_Size => 1, Size => 6;
   ...
   subtype ENDPTPRIME_RESERVED_Field is HAL.UInt10;

   --  ENDPTPRIME_PETB array
   type ENDPTPRIME_PETB_Field_Array is array (0 .. 5) of Boolean
     with Component_Size => 1, Size => 6;
   ...
   type ENDPTFLUSH_FERB_Field_Array is array (0 .. 5) of Boolean
     with Component_Size => 1, Size => 6;
   ...
   subtype ENDPTFLUSH_RESERVED_Field is HAL.UInt10;

   --  ENDPTFLUSH_FETB array
   type ENDPTFLUSH_FETB_Field_Array is array (0 .. 5) of Boolean
     with Component_Size => 1, Size => 6;
   ...
   type ENDPTSTAT_ERBR_Field_Array is array (0 .. 5) of Boolean
     with Component_Size => 1, Size => 6;
   ...
   subtype ENDPTSTAT_RESERVED_Field is HAL.UInt10;

   --  ENDPTSTAT_ETBR array
   type ENDPTSTAT_ETBR_Field_Array is array (0 .. 5) of Boolean
     with Component_Size => 1, Size => 6;
   ...
   type ENDPTCOMPLETE_ERCE_Field_Array is array (0 .. 5) of Boolean
     with Component_Size => 1, Size => 6;
   ...
   subtype ENDPTCOMPLETE_RESERVED_Field is HAL.UInt10;

   --  ENDPTCOMPLETE_ETCE array
   type ENDPTCOMPLETE_ETCE_Field_Array is array (0 .. 5) of Boolean
     with Component_Size => 1, Size => 6;
