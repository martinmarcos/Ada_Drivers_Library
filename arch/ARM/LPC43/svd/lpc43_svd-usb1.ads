...
package LPC43_SVD.USB1 is
   ...
   subtype DCIVERSION_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype USBCMD_D_FS2_Field is LPC43_SVD.Bit;
   subtype USBCMD_D_ITC_Field is LPC43_SVD.Byte;
   subtype USBCMD_D_RESERVED_Field_3 is LPC43_SVD.Byte;

   --  USB command (device mode)
   type USBCMD_D_Register is record
      --  Run/Stop
      RS         : USBCMD_D_ENUM := LPC43_SVD.USB1.Detach;
      ...
      RST        : USBCMD_D_ENUM_1 := LPC43_SVD.USB1.Resetcomplete;
   ...
   type USBCMD_H_Register is record
      --  Run/Stop
      RS         : USBCMD_H_ENUM := LPC43_SVD.USB1.Halt;
      --  Controller reset. Software uses this bit to reset the controller.
      --  This bit is set to zero by the Host/Device Controller when the reset
      --  process is complete. Software cannot terminate the reset process
      --  early by writing a zero to this register.
      RST        : USBCMD_H_ENUM_1 := LPC43_SVD.USB1.Resetcomplete;
      ...
      --  This bit controls whether the host controller skips processing the
      --  periodic schedule.
      PSE        : USBCMD_H_ENUM_2 := LPC43_SVD.USB1.Use_The_Periodiclist;
      --  This bit controls whether the host controller skips processing the
      --  asynchronous schedule.
      ASE        : USBCMD_H_ENUM_3 := LPC43_SVD.USB1.Use_The_Asynclistadd;
      --  This bit is used as a doorbell by software to tell the host
      --  controller to issue an interrupt the next time it advances
      --  asynchronous schedule.
      IAA        : USBCMD_H_ENUM_4 := LPC43_SVD.USB1.St;
      --  Reserved
      ...
      --  Asynchronous Schedule Park Mode Enable
      ASPE       : USBCMD_H_ENUM_5 := LPC43_SVD.USB1.Park_Mode_Is_Disable;
      --  Reserved.
   ...
   subtype USBSTS_D_RESERVED_Field_3 is LPC43_SVD.UInt12;

   --  USB status (device mode)
   type USBSTS_D_Register is record
      --  USB interrupt
      UI         : USBSTS_D_ENUM := LPC43_SVD.USB1.St;
      --  USB error interrupt
      UEI        : USBSTS_D_ENUM := LPC43_SVD.USB1.St;
      --  Port change detect.
      PCI        : USBSTS_D_ENUM := LPC43_SVD.USB1.St;
      --  Not used in Device mode.
      RESERVED   : USBSTS_D_RESERVED_Field :=
                    (As_Array => False, Val => 16#0#);
      --  USB reset received
      URI        : USBSTS_D_ENUM := LPC43_SVD.USB1.St;
      --  SOF received
      SRI        : USBSTS_D_ENUM := LPC43_SVD.USB1.St;
      --  DCSuspend
      SLI        : USBSTS_D_ENUM := LPC43_SVD.USB1.St;
      ...
      RESERVED_2 : USBSTS_D_RESERVED_Field_2 :=
                    (As_Array => False, Val => 16#0#);
      --  NAK interrupt bit
      NAKI       : USBSTS_D_ENUM_1 := LPC43_SVD.USB1.Endpclear;
      --  Reserved. Software should only write 0 to reserved bits.
   ...
   subtype USBSTS_H_SLI_Field is LPC43_SVD.Bit;
   ...
   type USBSTS_H_Register is record
      --  USB interrupt (USBINT)
      UI         : USBSTS_H_ENUM := LPC43_SVD.USB1.St;
      --  USB error interrupt (USBERRINT)
      UEI        : USBSTS_H_ENUM := LPC43_SVD.USB1.St;
      --  Port change detect.
      PCI        : USBSTS_H_ENUM := LPC43_SVD.USB1.St;
      --  Frame list roll-over
      FRI        : USBSTS_H_ENUM := LPC43_SVD.USB1.St;
      --  Reserved.
      RESERVED   : USBSTS_H_RESERVED_Field := 16#0#;
      --  Interrupt on async advance
      AAI        : USBSTS_H_ENUM := LPC43_SVD.USB1.St;
      --  Not used by the Host controller.
      RESERVED_1 : USBSTS_H_RESERVED_Field := 16#0#;
      --  SOF received
      SRI        : USBSTS_H_ENUM := LPC43_SVD.USB1.St;
      --  Not used by the Host controller.
      SLI        : USBSTS_H_SLI_Field := 16#0#;
      --  Reserved.
      RESERVED_2 : USBSTS_H_RESERVED_Field_1 := 16#0#;
      --  HCHalted
      HCH        : USBSTS_H_ENUM_1 := LPC43_SVD.USB1.Stop;
      --  Reclamation
      RCL        : USBSTS_H_ENUM_2 := LPC43_SVD.USB1.No_Empty_Asynchronou;
      ...
      PS         : USBSTS_H_ENUM_3 := LPC43_SVD.USB1.Disabled;
   ...
   subtype USBINTR_D_RESERVED_Field_2 is LPC43_SVD.Bit;
   subtype USBINTR_D_UAIE_Field is LPC43_SVD.Bit;
   subtype USBINTR_D_UPIA_Field is LPC43_SVD.Bit;
   subtype USBINTR_D_RESERVED_Field_3 is LPC43_SVD.UInt12;
   ...
   type DEVICEADDR_Register is record
      ...
      --  Device address advance
      USBADRA  : DEVICEADDR_ENUM := LPC43_SVD.USB1.Advance;
      --  USB device address
   ...
   subtype ULPIVIEWPORT_ULPIDATWR_Field is LPC43_SVD.Byte;
   subtype ULPIVIEWPORT_ULPIDATRD_Field is LPC43_SVD.Byte;
   subtype ULPIVIEWPORT_ULPIADDR_Field is LPC43_SVD.Byte;
   subtype ULPIVIEWPORT_ULPIPORT_Field is LPC43_SVD.UInt3;
   ...
   subtype ULPIVIEWPORT_RESERVED_Field is LPC43_SVD.Bit;
   ...
   subtype ULPIVIEWPORT_ULPIRUN_Field is LPC43_SVD.Bit;
   subtype ULPIVIEWPORT_ULPIWU_Field is LPC43_SVD.Bit;
   ...
   type ULPIVIEWPORT_Register is record
      ...
      --  ULPI sync state. This bit represents the state of the ULPI interface.
      ULPISS    : ULPIVIEWPORT_ENUM := LPC43_SVD.USB1.In_Another_State;
      --  Reserved
      RESERVED  : ULPIVIEWPORT_RESERVED_Field := 16#0#;
      --  ULPI Read/Write control. This bit selects between running a read or
      --  write operation.
      ULPIRW    : ULPIVIEWPORT_ENUM_1 := LPC43_SVD.USB1.Read;
   ...
   subtype ENDPTNAK_RESERVED_Field is LPC43_SVD.UInt12;
   ...
   subtype ENDPTNAKEN_RESERVED_Field is LPC43_SVD.UInt12;
   ...
   subtype PORTSC1_D_CSC_Field is LPC43_SVD.Bit;
   subtype PORTSC1_D_PE_Field is LPC43_SVD.Bit;
   subtype PORTSC1_D_PEC_Field is LPC43_SVD.Bit;
   subtype PORTSC1_D_RESERVED_Field is LPC43_SVD.UInt2;
   ...
   subtype PORTSC1_D_LS_Field is LPC43_SVD.UInt2;
   subtype PORTSC1_D_PP_Field is LPC43_SVD.Bit;
   subtype PORTSC1_D_RESERVED_Field_1 is LPC43_SVD.Bit;
   ...
   type PORTSC1_D_Register is record
      --  Current connect status
      CCS        : PORTSC1_D_ENUM := LPC43_SVD.USB1.Device_Not_Attached;
      --  Not used in device mode
      ...
      --  one as well.
      FPR        : PORTSC1_D_ENUM_1 := LPC43_SVD.USB1.No_Resume;
      --  Suspend In device mode, this is a read-only status bit .
      SUSP       : PORTSC1_D_ENUM_2 := LPC43_SVD.USB1.Port_Not_In_Suspend;
      --  Port reset In device mode, this is a read-only status bit. A device
      --  reset from the USB bus is also indicated in the USBSTS register.
      PR         : PORTSC1_D_ENUM_3 := LPC43_SVD.USB1.Port_Is_Not_In_The_R;
      --  High-speed status This bit is redundant with bits 27:26 (PSPD) in
      --  this register. It is implemented for compatibility reasons.
      HSP        : PORTSC1_D_ENUM_4 := LPC43_SVD.USB1.Nohispeed;
      --  Not used in device mode.
      ...
      --  Port indicator control Writing to this field effects the value of the
      --  USB1_IND1:0 pins.
      PIC1_0     : PORTSC1_D_ENUM_5 := LPC43_SVD.USB1.Off;
      ...
      PTC3_0     : PORTSC1_D_ENUM_6 := LPC43_SVD.USB1.Test_Mode_Disable;
      ...
      PHCD       : PORTSC1_D_ENUM_7 := LPC43_SVD.USB1.Enabled;
      --  Port force full speed connect
      PFSC       : PORTSC1_D_ENUM_8 := LPC43_SVD.USB1.Anyspeed;
      --  Reserved
   ...
   subtype PORTSC1_H_RESERVED_Field_1 is LPC43_SVD.UInt2;
   ...
   type PORTSC1_H_Register is record
      ...
      CCS        : PORTSC1_H_ENUM := LPC43_SVD.USB1.No_Device_Is_Present;
      --  Connect status change Indicates a change has occurred in the port's
      ...
      CSC        : PORTSC1_H_ENUM_1 := LPC43_SVD.USB1.No_Change_In_Current;
      ...
      PE         : PORTSC1_H_ENUM_2 := LPC43_SVD.USB1.Port_Disabled;
      ...
      --  (Port Power bit) is 0.
      FPR        : PORTSC1_H_ENUM_5 := LPC43_SVD.USB1.No_Resume;
      ...
      SUSP       : PORTSC1_H_ENUM_6 := LPC43_SVD.USB1.Port_Not_In_Suspend;
      ...
      --  Power bit) is 0.
      PR         : PORTSC1_H_ENUM_7 := LPC43_SVD.USB1.Not_In_Reset;
      --  High-speed status
      HSP        : PORTSC1_H_ENUM_8 := LPC43_SVD.USB1.Nohighspeed;
      ...
      LS         : PORTSC1_H_ENUM_9 := LPC43_SVD.USB1.Se0;
      ...
      PP         : PORTSC1_H_ENUM_10 := LPC43_SVD.USB1.Port_Power_Off;
      --  Reserved
      ...
      PIC1_0     : PORTSC1_H_ENUM_11 := LPC43_SVD.USB1.Off;
      --  Port test control Any value other than 0000 indicates that the port
      --  is operating in test mode. The FORCE_ENABLE_FS and FORCE ENABLE_LS
      --  are extensions to the test mode support specified in the EHCI
      --  specification. Writing the PTC field to any of the
      ...
      PTC3_0     : PORTSC1_H_ENUM_12 := LPC43_SVD.USB1.Test_Mode_Disable;
      --  Wake on connect enable (WKCNNT_E) This bit is 0 if PP (Port Power
      --  bit) is 0
      WKCN       : PORTSC1_H_ENUM_13 := LPC43_SVD.USB1.Disables_The_Port_To;
      --  Wake on disconnect enable (WKDSCNNT_E) This bit is 0 if PP (Port
      --  Power bit) is 0.
      WKDC       : PORTSC1_H_ENUM_13 := LPC43_SVD.USB1.Disables_The_Port_To;
      --  Wake on over-current enable (WKOC_E)
      WKOC       : PORTSC1_H_ENUM_14 := LPC43_SVD.USB1.Disables_Overcurrent;
      ...
      --  connected. Low power suspend is completely under the control of
      --  software.
      PHCD       : PORTSC1_H_ENUM_15 := LPC43_SVD.USB1.Enable_Phy_Clk;
      --  Port force full speed connect
      PFSC       : PORTSC1_H_ENUM_16 := LPC43_SVD.USB1.Anyspeed;
      --  Reserved
      ...
      PSPD       : PORTSC1_H_ENUM_17 := LPC43_SVD.USB1.Full_Speed;
      --  Reserved
   ...
   type USBMODE_D_Register is record
      ...
      CM1_0      : USBMODE_D_ENUM := LPC43_SVD.USB1.Idle;
      --  Endian select This bit can change the byte ordering of the transfer
      --  buffers to match the host microprocessor bus architecture. The bit
      --  fields in the microprocessor interface and the DMA data structures
      ...
      ES         : USBMODE_D_ENUM_1 := LPC43_SVD.USB1.Little_Endian_First;
      --  Setup Lockout mode In device mode, this bit controls behavior of the
      --  setup lock mechanism. See Section 18.10.8.
      SLOM       : USBMODE_D_ENUM_2 := LPC43_SVD.USB1.Setup_Lockouts_On;
      --  Stream disable mode The use of this feature substantially limits the
      --  overall USB performance that can be achieved.
      SDIS       : USBMODE_D_ENUM_3 := LPC43_SVD.USB1.Not_Disabled;
      --  Not used in device mode.
   ...
   type USBMODE_H_Register is record
      ...
      --  switch modes, software must reset the controller by writing to the
      --  RESET bit in the USBCMD register before reprogramming this register.
      CM1_0      : USBMODE_H_ENUM := LPC43_SVD.USB1.Idle;
      --  Endian select This bit can change the byte ordering of the transfer
      ...
      --  32-bit words.
      ES         : USBMODE_H_ENUM_1 := LPC43_SVD.USB1.Little_Endian_First;
      --  Not used in host mode
      RESERVED   : USBMODE_H_RESERVED_Field := 16#0#;
      --  Stream disable mode The use of this feature substantially limits the
      --  overall USB performance that can be achieved.
      SDIS       : USBMODE_H_ENUM_2 := LPC43_SVD.USB1.Not_Disabled;
      --  VBUS power select
      VBPS       : USBMODE_H_ENUM_3 := LPC43_SVD.USB1.Low;
      --  Reserved
   ...
   subtype ENDPTSETUPSTAT_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype ENDPTPRIME_RESERVED_Field is LPC43_SVD.UInt12;
   ...
   subtype ENDPTFLUSH_RESERVED_Field is LPC43_SVD.UInt12;
   ...
   subtype ENDPTSTAT_RESERVED_Field is LPC43_SVD.UInt12;
   ...
   subtype ENDPTCOMPLETE_RESERVED_Field is LPC43_SVD.UInt12;
   ...
   subtype ENDPTCTRL0_RXT_Field is LPC43_SVD.UInt2;
   ...
   subtype ENDPTCTRL0_TXT_Field is LPC43_SVD.UInt2;
   subtype ENDPTCTRL0_TXE_Field is LPC43_SVD.Bit;

   --  Endpoint control 0
   type ENDPTCTRL0_Register is record
      --  Rx endpoint stall
      RXS        : ENDPTCTRL0_ENUM := LPC43_SVD.USB1.Endpoint_Ok;
      --  Reserved
      ...
      --  Tx endpoint stall
      TXS        : ENDPTCTRL0_ENUM := LPC43_SVD.USB1.Endpoint_Ok;
      --  Reserved
   ...
   type ENDPTCTRL_Register is record
      --  Rx endpoint stall
      RXS        : ENDPTCTRL_ENUM := LPC43_SVD.USB1.Endpoint_Ok_This_Bi;
      --  Reserved
      RESERVED   : ENDPTCTRL_RESERVED_Field := 16#0#;
      --  Endpoint type
      RXT        : ENDPTCTRL_ENUM_1 := LPC43_SVD.USB1.Control;
      --  Reserved
      ...
      RXI        : ENDPTCTRL_ENUM_2 := LPC43_SVD.USB1.Disabled;
      ...
      --  been configured.
      RXE        : ENDPTCTRL_ENUM_3 := LPC43_SVD.USB1.Endpoint_Disabled;
      --  Reserved
      RESERVED_2 : ENDPTCTRL_RESERVED_Field_1 := 16#0#;
      --  Tx endpoint stall
      TXS        : ENDPTCTRL_ENUM := LPC43_SVD.USB1.Endpoint_Ok_This_Bi;
      --  Reserved
      RESERVED_3 : ENDPTCTRL_RESERVED_Field := 16#0#;
      --  Tx endpoint type
      TXT        : ENDPTCTRL_ENUM_4 := LPC43_SVD.USB1.Control;
      --  Reserved
      ...
      --  endpoint to ignore the data toggle sequence and always accept data
      --  packets regardless of their data PID.
      TXI        : ENDPTCTRL_ENUM_5 := LPC43_SVD.USB1.Enabled;
      ...
      --  been configured
      TXE        : ENDPTCTRL_ENUM_3 := LPC43_SVD.USB1.Endpoint_Disabled;
      --  Reserved
