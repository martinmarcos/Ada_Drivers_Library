...
package LPC43_SVD.GPDMA is
   ...
   --  INTSTAT array
   type INTSTAT_Field_Array is array (0 .. 7) of Boolean
   ...
   subtype INTSTAT_RESERVED_Field is HAL.UInt24;
   ...
   --  INTTCSTAT array
   type INTTCSTAT_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype INTTCSTAT_RESERVED_Field is HAL.UInt24;
   ...
   --  INTTCCLEAR array
   type INTTCCLEAR_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype INTTCCLEAR_RESERVED_Field is HAL.UInt24;
   ...
   --  INTERRSTAT array
   type INTERRSTAT_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype INTERRSTAT_RESERVED_Field is HAL.UInt24;
   ...
   --  INTERRCLR array
   type INTERRCLR_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype INTERRCLR_RESERVED_Field is HAL.UInt24;
   ...
   --  RAWINTTCSTAT array
   type RAWINTTCSTAT_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype RAWINTTCSTAT_RESERVED_Field is HAL.UInt24;
   ...
   --  RAWINTERRSTAT array
   type RAWINTERRSTAT_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype RAWINTERRSTAT_RESERVED_Field is HAL.UInt24;
   ...
   type ENBLDCHNS_ENABLEDCHANNELS_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype ENBLDCHNS_RESERVED_Field is HAL.UInt24;
   ...
   --  SOFTBREQ array
   type SOFTBREQ_Field_Array is array (0 .. 15) of Boolean
   ...
   subtype SOFTBREQ_RESERVED_Field is HAL.UInt16;
   ...
   --  SOFTSREQ array
   type SOFTSREQ_Field_Array is array (0 .. 15) of Boolean
     with Component_Size => 1, Size => 16;
   ...
   subtype SOFTSREQ_RESERVED_Field is HAL.UInt16;
   ...
   --  SOFTLBREQ array
   type SOFTLBREQ_Field_Array is array (0 .. 15) of Boolean
     with Component_Size => 1, Size => 16;
   ...
   subtype SOFTLBREQ_RESERVED_Field is HAL.UInt16;
   ...
   --  SOFTLSREQ array
   type SOFTLSREQ_Field_Array is array (0 .. 15) of Boolean
     with Component_Size => 1, Size => 16;
   ...
   subtype SOFTLSREQ_RESERVED_Field is HAL.UInt16;
   ...
   subtype CONFIG_RESERVED_Field is HAL.UInt29;
   ...
   --  SYNC_DMACSYNC array
   type SYNC_DMACSYNC_Field_Array is array (0 .. 15) of Boolean
     with Component_Size => 1, Size => 16;
   ...
   subtype SYNC_RESERVED_Field is HAL.UInt16;
   ...
   subtype CLLI_LLI_Field is HAL.UInt30;
   ...
   subtype CCONTROL_TRANSFERSIZE_Field is HAL.UInt12;
   ...
   subtype CCONFIG_RESERVED_Field is HAL.UInt13;
   ...
   type GPDMA_Peripheral is record
      ...
      CSRCADDR0     : aliased HAL.UInt32;
      --  DMA Channel Destination Address Register
      CDESTADDR0    : aliased HAL.UInt32;
      --  DMA Channel Linked List Item Register
      ...
      --  DMA Channel Source Address Register
      CSRCADDR1     : aliased HAL.UInt32;
      --  DMA Channel Destination Address Register
      CDESTADDR1    : aliased HAL.UInt32;
      --  DMA Channel Linked List Item Register
      ...
      --  DMA Channel Source Address Register
      CSRCADDR2     : aliased HAL.UInt32;
      --  DMA Channel Destination Address Register
      CDESTADDR2    : aliased HAL.UInt32;
      --  DMA Channel Linked List Item Register
      ...
      --  DMA Channel Source Address Register
      CSRCADDR3     : aliased HAL.UInt32;
      --  DMA Channel Destination Address Register
      CDESTADDR3    : aliased HAL.UInt32;
      --  DMA Channel Linked List Item Register
      ...
      --  DMA Channel Source Address Register
      CSRCADDR4     : aliased HAL.UInt32;
      --  DMA Channel Destination Address Register
      CDESTADDR4    : aliased HAL.UInt32;
      --  DMA Channel Linked List Item Register
      ...
      --  DMA Channel Source Address Register
      CSRCADDR5     : aliased HAL.UInt32;
      --  DMA Channel Destination Address Register
      CDESTADDR5    : aliased HAL.UInt32;
      --  DMA Channel Linked List Item Register
      ...
      --  DMA Channel Source Address Register
      CSRCADDR6     : aliased HAL.UInt32;
      --  DMA Channel Destination Address Register
      CDESTADDR6    : aliased HAL.UInt32;
      --  DMA Channel Linked List Item Register
      ...
      --  DMA Channel Source Address Register
      CSRCADDR7     : aliased HAL.UInt32;
      --  DMA Channel Destination Address Register
      CDESTADDR7    : aliased HAL.UInt32;
      --  DMA Channel Linked List Item Register
