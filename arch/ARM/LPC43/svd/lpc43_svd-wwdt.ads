...
package LPC43_SVD.WWDT is
   ...
   subtype MOD_RESERVED_Field is HAL.UInt3;
   ...
   subtype TC_WDTC_Field is HAL.UInt24;
   subtype TC_RESERVED_Field is HAL.UInt8;
   ...
   subtype TV_RESERVED_Field is HAL.UInt8;
   ...
   subtype WARNINT_WDWARNINT_Field is HAL.UInt10;
   subtype WARNINT_RESERVED_Field is HAL.UInt22;
   ...
   subtype WINDOW_WDWINDOW_Field is HAL.UInt24;
   subtype WINDOW_RESERVED_Field is HAL.UInt8;
