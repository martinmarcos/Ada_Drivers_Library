...
package LPC43_SVD.WWDT is
   ...
   subtype MOD_WDTOF_Field is LPC43_SVD.Bit;
   subtype MOD_WDINT_Field is LPC43_SVD.Bit;
   ...
   subtype MOD_RESERVED_Field is LPC43_SVD.UInt3;

   --  Watchdog mode register. This register contains the basic mode and status
   --  of the Watchdog Timer.
   type MOD_Register is record
      --  Watchdog enable bit. This bit is Set Only.
      WDEN          : MOD_ENUM := LPC43_SVD.WWDT.Wwdtstopped;
      --  Watchdog reset enable bit. This bit is Set Only.
      WDRESET       : MOD_ENUM_1 := LPC43_SVD.WWDT.Wwdtint;
      ...
      --  Watchdog update mode. This bit is Set Only.
      WDPROTECT     : MOD_ENUM_2 := LPC43_SVD.WWDT.No_Lock;
   ...
   subtype TC_WDTC_Field is LPC43_SVD.UInt24;
   subtype TC_RESERVED_Field is LPC43_SVD.Byte;
   ...
   subtype FEED_Feed_Field is LPC43_SVD.Byte;
   ...
   subtype TV_Count_Field is LPC43_SVD.UInt24;
   subtype TV_RESERVED_Field is LPC43_SVD.Byte;
   ...
   subtype WARNINT_WDWARNINT_Field is LPC43_SVD.UInt10;
   subtype WARNINT_RESERVED_Field is LPC43_SVD.UInt22;
   ...
   subtype WINDOW_WDWINDOW_Field is LPC43_SVD.UInt24;
   subtype WINDOW_RESERVED_Field is LPC43_SVD.Byte;
