...
package LPC43_SVD.USART is
   ...
   subtype RBR_RBR_Field is LPC43_SVD.Byte;
   subtype RBR_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype THR_THR_Field is LPC43_SVD.Byte;
   subtype THR_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype DLL_DLLSB_Field is LPC43_SVD.Byte;
   subtype DLL_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype DLM_DLMSB_Field is LPC43_SVD.Byte;
   subtype DLM_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype IER_RESERVED_Field is LPC43_SVD.Bit;
   subtype IER_RESERVED_Field_1 is LPC43_SVD.UInt3;
   subtype IER_RESERVED_Field_2 is LPC43_SVD.UInt22;
   ...
   type IER_Register is record
      ...
      RXIE       : IER_ENUM := LPC43_SVD.USART.Disable;
      --  Reserved
      ...
      ABEOINTEN  : IER_ENUM := LPC43_SVD.USART.Disable;
      --  Enables the auto-baud time-out interrupt.
      ABTOINTEN  : IER_ENUM := LPC43_SVD.USART.Disable;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype IIR_RESERVED_Field is LPC43_SVD.UInt2;
   subtype IIR_FIFOENABLE_Field is LPC43_SVD.UInt2;
   subtype IIR_ABEOINT_Field is LPC43_SVD.Bit;
   subtype IIR_ABTOINT_Field is LPC43_SVD.Bit;
   subtype IIR_RESERVED_Field_1 is LPC43_SVD.UInt22;
   ...
   subtype FCR_DMAMODE_Field is LPC43_SVD.Bit;
   subtype FCR_RESERVED_Field is LPC43_SVD.UInt2;
   ...
   subtype FCR_RESERVED_Field_1 is LPC43_SVD.UInt24;

   --  FIFO Control Register. Controls USART FIFO usage and modes.
   type FCR_Register is record
      --  Write-only. FIFO Enable.
      FIFOEN     : FCR_ENUM := LPC43_SVD.USART.Disabled;
      --  Write-only. RX FIFO Reset.
      RXFIFORES  : FCR_ENUM_1 := LPC43_SVD.USART.No_Effect;
      --  Write-only. TX FIFO Reset.
      TXFIFORES  : FCR_ENUM_1 := LPC43_SVD.USART.No_Effect;
      ...
      --  activated.
      RXTRIGLVL  : FCR_ENUM_2 := LPC43_SVD.USART.Level_0;
      --  Write-only. Reserved
   ...
   subtype LCR_RESERVED_Field is LPC43_SVD.UInt24;

   --  Line Control Register. Contains controls for frame formatting and break
   --  generation.
   type LCR_Register is record
      --  Word Length Select.
      WLS      : LCR_ENUM := LPC43_SVD.USART.LCR_ENUM_5_Bit_Character_Leng;
      --  Stop Bit Select.
      SBS      : LCR_ENUM_1 := LPC43_SVD.USART.LCR_ENUM_1_Stop_Bit;
      --  Parity Enable
      PE       : LCR_ENUM_2 := LPC43_SVD.USART.Disable_Parity_Gener;
      --  Parity Select.
      PS       : LCR_ENUM_3 := LPC43_SVD.USART.Odd_Parity;
      --  Break Control.
      BC       : LCR_ENUM_4 := LPC43_SVD.USART.Disabled;
      --  Divisor Latch Access Bit.
      DLAB     : LCR_ENUM_4 := LPC43_SVD.USART.Disabled;
      --  Reserved
   ...
   subtype LSR_RESERVED_Field is LPC43_SVD.UInt23;
   ...
   subtype SCR_PAD_Field is LPC43_SVD.Byte;
   subtype SCR_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype ACR_RESERVED_Field is LPC43_SVD.UInt5;
   ...
   subtype ACR_RESERVED_Field_1 is LPC43_SVD.UInt22;
   ...
   type ACR_Register is record
      ...
      --  completion.
      START       : ACR_ENUM := LPC43_SVD.USART.Stop;
      --  Auto-baud mode select bit.
      MODE        : ACR_ENUM_1 := LPC43_SVD.USART.Mode_0;
      --  Restart bit.
      AUTORESTART : ACR_ENUM_2 := LPC43_SVD.USART.No_Restart;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED    : ACR_RESERVED_Field := 16#0#;
      --  End of auto-baud interrupt clear bit (write-only).
      ABEOINTCLR  : ACR_ENUM_3 := LPC43_SVD.USART.No_Effect;
      --  Auto-baud time-out interrupt clear bit (write-only).
      ABTOINTCLR  : ACR_ENUM_3 := LPC43_SVD.USART.No_Effect;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype ICR_PULSEDIV_Field is LPC43_SVD.UInt3;
   subtype ICR_RESERVED_Field is LPC43_SVD.UInt26;

   --  IrDA control register (USART3 only)
   type ICR_Register is record
      --  IrDA mode enable.
      IRDAEN     : ICR_ENUM := LPC43_SVD.USART.Disabled;
      --  Serial input direction.
      IRDAINV    : ICR_ENUM_1 := LPC43_SVD.USART.Not_Inverted;
      --  IrDA fixed pulse width mode.
      FIXPULSEEN : ICR_ENUM := LPC43_SVD.USART.Disabled;
   ...
   subtype FDR_DIVADDVAL_Field is LPC43_SVD.UInt4;
   subtype FDR_MULVAL_Field is LPC43_SVD.UInt4;
   subtype FDR_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype OSR_RESERVED_Field is LPC43_SVD.Bit;
   subtype OSR_OSFRAC_Field is LPC43_SVD.UInt3;
   subtype OSR_OSINT_Field is LPC43_SVD.UInt4;
   subtype OSR_FDINT_Field is LPC43_SVD.UInt7;
   subtype OSR_RESERVED_Field_1 is LPC43_SVD.UInt17;
   ...
   subtype HDEN_RESERVED_Field is LPC43_SVD.UInt31;

   --  Half-duplex enable Register
   type HDEN_Register is record
      --  Half-duplex mode enable
      HDEN     : HDEN_ENUM := LPC43_SVD.USART.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype SCICTRL_RESERVED_Field is LPC43_SVD.UInt2;
   subtype SCICTRL_TXRETRY_Field is LPC43_SVD.UInt3;
   subtype SCICTRL_GUARDTIME_Field is LPC43_SVD.Byte;
   subtype SCICTRL_RESERVED_Field_1 is LPC43_SVD.UInt16;

   --  Smart card interface control register
   type SCICTRL_Register is record
      --  Smart Card Interface Enable.
      SCIEN      : SCICTRL_ENUM := LPC43_SVD.USART.Disabled;
      --  NACK response disable. Only applicable in T=0.
      NACKDIS    : SCICTRL_ENUM_1 := LPC43_SVD.USART.Enabled;
      --  Protocol selection as defined in the ISO7816-3 standard.
      PROTSEL    : SCICTRL_ENUM_2 := LPC43_SVD.USART.T_Eq_0;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype RS485CTRL_RESERVED_Field is LPC43_SVD.Bit;
   ...
   subtype RS485CTRL_RESERVED_Field_1 is LPC43_SVD.UInt26;
   ...
   type RS485CTRL_Register is record
      --  NMM enable.
      NMMEN      : RS485CTRL_ENUM := LPC43_SVD.USART.Disabled;
      --  Receiver enable.
      RXDIS      : RS485CTRL_ENUM_1 := LPC43_SVD.USART.Enabled;
      --  AAD enable
      AADEN      : RS485CTRL_ENUM := LPC43_SVD.USART.Disabled;
      --  Reserved.
      RESERVED   : RS485CTRL_RESERVED_Field := 16#0#;
      --  Direction control for DIR pin.
      DCTRL      : RS485CTRL_ENUM := LPC43_SVD.USART.Disabled;
      --  Direction control pin polarity. This bit reverses the polarity of the
      --  direction control signal on the DIR pin.
      OINV       : RS485CTRL_ENUM_2 := LPC43_SVD.USART.Low;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype RS485ADRMATCH_ADRMATCH_Field is LPC43_SVD.Byte;
   subtype RS485ADRMATCH_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype RS485DLY_DLY_Field is LPC43_SVD.Byte;
   subtype RS485DLY_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype SYNCCTRL_RESERVED_Field is LPC43_SVD.UInt25;

   --  Synchronous mode control register.
   type SYNCCTRL_Register is record
      --  Enables synchronous mode.
      SYNC     : SYNCCTRL_ENUM := LPC43_SVD.USART.Disabled;
      --  Clock source select.
      CSRC     : SYNCCTRL_ENUM_1 := LPC43_SVD.USART.Slave_Mode;
      --  Edge sampling.
      FES      : SYNCCTRL_ENUM_2 := LPC43_SVD.USART.Rising;
      --  Transmit synchronization bypass in synchronous slave mode.
      TSBYPASS : SYNCCTRL_ENUM_3 := LPC43_SVD.USART.Synchronized_k;
      --  Continuous master clock enable (used only when CSRC is 1)
      CSCEN    : SYNCCTRL_ENUM_4 := LPC43_SVD.USART.On_Character;
      --  Start/stop bits
      SSSDIS   : SYNCCTRL_ENUM_5 := LPC43_SVD.USART.Send;
      --  Continuous clock clear
      CCCLR    : SYNCCTRL_ENUM_6 := LPC43_SVD.USART.Software;
   ...
   subtype TER_TXEN_Field is LPC43_SVD.Bit;
   subtype TER_RESERVED_Field is LPC43_SVD.UInt31;
