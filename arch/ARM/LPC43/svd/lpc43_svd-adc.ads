...
package LPC43_SVD.ADC is
   ...
   subtype CR_SEL_Field is LPC43_SVD.Byte;
   subtype CR_CLKDIV_Field is LPC43_SVD.Byte;
   ...
   subtype CR_RESERVED_Field is LPC43_SVD.Bit;
   ...
   subtype CR_RESERVED_Field_1 is LPC43_SVD.UInt2;
   ...
   subtype CR_RESERVED_Field_2 is LPC43_SVD.UInt4;
   ...
   type CR_Register is record
      ...
      --  Burst mode
      BURST      : CR_ENUM := LPC43_SVD.ADC.Software;
      --  This field selects the number of clocks used for each conversion in
      ...
      CLKS       : CR_ENUM_1 := LPC43_SVD.ADC.CR_ENUM_11_Clocks_10_Bits;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED   : CR_RESERVED_Field := 16#0#;
      --  Power mode
      PDN        : CR_ENUM_2 := LPC43_SVD.ADC.Powerdown;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_1 : CR_RESERVED_Field_1 := 16#0#;
      --  When the BURST bit is 0, these bits control whether and when an A/D
      --  conversion is started (also see Figure 56):
      START      : CR_ENUM_3 := LPC43_SVD.ADC.No_Start;
      --  This bit is significant only when the START field contains 0x2 -0x6.
      --  In these cases:
      EDGE       : CR_ENUM_4 := LPC43_SVD.ADC.Rising;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype GDR_RESERVED_Field is LPC43_SVD.UInt6;
   subtype GDR_V_VREF_Field is LPC43_SVD.UInt10;
   subtype GDR_RESERVED_Field_1 is LPC43_SVD.Byte;
   subtype GDR_CHN_Field is LPC43_SVD.UInt3;
   subtype GDR_RESERVED_Field_2 is LPC43_SVD.UInt3;
   subtype GDR_OVERRUN_Field is LPC43_SVD.Bit;
   subtype GDR_DONE_Field is LPC43_SVD.Bit;
   ...
   subtype INTEN_ADINTEN_Field is LPC43_SVD.Byte;
   subtype INTEN_ADGINTEN_Field is LPC43_SVD.Bit;
   subtype INTEN_RESERVED_Field is LPC43_SVD.UInt23;
   ...
   subtype DR_RESERVED_Field is LPC43_SVD.UInt6;
   subtype DR_V_VREF_Field is LPC43_SVD.UInt10;
   subtype DR_RESERVED_Field_1 is LPC43_SVD.UInt14;
   subtype DR_OVERRUN_Field is LPC43_SVD.Bit;
   subtype DR_DONE_Field is LPC43_SVD.Bit;
   ...
   subtype STAT_DONE_Field is LPC43_SVD.Byte;
   subtype STAT_OVERUN_Field is LPC43_SVD.Byte;
   subtype STAT_ADINT_Field is LPC43_SVD.Bit;
   subtype STAT_RESERVED_Field is LPC43_SVD.UInt15;
