...
package LPC43_SVD.ADC is
   ...
   subtype CR_SEL_Field is HAL.UInt8;
   subtype CR_CLKDIV_Field is HAL.UInt8;
   ...
   subtype CR_RESERVED_Field_1 is HAL.UInt4;
   ...
   type CR_Register is record
      ...
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_1 : CR_RESERVED_Field := 16#0#;
      --  When the BURST bit is 0, these bits control whether and when an A/D
      --  conversion is started (also see Figure 56):
      ...
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_2 : CR_RESERVED_Field_1 := 16#0#;
   end record
   ...
   subtype GDR_RESERVED_Field is HAL.UInt6;
   subtype GDR_V_VREF_Field is HAL.UInt10;
   subtype GDR_RESERVED_Field_1 is HAL.UInt8;
   subtype GDR_CHN_Field is HAL.UInt3;
   subtype GDR_RESERVED_Field_2 is HAL.UInt3;
   ...
   subtype INTEN_ADINTEN_Field is HAL.UInt8;
   subtype INTEN_RESERVED_Field is HAL.UInt23;
   ...
   subtype DR_RESERVED_Field is HAL.UInt6;
   subtype DR_V_VREF_Field is HAL.UInt10;
   subtype DR_RESERVED_Field_1 is HAL.UInt14;
   ...
   subtype STAT_DONE_Field is HAL.UInt8;
   subtype STAT_OVERUN_Field is HAL.UInt8;
   subtype STAT_RESERVED_Field is HAL.UInt15;
