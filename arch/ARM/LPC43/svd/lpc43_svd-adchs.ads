...
package LPC43_SVD.ADCHS is
   ...
   subtype FLUSH_FIFO_FLUSH_Field is LPC43_SVD.Bit;
   subtype FLUSH_RESERVED_Field is LPC43_SVD.UInt31;
   ...
   subtype DMA_REQ_DMA_REQ_WR_Field is LPC43_SVD.Bit;
   subtype DMA_REQ_RESERVED_Field is LPC43_SVD.UInt31;
   ...
   subtype FIFO_STS_LEVEL_Field is LPC43_SVD.UInt5;
   subtype FIFO_STS_RESERVED_Field is LPC43_SVD.UInt27;
   ...
   subtype FIFO_CFG_PACKED_READ_Field is LPC43_SVD.Bit;
   subtype FIFO_CFG_LEVEL_Field is LPC43_SVD.UInt5;
   subtype FIFO_CFG_RESERVED_Field is LPC43_SVD.UInt26;
   ...
   subtype TRIGGER_SW_TRIGGER_Field is LPC43_SVD.Bit;
   subtype TRIGGER_RESERVED_Field is LPC43_SVD.UInt31;
   ...
   subtype DSCR_STS_ACT_TABLE_Field is LPC43_SVD.Bit;
   subtype DSCR_STS_ACT_DESCRIPTOR_Field is LPC43_SVD.UInt3;
   subtype DSCR_STS_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype POWER_DOWN_PD_CTRL_Field is LPC43_SVD.Bit;
   subtype POWER_DOWN_RESERVED_Field is LPC43_SVD.UInt31;
   ...
   subtype CONFIG_TRIGGER_MASK_Field is LPC43_SVD.UInt2;
   subtype CONFIG_TRIGGER_MODE_Field is LPC43_SVD.UInt2;
   subtype CONFIG_TRIGGER_SYNC_Field is LPC43_SVD.Bit;
   subtype CONFIG_CHANNEL_ID_EN_Field is LPC43_SVD.Bit;
   subtype CONFIG_RECOVERY_TIME_Field is LPC43_SVD.Byte;
   subtype CONFIG_RESERVED_Field is LPC43_SVD.UInt18;
   ...
   subtype THR_A_THR_LOW_A_Field is LPC43_SVD.UInt12;
   subtype THR_A_THR_HIGH_A_Field is LPC43_SVD.UInt12;
   subtype THR_A_RESERVED_Field is LPC43_SVD.UInt4;
   ...
   type THR_A_Register is record
      ...
      --  unspecified
      Reserved_12_15 : LPC43_SVD.UInt4 := 16#0#;
   ...
   subtype THR_B_THR_LOW_B_Field is LPC43_SVD.UInt12;
   subtype THR_B_THR_HIGH_B_Field is LPC43_SVD.UInt12;
   subtype THR_B_RESERVED_Field is LPC43_SVD.UInt4;
   ...
   subtype LAST_SAMPLE_DONE_Field is LPC43_SVD.Bit;
   subtype LAST_SAMPLE_OVERRUN_Field is LPC43_SVD.Bit;
   subtype LAST_SAMPLE_THCMP_RANGE_Field is LPC43_SVD.UInt2;
   subtype LAST_SAMPLE_THCMP_CROSS_Field is LPC43_SVD.UInt2;
   subtype LAST_SAMPLE_SAMPLE_Field is LPC43_SVD.UInt12;
   subtype LAST_SAMPLE_RESERVED_Field is LPC43_SVD.UInt11;
   ...
   type LAST_SAMPLE_Register is record
      ...
      --  unspecified
      Reserved_18_20 : LPC43_SVD.UInt3;
      --  Read-only. Reserved
   ...
   subtype ADC_SPEED_DGEC_Element is LPC43_SVD.UInt4;
   ...
   subtype ADC_SPEED_RESERVED_Field is LPC43_SVD.Byte;
   ...
   subtype POWER_CONTROL_CRS_Field is LPC43_SVD.UInt4;
   subtype POWER_CONTROL_DCINNEG_Field is LPC43_SVD.UInt6;
   subtype POWER_CONTROL_DCINPOS_Field is LPC43_SVD.UInt6;
   subtype POWER_CONTROL_TWOS_Field is LPC43_SVD.Bit;
   subtype POWER_CONTROL_POWER_SWITCH_Field is LPC43_SVD.Bit;
   subtype POWER_CONTROL_BGAP_SWITCH_Field is LPC43_SVD.Bit;
   subtype POWER_CONTROL_RESERVED_Field is LPC43_SVD.UInt13;
   ...
   subtype FIFO_OUTPUT_SAMPLE_Field is LPC43_SVD.UInt12;
   subtype FIFO_OUTPUT_CHAN_ID_Field is LPC43_SVD.UInt3;
   subtype FIFO_OUTPUT_EMPTY_Field is LPC43_SVD.Bit;
   subtype FIFO_OUTPUT_SAMPLE2_Field is LPC43_SVD.UInt12;
   subtype FIFO_OUTPUT_CHAN_ID2_Field is LPC43_SVD.UInt3;
   subtype FIFO_OUTPUT_EMPTY2_Field is LPC43_SVD.Bit;
   ...
   subtype DESCRIPTOR_CHANNEL_NR_Field is LPC43_SVD.UInt3;
   subtype DESCRIPTOR_HALT_Field is LPC43_SVD.Bit;
   subtype DESCRIPTOR_INTERRUPT_Field is LPC43_SVD.Bit;
   subtype DESCRIPTOR_POWER_DOWN_Field is LPC43_SVD.Bit;
   subtype DESCRIPTOR_BRANCH_Field is LPC43_SVD.UInt2;
   subtype DESCRIPTOR_MATCH_VALUE_Field is LPC43_SVD.UInt14;
   subtype DESCRIPTOR_THRESHOLD_SEL_Field is LPC43_SVD.UInt2;
   subtype DESCRIPTOR_RESET_TIMER_Field is LPC43_SVD.Bit;
   subtype DESCRIPTOR_RESERVED_Field is LPC43_SVD.UInt6;
   subtype DESCRIPTOR_UPDATE_TABLE_Field is LPC43_SVD.Bit;
   ...
   subtype CLR_EN0_CEN0_Field is LPC43_SVD.UInt7;
   subtype CLR_EN0_RESERVED_Field is LPC43_SVD.UInt25;
   ...
   subtype SET_EN0_SEN0_Field is LPC43_SVD.UInt7;
   subtype SET_EN0_RESERVED_Field is LPC43_SVD.UInt25;
   ...
   subtype MASK0_M0_Field is LPC43_SVD.UInt7;
   subtype MASK0_RESERVED_Field is LPC43_SVD.UInt25;
   ...
   subtype STATUS0_FIFO_FULL_Field is LPC43_SVD.Bit;
   subtype STATUS0_FIFO_EMPTY_Field is LPC43_SVD.Bit;
   subtype STATUS0_FIFO_OVERFLOW_Field is LPC43_SVD.Bit;
   subtype STATUS0_DSCR_DONE_Field is LPC43_SVD.Bit;
   subtype STATUS0_DSCR_ERROR_Field is LPC43_SVD.Bit;
   subtype STATUS0_ADC_OVF_Field is LPC43_SVD.Bit;
   subtype STATUS0_ADC_UNF_Field is LPC43_SVD.Bit;
   subtype STATUS0_RESERVED_Field is LPC43_SVD.UInt25;
   ...
   subtype CLR_STAT0_CSTAT0_Field is LPC43_SVD.UInt7;
   subtype CLR_STAT0_RESERVED_Field is LPC43_SVD.UInt25;
   ...
   subtype SET_STAT0_SSTAT0_Field is LPC43_SVD.UInt7;
   subtype SET_STAT0_RESERVED_Field is LPC43_SVD.UInt25;
   ...
   subtype CLR_EN1_CEN1_Field is LPC43_SVD.UInt30;
   subtype CLR_EN1_RESERVED_Field is LPC43_SVD.UInt2;
   ...
   subtype SET_EN1_SEN1_Field is LPC43_SVD.UInt30;
   subtype SET_EN1_RESERVED_Field is LPC43_SVD.UInt2;
   ...
   subtype MASK1_M1_Field is LPC43_SVD.UInt30;
   subtype MASK1_RESERVED_Field is LPC43_SVD.UInt2;
   ...
   subtype STATUS1_THCMP_BRANGE0_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_ARANGE0_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_DCROSS0_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_UCROSS0_Field is LPC43_SVD.Bit;
   subtype STATUS1_OVERRUN_0_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_BRANGE1_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_ARANGE1_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_DCROSS1_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_UCROSS1_Field is LPC43_SVD.Bit;
   subtype STATUS1_OVERRUN_1_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_BRANGE2_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_ARANGE2_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_DCROSS2_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_UCROSS2_Field is LPC43_SVD.Bit;
   subtype STATUS1_OVERRUN_2_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_BRANGE3_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_ARANGE3_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_DCROSS3_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_UCROSS3_Field is LPC43_SVD.Bit;
   subtype STATUS1_OVERRUN_3_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_BRANGE4_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_ARANGE4_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_DCROSS4_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_UCROSS4_Field is LPC43_SVD.Bit;
   subtype STATUS1_OVERRUN_4_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_BRANGE5_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_ARANGE5_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_DCROSS5_Field is LPC43_SVD.Bit;
   subtype STATUS1_THCMP_UCROSS5_Field is LPC43_SVD.Bit;
   subtype STATUS1_OVERRUN_5_Field is LPC43_SVD.Bit;
   subtype STATUS1_RESERVED_Field is LPC43_SVD.UInt2;
   ...
   subtype CLR_STAT1_CSTAT1_Field is LPC43_SVD.UInt30;
   subtype CLR_STAT1_RESERVED_Field is LPC43_SVD.UInt2;
   ...
   subtype SET_STAT1_SSTAT1_Field is LPC43_SVD.UInt30;
   subtype SET_STAT1_RESERVED_Field is LPC43_SVD.UInt2;
