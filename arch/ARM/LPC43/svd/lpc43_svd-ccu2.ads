...
package LPC43_SVD.CCU2 is
   ...
   type PM_Register is record
      --  Initiate power-down mode
      PD       : PM_ENUM := LPC43_SVD.CCU2.Normal_Operation;
      --  Reserved.
   ...
   subtype BASE_STAT_RESERVED_Field is LPC43_SVD.Bit;
   subtype BASE_STAT_BASE_UART3_CLK_Field is LPC43_SVD.Bit;
   subtype BASE_STAT_BASE_UART2_CLK_Field is LPC43_SVD.Bit;
   subtype BASE_STAT_BASE_UART1_CLK_Field is LPC43_SVD.Bit;
   subtype BASE_STAT_BASE_UART0_CLK_Field is LPC43_SVD.Bit;
   subtype BASE_STAT_BASE_SSP1_CLK_Field is LPC43_SVD.Bit;
   subtype BASE_STAT_BASE_SSP0_CLK_Field is LPC43_SVD.Bit;
   subtype BASE_STAT_RESERVED_Field_1 is LPC43_SVD.UInt24;
   ...
   subtype CLK_AUDIO_CFG_RESERVED_Field is LPC43_SVD.UInt29;

   --  CLK_AUDIO clock configuration register
   type CLK_AUDIO_CFG_Register is record
      --  Run enable
      RUN      : CLK_AUDIO_CFG_ENUM := LPC43_SVD.CCU2.Enabled;
      --  Auto (AHB disable mechanism) enable
      AUTO     : CLK_AUDIO_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Wake-up mechanism enable
      WAKEUP   : CLK_AUDIO_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Reserved.
   ...
   subtype CLK_AUDIO_STAT_RUN_Field is LPC43_SVD.Bit;
   subtype CLK_AUDIO_STAT_AUTO_Field is LPC43_SVD.Bit;
   subtype CLK_AUDIO_STAT_WAKEUP_Field is LPC43_SVD.Bit;
   subtype CLK_AUDIO_STAT_RESERVED_Field is LPC43_SVD.UInt29;
   ...
   subtype CLK_APB2_USART3_CFG_RESERVED_Field is LPC43_SVD.UInt29;

   --  CLK_APB2_USART3 clock configuration register
   type CLK_APB2_USART3_CFG_Register is record
      --  Run enable
      RUN      : CLK_APB2_USART3_CFG_ENUM := LPC43_SVD.CCU2.Enabled;
      --  Auto (AHB disable mechanism) enable
      AUTO     : CLK_APB2_USART3_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Wake-up mechanism enable
      WAKEUP   : CLK_APB2_USART3_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Reserved.
   ...
   subtype CLK_APB2_USART3_STAT_RUN_Field is LPC43_SVD.Bit;
   subtype CLK_APB2_USART3_STAT_AUTO_Field is LPC43_SVD.Bit;
   subtype CLK_APB2_USART3_STAT_WAKEUP_Field is LPC43_SVD.Bit;
   subtype CLK_APB2_USART3_STAT_RESERVED_Field is LPC43_SVD.UInt29;
   ...
   subtype CLK_APB2_USART2_CFG_RESERVED_Field is LPC43_SVD.UInt29;

   --  CLK_APB2_USART2 clock configuration register
   type CLK_APB2_USART2_CFG_Register is record
      --  Run enable
      RUN      : CLK_APB2_USART2_CFG_ENUM := LPC43_SVD.CCU2.Enabled;
      --  Auto (AHB disable mechanism) enable
      AUTO     : CLK_APB2_USART2_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Wake-up mechanism enable
      WAKEUP   : CLK_APB2_USART2_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Reserved.
   ...
   subtype CLK_APB2_USART2_STAT_RUN_Field is LPC43_SVD.Bit;
   subtype CLK_APB2_USART2_STAT_AUTO_Field is LPC43_SVD.Bit;
   subtype CLK_APB2_USART2_STAT_WAKEUP_Field is LPC43_SVD.Bit;
   subtype CLK_APB2_USART2_STAT_RESERVED_Field is LPC43_SVD.UInt29;
   ...
   subtype CLK_APB0_UART1_BUS_CFG_RESERVED_Field is LPC43_SVD.UInt29;

   --  CLK_APB2_UART1 clock configuration register
   type CLK_APB0_UART1_BUS_CFG_Register is record
      --  Run enable
      RUN      : CLK_APB0_UART1_BUS_CFG_ENUM := LPC43_SVD.CCU2.Enabled;
      --  Auto (AHB disable mechanism) enable
      AUTO     : CLK_APB0_UART1_BUS_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Wake-up mechanism enable
      WAKEUP   : CLK_APB0_UART1_BUS_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Reserved.
   ...
   subtype CLK_APB0_UART1_STAT_RUN_Field is LPC43_SVD.Bit;
   subtype CLK_APB0_UART1_STAT_AUTO_Field is LPC43_SVD.Bit;
   subtype CLK_APB0_UART1_STAT_WAKEUP_Field is LPC43_SVD.Bit;
   subtype CLK_APB0_UART1_STAT_RESERVED_Field is LPC43_SVD.UInt29;
   ...
   subtype CLK_APB0_USART0_CFG_RESERVED_Field is LPC43_SVD.UInt29;

   --  CLK_APB2_USART0 clock configuration register
   type CLK_APB0_USART0_CFG_Register is record
      --  Run enable
      RUN      : CLK_APB0_USART0_CFG_ENUM := LPC43_SVD.CCU2.Enabled;
      --  Auto (AHB disable mechanism) enable
      AUTO     : CLK_APB0_USART0_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Wake-up mechanism enable
      WAKEUP   : CLK_APB0_USART0_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Reserved.
   ...
   subtype CLK_APB0_USART0_STAT_RUN_Field is LPC43_SVD.Bit;
   subtype CLK_APB0_USART0_STAT_AUTO_Field is LPC43_SVD.Bit;
   subtype CLK_APB0_USART0_STAT_WAKEUP_Field is LPC43_SVD.Bit;
   subtype CLK_APB0_USART0_STAT_RESERVED_Field is LPC43_SVD.UInt29;
   ...
   subtype CLK_APB2_SSP1_CFG_RESERVED_Field is LPC43_SVD.UInt29;

   --  CLK_APB2_SSP1 clock configuration register
   type CLK_APB2_SSP1_CFG_Register is record
      --  Run enable
      RUN      : CLK_APB2_SSP1_CFG_ENUM := LPC43_SVD.CCU2.Enabled;
      --  Auto (AHB disable mechanism) enable
      AUTO     : CLK_APB2_SSP1_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Wake-up mechanism enable
      WAKEUP   : CLK_APB2_SSP1_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Reserved.
   ...
   subtype CLK_APB2_SSP1_STAT_RUN_Field is LPC43_SVD.Bit;
   subtype CLK_APB2_SSP1_STAT_AUTO_Field is LPC43_SVD.Bit;
   subtype CLK_APB2_SSP1_STAT_WAKEUP_Field is LPC43_SVD.Bit;
   subtype CLK_APB2_SSP1_STAT_RESERVED_Field is LPC43_SVD.UInt29;
   ...
   subtype CLK_APB0_SSP0_CFG_RESERVED_Field is LPC43_SVD.UInt29;

   --  CLK_APB0_SSP0 clock configuration register
   type CLK_APB0_SSP0_CFG_Register is record
      --  Run enable
      RUN      : CLK_APB0_SSP0_CFG_ENUM := LPC43_SVD.CCU2.Enabled;
      --  Auto (AHB disable mechanism) enable
      AUTO     : CLK_APB0_SSP0_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Wake-up mechanism enable
      WAKEUP   : CLK_APB0_SSP0_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Reserved.
   ...
   subtype CLK_APB0_SSP0_STAT_RUN_Field is LPC43_SVD.Bit;
   subtype CLK_APB0_SSP0_STAT_AUTO_Field is LPC43_SVD.Bit;
   subtype CLK_APB0_SSP0_STAT_WAKEUP_Field is LPC43_SVD.Bit;
   subtype CLK_APB0_SSP0_STAT_RESERVED_Field is LPC43_SVD.UInt29;
   ...
   subtype CLK_SDIO_CFG_RESERVED_Field is LPC43_SVD.UInt29;

   --  CLK_SDIO clock configuration register
   type CLK_SDIO_CFG_Register is record
      --  Run enable
      RUN      : CLK_SDIO_CFG_ENUM := LPC43_SVD.CCU2.Enabled;
      --  Auto (AHB disable mechanism) enable
      AUTO     : CLK_SDIO_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Wake-up mechanism enable
      WAKEUP   : CLK_SDIO_CFG_ENUM := LPC43_SVD.CCU2.Disabled;
      --  Reserved.
   ...
   subtype CLK_SDIO_STAT_RUN_Field is LPC43_SVD.Bit;
   subtype CLK_SDIO_STAT_AUTO_Field is LPC43_SVD.Bit;
   subtype CLK_SDIO_STAT_WAKEUP_Field is LPC43_SVD.Bit;
   subtype CLK_SDIO_STAT_RESERVED_Field is LPC43_SVD.UInt29;
