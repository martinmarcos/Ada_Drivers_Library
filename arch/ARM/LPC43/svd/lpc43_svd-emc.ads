...
package LPC43_SVD.EMC is
   ...
   subtype CONTROL_RESERVED_Field is LPC43_SVD.UInt29;
   ...
   type CONTROL_Register is record
      ...
      L        : CONTROL_ENUM_2 := LPC43_SVD.EMC.Normal;
   ...
   subtype STATUS_RESERVED_Field is LPC43_SVD.UInt29;
   ...
   subtype CONFIG_RESERVED_Field is LPC43_SVD.UInt7;
   subtype CONFIG_RESERVED_Field_1 is LPC43_SVD.Bit;
   subtype CONFIG_RESERVED_Field_2 is LPC43_SVD.UInt23;

   --  Configures operation of the memory controller.
   type CONFIG_Register is record
      --  Endian mode.
      EM         : CONFIG_ENUM := LPC43_SVD.EMC.Little_Endian_Mode;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype DYNAMICCONTROL_RESERVED_Field is LPC43_SVD.UInt2;
   ...
   subtype DYNAMICCONTROL_RESERVED_Field_1 is LPC43_SVD.Bit;
   ...
   subtype DYNAMICCONTROL_RESERVED_Field_2 is LPC43_SVD.UInt5;
   subtype DYNAMICCONTROL_RESERVED_Field_3 is LPC43_SVD.UInt18;

   --  Controls dynamic memory operation.
   type DYNAMICCONTROL_Register is record
      --  Dynamic memory clock enable.
      CE         : DYNAMICCONTROL_ENUM := LPC43_SVD.EMC.Disabled;
      ...
      CS         : DYNAMICCONTROL_ENUM_1 := LPC43_SVD.EMC.Run;
      ...
      SR         : DYNAMICCONTROL_ENUM_2 := LPC43_SVD.EMC.Self_Refresh;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED   : DYNAMICCONTROL_RESERVED_Field := 16#0#;
      --  Memory clock control.
      MMC        : DYNAMICCONTROL_ENUM_3 := LPC43_SVD.EMC.Enabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_1 : DYNAMICCONTROL_RESERVED_Field_1 := 16#0#;
      --  SDRAM initialization.
      I          : DYNAMICCONTROL_ENUM_4 := LPC43_SVD.EMC.Normal;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype DYNAMICREFRESH_REFRESH_Field is LPC43_SVD.UInt11;
   subtype DYNAMICREFRESH_RESERVED_Field is LPC43_SVD.UInt21;
   ...
   subtype DYNAMICREADCONFIG_RESERVED_Field is LPC43_SVD.UInt30;

   --  Configures the dynamic memory read strategy.
   type DYNAMICREADCONFIG_Register is record
      --  Read data strategy.
      RD       : DYNAMICREADCONFIG_ENUM := LPC43_SVD.EMC.Do_Not_Use;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype DYNAMICRP_TRP_Field is LPC43_SVD.UInt4;
   subtype DYNAMICRP_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype DYNAMICRAS_TRAS_Field is LPC43_SVD.UInt4;
   subtype DYNAMICRAS_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype DYNAMICSREX_TSREX_Field is LPC43_SVD.UInt4;
   subtype DYNAMICSREX_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype DYNAMICAPR_TAPR_Field is LPC43_SVD.UInt4;
   subtype DYNAMICAPR_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype DYNAMICDAL_TDAL_Field is LPC43_SVD.UInt4;
   subtype DYNAMICDAL_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype DYNAMICWR_TWR_Field is LPC43_SVD.UInt4;
   subtype DYNAMICWR_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype DYNAMICRC_TRC_Field is LPC43_SVD.UInt5;
   subtype DYNAMICRC_RESERVED_Field is LPC43_SVD.UInt27;
   ...
   subtype DYNAMICRFC_TRFC_Field is LPC43_SVD.UInt5;
   subtype DYNAMICRFC_RESERVED_Field is LPC43_SVD.UInt27;
   ...
   subtype DYNAMICXSR_TXSR_Field is LPC43_SVD.UInt5;
   subtype DYNAMICXSR_RESERVED_Field is LPC43_SVD.UInt27;
   ...
   subtype DYNAMICRRD_TRRD_Field is LPC43_SVD.UInt4;
   subtype DYNAMICRRD_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype DYNAMICMRD_TMRD_Field is LPC43_SVD.UInt4;
   subtype DYNAMICMRD_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype STATICEXTENDEDWAIT_EXTENDEDWAIT_Field is LPC43_SVD.UInt10;
   subtype STATICEXTENDEDWAIT_RESERVED_Field is LPC43_SVD.UInt22;
   ...
   subtype DYNAMICCONFIG_RESERVED_Field is LPC43_SVD.UInt3;
   ...
   subtype DYNAMICCONFIG_RESERVED_Field_1 is LPC43_SVD.UInt2;
   subtype DYNAMICCONFIG_AM0_Field is LPC43_SVD.UInt6;
   subtype DYNAMICCONFIG_RESERVED_Field_2 is LPC43_SVD.Bit;
   subtype DYNAMICCONFIG_AM1_Field is LPC43_SVD.Bit;
   subtype DYNAMICCONFIG_RESERVED_Field_3 is LPC43_SVD.UInt4;
   ...
   subtype DYNAMICCONFIG_RESERVED_Field_4 is LPC43_SVD.UInt11;
   ...
   type DYNAMICCONFIG_Register is record
      ...
      --  Memory device.
      MD         : DYNAMICCONFIG0_ENUM := LPC43_SVD.EMC.Sdram;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      ...
      --  Buffer enable.
      B          : DYNAMICCONFIG0_ENUM_1 := LPC43_SVD.EMC.Disabled;
      --  Write protect.
      P          : DYNAMICCONFIG0_ENUM_2 := LPC43_SVD.EMC.None;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype DYNAMICRASCAS_RESERVED_Field is LPC43_SVD.UInt6;
   subtype DYNAMICRASCAS_RESERVED_Field_1 is LPC43_SVD.UInt22;

   --  Selects the RAS and CAS latencies for dynamic memory chip select 0.
   type DYNAMICRASCAS_Register is record
      --  RAS latency (active to read/write delay).
      RAS        : DYNAMICRASCAS0_ENUM := LPC43_SVD.EMC.Three_Emc_Cclk_Cycle;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED   : DYNAMICRASCAS_RESERVED_Field := 16#0#;
      --  CAS latency.
      CAS        : DYNAMICRASCAS0_ENUM := LPC43_SVD.EMC.Three_Emc_Cclk_Cycle;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype STATICCONFIG_RESERVED_Field is LPC43_SVD.Bit;
   ...
   subtype STATICCONFIG_RESERVED_Field_1 is LPC43_SVD.UInt2;
   ...
   subtype STATICCONFIG_RESERVED_Field_2 is LPC43_SVD.UInt10;
   ...
   type STATICCONFIG_Register is record
      ...
      --  signal.
      PB         : STATICCONFIG0_ENUM_3 := LPC43_SVD.EMC.High;
      ...
      --  transactions.[1]
      EW         : STATICCONFIG0_ENUM_1 := LPC43_SVD.EMC.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_2 : STATICCONFIG_RESERVED_Field_2 := 16#0#;
      --  Buffer enable [2].
      B          : STATICCONFIG0_ENUM_1 := LPC43_SVD.EMC.Disabled;
      --  Write protect.
      P          : STATICCONFIG0_ENUM_4 := LPC43_SVD.EMC.None;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype STATICWAITWEN_WAITWEN_Field is LPC43_SVD.UInt4;
   subtype STATICWAITWEN_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype STATICWAITOEN_WAITOEN_Field is LPC43_SVD.UInt4;
   subtype STATICWAITOEN_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   subtype STATICWAITRD_WAITRD_Field is LPC43_SVD.UInt5;
   subtype STATICWAITRD_RESERVED_Field is LPC43_SVD.UInt27;
   ...
   subtype STATICWAITPAGE_WAITPAGE_Field is LPC43_SVD.UInt5;
   subtype STATICWAITPAGE_RESERVED_Field is LPC43_SVD.UInt27;
   ...
   subtype STATICWAITWR_WAITWR_Field is LPC43_SVD.UInt5;
   subtype STATICWAITWR_RESERVED_Field is LPC43_SVD.UInt27;
   ...
   subtype STATICWAITTURN_WAITTURN_Field is LPC43_SVD.UInt4;
   subtype STATICWAITTURN_RESERVED_Field is LPC43_SVD.UInt28;
