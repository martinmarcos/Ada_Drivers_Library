...
package LPC43_SVD.EMC is
   ...
   subtype CONTROL_RESERVED_Field is HAL.UInt29;
   ...
   subtype STATUS_RESERVED_Field is HAL.UInt29;
   ...
   subtype CONFIG_RESERVED_Field is HAL.UInt7;
   subtype CONFIG_RESERVED_Field_1 is HAL.UInt23;
   ...
   type CONFIG_Register is record
      ...
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_2 : CONFIG_RESERVED_Field_1 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DYNAMICCONTROL_RESERVED_Field is HAL.UInt2;
   ...
   subtype DYNAMICCONTROL_RESERVED_Field_1 is HAL.UInt5;
   subtype DYNAMICCONTROL_RESERVED_Field_2 is HAL.UInt18;
   ...
   type DYNAMICCONTROL_Register is record
      ...
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_2 : DYNAMICCONTROL_RESERVED_Field_1 := 16#0#;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_3 : DYNAMICCONTROL_RESERVED_Field_2 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DYNAMICREFRESH_RESERVED_Field is HAL.UInt21;
   ...
   subtype DYNAMICREADCONFIG_RESERVED_Field is HAL.UInt30;
   ...
   subtype DYNAMICRP_RESERVED_Field is HAL.UInt28;
   ...
   subtype DYNAMICRAS_RESERVED_Field is HAL.UInt28;
   ...
   subtype DYNAMICSREX_RESERVED_Field is HAL.UInt28;
   ...
   subtype DYNAMICAPR_RESERVED_Field is HAL.UInt28;
   ...
   subtype DYNAMICDAL_RESERVED_Field is HAL.UInt28;
   ...
   subtype DYNAMICWR_RESERVED_Field is HAL.UInt28;
   ...
   subtype DYNAMICRC_RESERVED_Field is HAL.UInt27;
   ...
   subtype DYNAMICRFC_RESERVED_Field is HAL.UInt27;
   ...
   subtype DYNAMICXSR_RESERVED_Field is HAL.UInt27;
   ...
   subtype DYNAMICRRD_RESERVED_Field is HAL.UInt28;
   ...
   subtype DYNAMICMRD_RESERVED_Field is HAL.UInt28;
   ...
   subtype STATICEXTENDEDWAIT_RESERVED_Field is HAL.UInt22;
   ...
   subtype DYNAMICCONFIG_RESERVED_Field is HAL.UInt3;
   ...
   subtype DYNAMICCONFIG_RESERVED_Field_1 is HAL.UInt2;
   subtype DYNAMICCONFIG_AM0_Field is HAL.UInt6;
   subtype DYNAMICCONFIG_RESERVED_Field_2 is HAL.UInt4;
   ...
   subtype DYNAMICCONFIG_RESERVED_Field_3 is HAL.UInt11;
   ...
   type DYNAMICCONFIG_Register is record
      ...
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_3 : DYNAMICCONFIG_RESERVED_Field_2 := 16#0#;
      --  Buffer enable.
      ...
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_4 : DYNAMICCONFIG_RESERVED_Field_3 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DYNAMICRASCAS_RESERVED_Field is HAL.UInt6;
   subtype DYNAMICRASCAS_RESERVED_Field_1 is HAL.UInt22;
   ...
   subtype STATICCONFIG_RESERVED_Field is HAL.UInt2;
   ...
   subtype STATICCONFIG_RESERVED_Field_1 is HAL.UInt10;
   ...
   subtype STATICCONFIG_RESERVED_Field_2 is HAL.UInt11;
   ...
   type STATICCONFIG_Register is record
      ...
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_1 : STATICCONFIG_RESERVED_Field := 16#0#;
      ...
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_2 : STATICCONFIG_RESERVED_Field_1 := 16#0#;
      --  Buffer enable [2].
      ...
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_3 : STATICCONFIG_RESERVED_Field_2 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype STATICWAITWEN_WAITWEN_Field is HAL.UInt4;
   subtype STATICWAITWEN_RESERVED_Field is HAL.UInt28;
   ...
   subtype STATICWAITOEN_WAITOEN_Field is HAL.UInt4;
   subtype STATICWAITOEN_RESERVED_Field is HAL.UInt28;
   ...
   subtype STATICWAITRD_WAITRD_Field is HAL.UInt5;
   subtype STATICWAITRD_RESERVED_Field is HAL.UInt27;
   ...
   subtype STATICWAITPAGE_WAITPAGE_Field is HAL.UInt5;
   subtype STATICWAITPAGE_RESERVED_Field is HAL.UInt27;
   ...
   subtype STATICWAITWR_WAITWR_Field is HAL.UInt5;
   subtype STATICWAITWR_RESERVED_Field is HAL.UInt27;
   ...
   subtype STATICWAITTURN_WAITTURN_Field is HAL.UInt4;
   subtype STATICWAITTURN_RESERVED_Field is HAL.UInt28;
