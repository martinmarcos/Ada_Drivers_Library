...
package LPC43_SVD.I2C is
   ...
   subtype CONSET_RESERVED_Field is LPC43_SVD.UInt2;
   subtype CONSET_AA_Field is LPC43_SVD.Bit;
   subtype CONSET_SI_Field is LPC43_SVD.Bit;
   subtype CONSET_STO_Field is LPC43_SVD.Bit;
   subtype CONSET_STA_Field is LPC43_SVD.Bit;
   subtype CONSET_I2EN_Field is LPC43_SVD.Bit;
   subtype CONSET_RESERVED_Field_1 is LPC43_SVD.UInt25;
   ...
   subtype STAT_RESERVED_Field is LPC43_SVD.UInt3;
   subtype STAT_Status_Field is LPC43_SVD.UInt5;
   subtype STAT_RESERVED_Field_1 is LPC43_SVD.UInt24;
   ...
   subtype DAT_Data_Field is LPC43_SVD.Byte;
   subtype DAT_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype ADR0_GC_Field is LPC43_SVD.Bit;
   subtype ADR0_Address_Field is LPC43_SVD.UInt7;
   subtype ADR0_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype SCLH_SCLH_Field is LPC43_SVD.UInt16;
   subtype SCLH_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype SCLL_SCLL_Field is LPC43_SVD.UInt16;
   subtype SCLL_RESERVED_Field is LPC43_SVD.UInt16;
   ...
   subtype CONCLR_RESERVED_Field is LPC43_SVD.UInt2;
   subtype CONCLR_AAC_Field is LPC43_SVD.Bit;
   subtype CONCLR_SIC_Field is LPC43_SVD.Bit;
   subtype CONCLR_RESERVED_Field_1 is LPC43_SVD.Bit;
   subtype CONCLR_STAC_Field is LPC43_SVD.Bit;
   subtype CONCLR_I2ENC_Field is LPC43_SVD.Bit;
   subtype CONCLR_RESERVED_Field_2 is LPC43_SVD.UInt24;
   ...
   subtype MMCTRL_RESERVED_Field is LPC43_SVD.UInt29;

   --  Monitor mode control register.
   type MMCTRL_Register is record
      --  Monitor mode enable.
      MM_ENA    : MMCTRL_ENUM := LPC43_SVD.I2C.Monitor_Mode_Disable;
      --  SCL output enable.
      ENA_SCL   : MMCTRL_ENUM_1 := LPC43_SVD.I2C.When_This_Bit_Is_Cle;
      --  Select interrupt register match.
      MATCH_ALL : MMCTRL_ENUM_1 := LPC43_SVD.I2C.When_This_Bit_Is_Cle;
   ...
   subtype ADR_GC_Field is LPC43_SVD.Bit;
   subtype ADR_Address_Field is LPC43_SVD.UInt7;
   subtype ADR_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype DATA_BUFFER_Data_Field is LPC43_SVD.Byte;
   subtype DATA_BUFFER_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype MASK_RESERVED_Field is LPC43_SVD.Bit;
   subtype MASK_MASK_Field is LPC43_SVD.UInt7;
   subtype MASK_RESERVED_Field_1 is LPC43_SVD.UInt24;
