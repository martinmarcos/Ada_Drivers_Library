...
package LPC43_SVD.I2C is
   ...
   subtype CONSET_RESERVED_Field is HAL.UInt2;
   subtype CONSET_RESERVED_Field_1 is HAL.UInt25;
   ...
   subtype STAT_RESERVED_Field is HAL.UInt3;
   subtype STAT_Status_Field is HAL.UInt5;
   subtype STAT_RESERVED_Field_1 is HAL.UInt24;
   ...
   subtype DAT_Data_Field is HAL.UInt8;
   subtype DAT_RESERVED_Field is HAL.UInt24;
   ...
   subtype ADR0_Address_Field is HAL.UInt7;
   subtype ADR0_RESERVED_Field is HAL.UInt24;
   ...
   subtype SCLH_RESERVED_Field is HAL.UInt16;
   ...
   subtype SCLL_RESERVED_Field is HAL.UInt16;
   ...
   subtype CONCLR_RESERVED_Field is HAL.UInt2;
   subtype CONCLR_RESERVED_Field_1 is HAL.UInt24;
   ...
   type CONCLR_Register is record
      ...
      --  defined.
      RESERVED_3 : CONCLR_RESERVED_Field_1 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype MMCTRL_RESERVED_Field is HAL.UInt29;
   ...
   subtype ADR_Address_Field is HAL.UInt7;
   subtype ADR_RESERVED_Field is HAL.UInt24;
   ...
   subtype DATA_BUFFER_Data_Field is HAL.UInt8;
   subtype DATA_BUFFER_RESERVED_Field is HAL.UInt24;
   ...
   subtype MASK_MASK_Field is HAL.UInt7;
   subtype MASK_RESERVED_Field is HAL.UInt24;
   ...
   type MASK_Register is record
      ...
      --  Reserved. The value read from a reserved bit is not defined.
      RESERVED_1 : MASK_RESERVED_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
