...
package LPC43_SVD.DAC is
   ...
   subtype CR_RESERVED_Field is LPC43_SVD.UInt6;
   subtype CR_VALUE_Field is LPC43_SVD.UInt10;
   ...
   subtype CR_RESERVED_Field_1 is LPC43_SVD.UInt15;
   ...
   type CR_Register is record
      ...
      --  Settling time
      BIAS       : CR_ENUM := LPC43_SVD.DAC.Short;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype CTRL_RESERVED_Field is LPC43_SVD.UInt28;

   --  DAC control register.
   type CTRL_Register is record
      --  DMA request
      INT_DMA_REQ : CTRL_ENUM := LPC43_SVD.DAC.Clr;
      --  DMA double-buffering
      DBLBUF_ENA  : CTRL_ENUM_1 := LPC43_SVD.DAC.Disabled;
      --  DMA time-out
      CNT_ENA     : CTRL_ENUM_1 := LPC43_SVD.DAC.Disabled;
      --  DMA enable
      DMA_ENA     : CTRL_ENUM_1 := LPC43_SVD.DAC.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype CNTVAL_VALUE_Field is LPC43_SVD.UInt16;
   subtype CNTVAL_RESERVED_Field is LPC43_SVD.UInt16;
