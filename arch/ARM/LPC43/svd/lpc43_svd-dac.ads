...
package LPC43_SVD.DAC is
   ...
   subtype CR_RESERVED_Field is HAL.UInt6;
   subtype CR_VALUE_Field is HAL.UInt10;
   ...
   subtype CR_RESERVED_Field_1 is HAL.UInt15;
   ...
   subtype CTRL_RESERVED_Field is HAL.UInt28;
   ...
   subtype CNTVAL_VALUE_Field is HAL.UInt16;
   subtype CNTVAL_RESERVED_Field is HAL.UInt16;
