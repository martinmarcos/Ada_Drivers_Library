...
package LPC43_SVD.TIMER is
   ...
   subtype IR_MR0INT_Field is LPC43_SVD.Bit;
   subtype IR_MR1INT_Field is LPC43_SVD.Bit;
   subtype IR_MR2INT_Field is LPC43_SVD.Bit;
   subtype IR_MR3INT_Field is LPC43_SVD.Bit;
   subtype IR_CR0INT_Field is LPC43_SVD.Bit;
   subtype IR_CR1INT_Field is LPC43_SVD.Bit;
   subtype IR_CR2INT_Field is LPC43_SVD.Bit;
   subtype IR_CR3INT_Field is LPC43_SVD.Bit;
   subtype IR_RESERVED_Field is LPC43_SVD.UInt24;
   ...
   subtype TCR_CEN_Field is LPC43_SVD.Bit;
   subtype TCR_CRST_Field is LPC43_SVD.Bit;
   subtype TCR_RESERVED_Field is LPC43_SVD.UInt30;
   ...
   subtype MCR_RESERVED_Field is LPC43_SVD.UInt20;
   ...
   type MCR_Register is record
      --  Interrupt on MR0
      MR0I     : MCR_ENUM := LPC43_SVD.TIMER.Disabled;
      --  Reset on MR0
      MR0R     : MCR_ENUM_1 := LPC43_SVD.TIMER.Disabled;
      --  Stop on MR0
      MR0S     : MCR_ENUM_2 := LPC43_SVD.TIMER.Disabled;
      --  Interrupt on MR1
      MR1I     : MCR_ENUM_2 := LPC43_SVD.TIMER.Disabled;
      --  Reset on MR1
      MR1R     : MCR_ENUM_1 := LPC43_SVD.TIMER.Disabled;
      --  Stop on MR1
      MR1S     : MCR_ENUM_3 := LPC43_SVD.TIMER.Disabled;
      --  Interrupt on MR2
      MR2I     : MCR_ENUM_2 := LPC43_SVD.TIMER.Disabled;
      --  Reset on MR2
      MR2R     : MCR_ENUM_2 := LPC43_SVD.TIMER.Disabled;
      --  Stop on MR2.
      MR2S     : MCR_ENUM_3 := LPC43_SVD.TIMER.Disabled;
      --  Interrupt on MR3
      MR3I     : MCR_ENUM_4 := LPC43_SVD.TIMER.Disabled;
      --  Reset on MR3
      MR3R     : MCR_ENUM_2 := LPC43_SVD.TIMER.Disabled;
      --  Stop on MR3
      MR3S     : MCR_ENUM_3 := LPC43_SVD.TIMER.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   --  matches the TC.
   type MR_Registers is array (0 .. 3) of LPC43_SVD.UInt32
     with Volatile;
   ...
   subtype CCR_RESERVED_Field is LPC43_SVD.UInt20;
   ...
   type CCR_Register is record
      --  Capture on CAPn.0 rising edge
      CAP0RE   : CCR_ENUM := LPC43_SVD.TIMER.Disabled;
      --  Capture on CAPn.0 falling edge
      CAP0FE   : CCR_ENUM_1 := LPC43_SVD.TIMER.Disabled;
      --  Interrupt on CAPn.0 event
      CAP0I    : CCR_ENUM_2 := LPC43_SVD.TIMER.Disabled;
      --  Capture on CAPn.1 rising edge
      CAP1RE   : CCR_ENUM := LPC43_SVD.TIMER.Disabled;
      --  Capture on CAPn.1 falling edge
      CAP1FE   : CCR_ENUM_1 := LPC43_SVD.TIMER.Disabled;
      --  Interrupt on CAPn.1 event
      CAP1I    : CCR_ENUM_2 := LPC43_SVD.TIMER.Disabled;
      --  Capture on CAPn.2 rising edge
      CAP2RE   : CCR_ENUM := LPC43_SVD.TIMER.Disabled;
      --  Capture on CAPn.2 falling edge:
      CAP2FE   : CCR_ENUM_1 := LPC43_SVD.TIMER.Disabled;
      --  Interrupt on CAPn.2 event
      CAP2I    : CCR_ENUM_2 := LPC43_SVD.TIMER.Disabled;
      --  Capture on CAPn.3 rising edge
      CAP3RE   : CCR_ENUM := LPC43_SVD.TIMER.Disabled;
      --  High to low. Capture on CAPn.3 falling edge
      CAP3FE   : CCR_ENUM_1 := LPC43_SVD.TIMER.Disabled;
      --  Interrupt on CAPn.3 event:
      CAP3I    : CCR_ENUM_2 := LPC43_SVD.TIMER.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type CR_Registers is array (0 .. 3) of LPC43_SVD.UInt32
     with Volatile;

   --  EMR_EM array element
   subtype EMR_EM_Element is LPC43_SVD.Bit;
   ...
   subtype EMR_RESERVED_Field is LPC43_SVD.UInt20;
   ...
   subtype CTCR_RESERVED_Field is LPC43_SVD.UInt28;
   ...
   type CTCR_Register is record
      ...
      CTMODE   : CTCR_ENUM := LPC43_SVD.TIMER.Timer_Mode;
      ...
      CINSEL   : CTCR_ENUM_1 := LPC43_SVD.TIMER.Cap0;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
