...
package NRF_SVD.UART1 is
   ...
   type DR_Register is record
      ...
      --  This is the framing error indicator.
      FEDATA         : DR_FEDATA_Field := NRF_SVD.UART1.Noerr;
      --  This is the parity error indicator.
      PEDATA         : DR_PEDATA_Field := NRF_SVD.UART1.Noerr;
      --  This is the break error indicator.
      BEDATA         : DR_BEDATA_Field := NRF_SVD.UART1.Noerr;
      --  This is the overrun error indicator.
      OEDATA         : DR_OEDATA_Field := NRF_SVD.UART1.Noerr;
      --  unspecified
   ...
   type RSR_Register is record
      --  This is the framing error indicator.
      FESTAT        : RSR_FESTAT_Field := NRF_SVD.UART1.Noerr;
      --  This is the parity error indicator.
      PESTAT        : RSR_PESTAT_Field := NRF_SVD.UART1.Noerr;
      --  This is the break error indicator.
      BESTAT        : RSR_BESTAT_Field := NRF_SVD.UART1.Noerr;
      --  This is the overrun error indicator.
      OESTAT        : RSR_OESTAT_Field := NRF_SVD.UART1.Noerr;
      --  unspecified
   ...
   type CR_Register is record
      ...
      CLKEN          : Boolean := False;
      --  This bitfield is the UART clock select.
      CLKSEL         : CR_CLKSEL_Field := NRF_SVD.UART1.Noclk;
