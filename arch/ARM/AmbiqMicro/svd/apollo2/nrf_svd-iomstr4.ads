...
package NRF_SVD.IOMSTR4 is
   ...
   type CLKCFG_Register is record
      ...
      --  Select the input clock frequency.
      FSEL           : CLKCFG_FSEL_Field := NRF_SVD.IOMSTR4.Min_Pwr;
      --  Enable divide by 3.
      DIV3           : CLKCFG_DIV3_Field := NRF_SVD.IOMSTR4.Dis;
      --  Enable clock division by TOTPER.
      DIVEN          : CLKCFG_DIVEN_Field := NRF_SVD.IOMSTR4.Dis;
      --  unspecified
   ...
   type CFG_Register is record
      --  This bit selects the I/O interface.
      IFCSEL         : CFG_IFCSEL_Field := NRF_SVD.IOMSTR4.I2C;
      --  This bit selects SPI polarity.
      SPOL           : CFG_SPOL_Field := NRF_SVD.IOMSTR4.Clk_Base_0;
      --  This bit selects SPI phase.
      SPHA           : CFG_SPHA_Field := NRF_SVD.IOMSTR4.Sample_Leading_Edge;
      --  This bit selects full duplex mode.
      FULLDUP        : CFG_FULLDUP_Field := NRF_SVD.IOMSTR4.Normal;
      --  This bit selects the preread timing.
      STARTRD        : CFG_STARTRD_Field := NRF_SVD.IOMSTR4.Prerd0;
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  This bit enables write mode flow control.
      WTFC           : CFG_WTFC_Field := NRF_SVD.IOMSTR4.Dis;
      --  This bit enables read mode flow control.
      RDFC           : CFG_RDFC_Field := NRF_SVD.IOMSTR4.Dis;
      --  This bit invewrts MOSI when flow control is enabled.
      MOSIINV        : CFG_MOSIINV_Field := NRF_SVD.IOMSTR4.Normal;
      --  This bit must be left at the default value of 0.
      FCDEL          : Boolean := False;
      --  This bit selects the write mode flow control signal.
      WTFCIRQ        : CFG_WTFCIRQ_Field := NRF_SVD.IOMSTR4.Miso;
      --  This bit selects the write flow control signal polarity.
      WTFCPOL        : CFG_WTFCPOL_Field := NRF_SVD.IOMSTR4.Low;
      --  This bit selects the read flow control signal polarity.
      RDFCPOL        : CFG_RDFCPOL_Field := NRF_SVD.IOMSTR4.High;
      --  unspecified
      Reserved_15_30 : HAL.UInt16 := 16#0#;
      --  This bit enables the IO Master.
      IFCEN          : CFG_IFCEN_Field := NRF_SVD.IOMSTR4.Dis;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   --  I2C/SPI Master
   type IOMSTR4_Peripheral is record
      --  FIFO Access Port
   ...
   for IOMSTR4_Peripheral use record
   ...
   --  I2C/SPI Master
   IOMSTR4_Periph : aliased IOMSTR4_Peripheral
     with Import, Address => IOMSTR4_Base;
