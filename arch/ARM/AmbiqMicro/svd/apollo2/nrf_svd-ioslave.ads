...
package NRF_SVD.IOSLAVE is
   ...
   type IOINTCTL_Register is record
      --  These read-only bits indicate whether the IOINT interrupts are
      --  enabled.
   ...
   for INTEN_Register use record
      ...
      XCMPRF         at 0 range 6 .. 6;
      XCMPRR         at 0 range 7 .. 7;
      XCMPWF         at 0 range 8 .. 8;
      XCMPWR         at 0 range 9 .. 9;
      Reserved_10_31 at 0 range 10 .. 31;
   end record;
