...
package NRF_SVD.UART is
   ...
   type DR_Register is record
      ...
      --  This is the framing error indicator.
      FEDATA         : DR_FEDATA_Field := NRF_SVD.UART.Noerr;
      --  This is the parity error indicator.
      PEDATA         : DR_PEDATA_Field := NRF_SVD.UART.Noerr;
      --  This is the break error indicator.
      BEDATA         : DR_BEDATA_Field := NRF_SVD.UART.Noerr;
      --  This is the overrun error indicator.
      OEDATA         : DR_OEDATA_Field := NRF_SVD.UART.Noerr;
      --  unspecified
   ...
   type RSR_Register is record
      --  This is the framing error indicator.
      FESTAT        : RSR_FESTAT_Field := NRF_SVD.UART.Noerr;
      --  This is the parity error indicator.
      PESTAT        : RSR_PESTAT_Field := NRF_SVD.UART.Noerr;
      --  This is the break error indicator.
      BESTAT        : RSR_BESTAT_Field := NRF_SVD.UART.Noerr;
      --  This is the overrun error indicator.
      OESTAT        : RSR_OESTAT_Field := NRF_SVD.UART.Noerr;
      --  unspecified
   ...
   type CR_CLKSEL_Field is
     (
      ...
      Noclk,
      --  24 MHz clock. Must be used if CLKGEN CORESEL=0. value.
      CR_CLKSEL_Field_24Mhz,
      --  12 MHz clock. Must be used if CLKGEN CORESEL=1. Note that CORESEL=1
      --  is unsupported by the IO Master. value.
      CR_CLKSEL_Field_12Mhz,
      --  6 MHz clock. Must be used if CLKGEN CORESEL=2, 3, or 4. Note that
      --  CORESEL=2 is unsupported. value.
      CR_CLKSEL_Field_6Mhz,
      --  3 MHz clock. Must be used if CLKGEN CORESEL=5, 6, or 7. value.
   ...
   type CR_Register is record
      ...
      CLKEN          : Boolean := False;
      --  This bitfield is the UART clock select.
      CLKSEL         : CR_CLKSEL_Field := NRF_SVD.UART.Noclk;
