...
package NRF_SVD.CLKGEN is
   ...
   type CCTRL_CORESEL_Field is
     (
      ...
      Hfrc_Div2,
      --  Core Clock is HFRC / 3 value.
      Hfrc_Div3,
      --  Core Clock is HFRC / 4 value.
      Hfrc_Div4,
      --  Core Clock is HFRC / 5 value.
      Hfrc_Div5,
      --  Core Clock is HFRC / 6 value.
      Hfrc_Div6,
      --  Core Clock is HFRC / 7 value.
      Hfrc_Div7,
      --  Core Clock is HFRC / 8 value.
      Hfrc_Div8)
     with Size => 3;
   ...
   --  Flash Clock divisor
   type CCTRL_MEMSEL_Field is
     (
      --  Flash Clock is HFRC / 25 value.
      Hfrc_Div25,
      --  Flash Clock is HFRC / 45 value.
      Hfrc_Div45)
     with Size => 1;
   for CCTRL_MEMSEL_Field use
     (Hfrc_Div25 => 0,
      Hfrc_Div45 => 1);
   ...
   type CCTRL_Register is record
      --  Core Clock divisor
      CORESEL       : CCTRL_CORESEL_Field := NRF_SVD.CLKGEN.Hfrc_Div8;
      --  Flash Clock divisor
      MEMSEL        : CCTRL_MEMSEL_Field := NRF_SVD.CLKGEN.Hfrc_Div25;
      --  unspecified
   ...
   for CCTRL_Register use record
      CORESEL       at 0 range 0 .. 2;
      MEMSEL        at 0 range 3 .. 3;
   ...
   subtype HFADJ_HFXTADJ_Field is HAL.UInt11;
   ...
   type HFADJ_Register is record
      ...
      HFXTADJ        : HFADJ_HFXTADJ_Field := 16#0#;
      --  XT warmup period for HFRC adjustment
   ...
   for HFADJ_Register use record
      ...
      HFXTADJ        at 0 range 8 .. 18;
      HFWARMUP       at 0 range 19 .. 19;
   ...
   type UARTEN_UARTEN_Field is
     (
      --  Disable the UART system clock value.
      Dis,
      --  Enable the UART system clock value.
      En)
     with Size => 1;
   for UARTEN_UARTEN_Field use
     (Dis => 0,
      En => 1);
   ...
   type UARTEN_Register is record
      --  UART system clock control
      UARTEN        : UARTEN_UARTEN_Field := NRF_SVD.CLKGEN.Dis;
      --  unspecified
